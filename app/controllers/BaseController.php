	...
	public function __construct()
	  {
	  	if (Sentry::check())
	  	{
			...
			$userImage =  $this->user->image ? ('profiles'. DIRECTORY_SEPARATOR.$this->user->directory.DIRECTORY_SEPARATOR.$this->user->image) : 'img'.DIRECTORY_SEPARATOR.'no-user-img.jpg' ;
		}
