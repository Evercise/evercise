...
class IndexerIndex extends Command {
    ...
    public function __construct()
    {
        ...
        $this->elastic = new Elastic(Geotools::getFacadeRoot(), new Evercisegroup(), Es::getFacadeRoot(), Log::getFacadeRoot());
    ...
    public function fire()
    {
        ...
        $total_indexed = $this->elastic->indexEvercisegroups($this->elastic_index, $this->elastic_type);
