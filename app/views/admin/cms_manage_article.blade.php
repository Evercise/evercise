...
@endif
    ...
    <div class="form-group">
		  ...
		  <textarea id="keywords" name="keywords" rows="3" cols=""  class="form-control">{{ $article->keywords or "" }}</textarea>
...
function write_url(text){
	    ...
	    var is_page = $("#is_page").attr('checked');
	    var cat = $("#category_id").val();
	    if(cat !='' && !is_page && cat != 'undefined' && cat > 0){
