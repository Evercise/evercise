...
@section('content')
    ...
    <div id="upload_wrapper">
        @include('image.upload-form', array('uploadImage' => $displayImage, 'label' => 'Upload you user image', 'fieldtext'=>'This image will appear on your profile and will be visible to Evercise members.'))
    </div>
