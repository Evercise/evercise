...
<div class="formitem clearfix">
	...
	<div class="formfield">
		{{ Form::password( $fieldname ,  array('data-tooltip' => isset($tooltip) ? $tooltip : null , 'placeholder' => $placeholder, 'maxlength' => 32, 'id' => $fieldname.'_first', 'class' => isset($tooltip) ? 'tooltip' : null))}}
		@if ($confirmation)
