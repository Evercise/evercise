<div class="formitem clearfix">
	...
	<div class="formfield">
		<div class="input-prepend">
			...
			@else
				{{ Form::select( 'areacode',  $country_codes, isset($default_area)?$default_area:'', ['class'=>'areacode' ,'id'=>'areacode']) }}
				<br>
				<br>
				{{ Form::text( $fieldname , isset($default) ? $default : '', array( 'data-tooltip' => isset($tooltip) ? $tooltip : null , 'pattern' => isset($pattern) ? $pattern : null, 'placeholder' => $placeholder, 'maxlength' => $maxlength, 'id' => $fieldname , 'class' => isset($tooltip) ? 'half_input tooltip' : 'half_input')) }}<span class="add-on country_code" id="country_code">-</span>
