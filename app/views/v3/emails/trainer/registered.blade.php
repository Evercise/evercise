...
{{ Html::decode(Html::linkRoute('evercisegroups.create', image('/assets/img/email/btns/btn_get_started.png', 'Create your first class'), [$trainer->display_name], ['class' => 'btn btn-blue'])) }}
