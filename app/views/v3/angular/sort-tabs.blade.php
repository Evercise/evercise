...
<div class="tab-content">
    <div role="tabpanel" class="tab-pane tab-pane-sort fade" id="filter">
        <ul class="list-group custom-dropdown" ng-style="dropwdownStyle">
            ...
            <li  class="list-group-item"><a ng-click="setDistance('1') ; closeDropdown('filter')" role="menuitem" tabindex="-1" href="#Distance:1mi" >Less than 1 mile<span ng-class="{ active : maxDistance == '1' }" class="pull-right icon icon-checkbox hover"></span></a></li>
            ...
            <li  class="list-group-item"><a ng-click="setDistance('200'); closeDropdown('filter')" role="menuitem" tabindex="-1" href="#Distance:200mi" >All<span  ng-class="{ active : maxDistance == '200' }"  class="pull-right icon icon-checkbox hover"></span></a></li>
        </ul>
    </div>
