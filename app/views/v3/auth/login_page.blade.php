        ...
        <div class="row">
            <div class="col-sm-6 col-sm-offset-3 mt50">
                {{ Form::open(['id' => 'login-form', 'route' => 'auth.login.post', 'method' => 'post', 'class'=>'mb10 login-form', 'role' => 'form'] ) }}
                    ...
                    {{ Html::linkRoute('users.fb', 'Connect via Facebook', [($redirect_after_login_route ?: 'users.edit'), 'param:3'], ['class' => 'custom-fb mb15']) }}
                    <div class="text-divider mb15 pull-left">or</div>
                    <label for="account">Log in using your account details</label>
