                ...
                <div class="row sm-mb10">
                    ...
                    @else
                        <div class="col-xs-12 mt5 text-right hidden-mob">
                                ...
                                <span>{{ HTML::decode(HTML::linkRoute('sessions.mail_all', '', ['sessionId'=>$session->id], ['class'=>'icon icon-mail mr10 mail-popup hover', 'data-id' => $session->id])) }}</span>
                            {{ Form::open(['route'=>'session.get.members', 'method'=> 'post', 'class' => 'visible-sm-inline-block visible-md-inline-block visible-lg-inline-block get-members', 'id'=>'get-members']) }}
