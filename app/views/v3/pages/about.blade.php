...
<div class="container first-container">
    <div class="row mb40">
        <div class="col-sm-4">
            <ul id="scroll-to" class="list-group list-group-no-border">
                <li class="list-group-item">
                     <a class="" href="#what">What is Evercise<span class="icon icon-grey-right-arrow pull-right mt5 hover"></span></a>
                </li>
                <li class="list-group-item">
                     <a class="" href="#why">Why Join Evercise<span class="icon icon-grey-right-arrow pull-right mt5 hover"></span></a>
                </li>
                <li class="list-group-item">
                     <a class="" href="#how">How it works<span class="icon icon-grey-right-arrow pull-right mt5 hover"></span></a>
                </li>
            </ul>
        ...
        <div class="col-sm-7 col-sm-offset-1">
            <div id="what">
                 <h1 class="mb25">What is evercise?</h1>
            ...
            <div id="why">
                 <h1 class="mb25">Why join evercise?</h1>
