...
<head>
	<meta charset="utf-8">
	<title>How to reset your Evercise password</title>
	<style>
				...
				<tr>
					<td valign="top">
						...
						<table width="600px" height="73px" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style=" font-size:18px; line-height:21.6px; color:#000000; padding: 0px 0px 0px 0px; font-family: Exo, lato, Helvetica, ‘Helvetica Neue’, Arial; ">
							<tr align="center">
								<td valign="top">
									<span style="font-size:24px; line-height:28.8px; font-weight:bold">Password escaped you?</span><br>
									<span>No worries, it happens! Here&apos;s how to reset it.</span>
								</td>
							</tr>
						</table>
						<!-- end heading -->
						...
						<table width="600px" height="150" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style=" font-size:12px; line-height:14.4px; color:#000000; padding: 0px 40px 0px 40px; font-family: lato, Helvetica, ‘Helvetica Neue’, Arial; ">
							<tr align="left">
								<td valign="top" width="400">
									...
									<br>
									<br>
									<span>Simply click below to reset your password:</span>
									...
									<span>If you have not made a request to reset your password, then something fishy might be going on. So please {{ HTML::linkRoute('static.contact_us', 'Contact Us') }} and let us know.</span>

									
								</td>
								<td valign="top" width="200" style="table-layout: fixed">
									{{HTML::image('img/WIE_forgot_password.jpg', 'forgot password', array('width' => 200, 'id' => 'potatoe'));}}
