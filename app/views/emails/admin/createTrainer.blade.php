			...
			<table width="600" height="135" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="color:#000000; padding: 0px 0px 0px 0px">
				<tr>
					<td valign="top">
                        ...
                        <br>
									<span><a style="color:#0087D3;font-size:14px" href="{{ URL::to('users') }}/{{ $user->display_name }}/resetpassword/{{ urlencode($resetCode) }}">To continue please click here to set your password and manage your account</a></span>
							...
							<tr valign="top">
								<td>
									<p  style="max-width:520px; word-wrap:break-word;">Start with evercise today: <br /> {{ URL::to('/') }}</p>
									<br>
									<br>
									<br>
