				...
				<tr>
					<td valign="top">
						...
						<table width="600px" height="73px" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style=" font-size:18px; line-height:21.6px; color:#000000; padding: 0px 0px 0px 0px; font-family: Exo, lato, Helvetica, ‘Helvetica Neue’, Arial; ">
							<tr align="center">
								<td valign="top">
									<p style="font-size:24px; line-height:28.8px; font-weight:bold">Hi {{{ $display_name }}},</p><br>
									<p>We are just confirming that you have left {{ $everciseGroup }}</p>
								</td>
							</tr>
						</table>
						<!-- end heading -->
						...
						<table width="600px" height="150" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style=" font-size:12px; line-height:14.4px; color:#000000; padding: 0px 40px 0px 40px; font-family: lato, Helvetica, ‘Helvetica Neue’, Arial; ">
							<tr align="center">
								<td valign="top" width="400">
									<p>We are sorry to hear that you no longer wish to attend {{ $everciseGroup }} on the  {{ $everciseSession }}</p>
									<p>If this was a mistake or you did not ask to leave this session please contact asap </p>
							</tr>
						</table>
						<!-- end body -->
