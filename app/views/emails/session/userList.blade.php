				...
				<tr>
					<td valign="top">
						...
						<table width="600px" height="73px" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style=" font-size:18px; line-height:21.6px; color:#000000; padding: 0px 0px 0px 0px; font-family: Exo, lato, Helvetica, ‘Helvetica Neue’, Arial; ">
							<tr align="center">
								<td valign="top">
									<span style="font-size:24px; line-height:28.8px; font-weight:bold">Hi {{{ $trainerName }}}, Here's the list of participants for your {{{ $group }}} session coming up!</span><br>
								</td>
							</tr>
						</table>
						<!-- end heading -->
						...
						<table width="600px" height="150" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style=" font-size:12px; line-height:14.4px; color:#000000; padding: 0px 40px 0px 40px; font-family: lato, Helvetica, ‘Helvetica Neue’, Arial; ">
							<tr align="left">
								<td valign="top" width="400">
									<span>Below are all the Evercise users who have signed up for your {{{ $group }}} session at {{{ date('h:m', strtotime($dateTime)) }}} on {{{ date('d-M-Y', strtotime($dateTime)) }}}.</span>
										<br>
									<span>The venue is: {{{$location}}} </span>
									<br>
									<br>
									<span>
									@foreach($userList as $user_name => $user_email)
