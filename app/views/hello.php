...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="content-type" content="text/html; charset=utf-8"><style>h1 {font-family: helvetica, arial, sans-serif; text-transform: uppercase; font-size: 26px;  line-height: 30px; font-weight: 500; color:#768690; margin: 0}
        ...
        th{border-bottom: 1px solid #768690;  font-family: helvetica, arial, sans-serif;  font-size: 18px;  line-height: 26px; font-weight: 500; color:#768690; margin: 0}
        ...
        .btn{line-height: 5px; border-radius:3px;color:#ffffff;display:inline-block;font-family:helvetica, arial, sans-serif;font-size:14px;font-weight:bold;text-align:center;text-decoration:none;-webkit-text-size-adjust:none;  }
        .btn-blue{ background: #5ecde8}
        .btn-pink{ background: #ff1b7e}
        .btn-grey{ background: #768690;}
        .bottom-border{ border-bottom: 1px solid #f2f2f2}
        ...
        @media screen and (max-device-width: 375px) and (max-device-height: 667px) {
            ...
            .footer { font-size: 13px; text-align: left;}
            .sm-hidden{ display: none}
        }</style></head><body bgcolor="#bfbfbf">
<!-- Opening main -->
<table bgcolor="#FFFFFF" border="0" align="center" cellspacing="0" cellpadding="0" style="max-width: 640px; table-layout: fixed; width: 100%;"><tr><td>
            <table width="100%" height="auto" bgcolor="#FFFFFF" border="0" align="center" cellspacing="0" cellpadding="0" style="max-width: 640px; table-layout: fixed; width: 100%;"><tr><td>
                        <!-- Main image -->
                        <table width="100%" height="auto" border="0" cellspacing="0" cellpadding="0" style="max-width: 640px; table-layout: fixed; width: 100%;"><tr><td>
                                    <a href="http://evercise.dev/uk/london" title="Confirmation of booking">
                                        <img src="http://evercise.dev/assets/img/email/user_booking_confirmation.jpg" alt="booking confirmation" style="width: 100%;"></a>
                                </td>
                            </tr></table></td></tr></table><table width="100%" height="auto" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" style="max-width: 640px; table-layout: fixed; width: 100%;"><tr><td>
                        <!-- Messaging -->
                        <table width="100%" height="20" align="left" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" style="max-width: 640px; table-layout: fixed; width: 100%;"><tr><td>
                                </td>
                            </tr></table><table width="100%" height="auto" align="left" cellspacing="30" cellpadding="0" bgcolor="#FFFFFF" style="max-width: 640px; table-layout: fixed; width: 100%;"><tr><td align="left">
                                ...
                                <td width="40" height="40" align="center">
                                    <a href="http://facebook.com/evercise"><img src="http://evercise.com/img/email-campaign/facebook.png" width="40" height="40" border="0" alt="Facebook" style="width: 100%;"></a>
                                </td>
                                <td width="40" height="40" align="center">
                                    <a href="http://twitter.com/evercise"><img src="http://evercise.com/img/email-campaign/twitter.png" width="40" height="40" border="0" alt="Twitter" style="width: 100%;"></a>
                                </td>
                                <td width="40" height="40" align="center">
                                    <a href="http://instagram.com/evercisefitness"><img src="http://evercise.com/img/email-campaign/instagram.png" width="40" height="40" border="0" alt="Instagram" style="width: 100%;"></a>
                                </td>

                                <td class="sm-hidden" width="30" height="85"></td>
                            </tr></table><table width="100%" height="20" cellspacing="0" cellpadding="30" bgcolor="#ffffff" style="max-width: 640px; table-layout: fixed; width: 100%;"><tr><td>

                                </td>
                            </tr></table><!-- Closing main --></td>
                </tr></table></td>
    </tr></table></body></html>
