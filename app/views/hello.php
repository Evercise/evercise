...
<head>
    ...
    <style>h1 {font-family: helvetica, arial, sans-serif; text-transform: uppercase; font-size: 26px;  line-height: 30px; font-weight: 500; color:#768690; margin: 0}
                            ...
                            <tr>
                                <td>
                                    <a href="http://evercise.dev/uk/london" title="Confirmation of booking">
                                        <img src="http://evercise.dev/assets/img/email/user_booking_confirmation.jpg" alt="booking confirmation">
                                    </a>
                                </td>
                            </tr>
                        </table>
