...
return array(
	...
	*/
	'filters' => array(
		...
		'.js' => array(
            (getenv('DISSABLE_JS_MINIFY') ? '' : new EnvironmentFilter(new Codesleeve\AssetPipeline\Filters\JSMinPlusFilter, App::environment())),
		),
		'.js.coffee' => array(
	...
	*/
	...
	|
	*/
	'concat' => array('production', 'local', 'staging', 'amazonsandbox', 'sunjie'),
