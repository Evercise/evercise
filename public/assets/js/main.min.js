...
"undefined"!=typeof angular&&app.controller("browseController",["$scope","$http","deviceDetector",function(e,o,t){e.deviceDetector=t,angular.element(document).ready(function(){e.getCats()}),e.activeCatSwitch=function(o){e.activeCat=o},e.subCategories=function(o,t){o.preventDefault(),e.browse=t,e.browseIsVisible=!0},e.closeBrowse=function(){e.browseIsVisible=!1},e.getCats=function(){var t="/ajax/categories/browse",n={method:"POST",url:t,headers:{"X-CSRF-Token":TOKEN}},c=o(n);c.success(function(o){e.categories=o,console.log(e.categories)}),c.error(function(e){console.log("AJAX failed!"),console.log(e)})}}]);
...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http","uiGmapGoogleMapApi",function(e,t){e.groupHeight=function(){var e=$(".results").outerHeight(),t=$(".results .heading").outerHeight(),s=$(".results .nav-tabs").outerHeight(),a=$(".results .date-picker-inline").outerHeight(),n=e-t-s-a;return{height:n+"px"}},e.results=laracasts.results,console.log(e.results),e.resultsLoading=!1,e.mapOptions={disableDefaultUI:!0,zoomControl:!0,backgroundColor:"#383d48",panControl:!1},e.clusterStyles=[{textColor:"white",url:"/assets/img/icon_default_small_pin_number.png",height:43,width:33,anchorText:[-14,9]}],e.clusterOptions={title:"click to expand",gridSize:5,maxZoom:20,styles:e.clusterStyles,zoomOnClick:!1},e.markerEvents={click:function(t,a,n){e.selectedVenueIds=!1,e.lastActiveMarker.icon="/assets/img/icon_default_small_pin.png",e.lastActiveMarker=n,n.icon="/assets/img/icon_default_large_pink.png",s(n),setTimeout(function(){$(".mb-scroll").mCustomScrollbar("scrollTo",$("#group-"+n.id),{scrollInertia:500,timeout:20})},500)},mouseover:function(e,t,s){$("#venue-"+s.id).addClass("active")},mouseout:function(e,t,s){$("#venue-"+s.id).removeClass("active")}},e.selectedVenueIds=!1,e.selectedVenueName=!1,e.clusterEvents={click:function(t,s){e.selectedVenueIds=!1;var a=t.getCenter(),n=e.map.control.getGMap(),l=new google.maps.LatLng(a.lat(),a.lng());n.panTo(l);var o=[];angular.forEach(s,function(e){o.push(e.id)}),e.selectedVenueIds=o,e.selectedVenueName=s[0].venue.name,e.lastActiveMarker.icon="/assets/img/icon_default_small_pin.png",e.lastActiveMarker=t},mouseover:function(e,t){angular.forEach(t,function(e){$("#venue-"+e.id).addClass("active")})},mouseout:function(e,t){angular.forEach(t,function(e){$("#venue-"+e.id).removeClass("active")})}},e.radius=e.results.radius,e.map={zoom:12,maxZoom:18,center:{latitude:e.results.area.lat,longitude:e.results.area.lng},control:{},clusterOptions:e.clusterOptions},e.mapEvents={},e.availableDates=e.results.available_dates,e.lastActiveMarker={},shapeEverciseGroups=function(){var t=[];return angular.forEach(e.results.results.hits,function(e){t.push({id:e.id,name:e.name,icon:"/assets/img/icon_default_small_pin.png",venue:{id:e.id,name:e.venue.name,postcode:e.venue.postcode,latitude:e.venue.lat,longitude:e.venue.lng},slug:e.slug,times:e.times,futuresessions:e.futuresessions,price:e.default_price})}),console.log(t),t},e.everciseGroups=shapeEverciseGroups();var s=function(t){var s=e.map.control.getGMap(),a=new google.maps.LatLng(t.venue.latitude,t.venue.longitude);s.panTo(a)};e.scroll_clicked=!1,e.scrollDates=function(t,s){s.preventDefault(),e.scroll_clicked=!0;var a=$(s.target).parent(),n=a.width(),l=a.find(".content"),o=parseInt(l.css("margin-left")),r=-l.width();if("right"==t)var i=o-n;else var i=o+n;0>=i&&i>=r&&a.find(".content").css({"margin-left":i+"px"}),setTimeout(function(){e.scroll_clicked=!1},500)},e.selectedDate=e.results.selected_date,e.changeSelectedDate=function(t,s){t.preventDefault(),e.selectedDate=s,e.getData()},$(".filter-btn, .sort-btn").click(function(e){e.preventDefault(),a($(this))});var a=function(e){e.parent("li").hasClass("active")&&window.setTimeout(function(){$(".tab-pane").removeClass("active"),e.parent("li").removeClass("active")},1)};e.sortChanged=function(t,s){t.preventDefault(),e.results.sort=s,e.getData()},e.url=e.results.url,e.getData=function(){var s="/ajax/uk/",n={method:"POST",url:s+e.url,headers:{"X-CSRF-Token":TOKEN},data:{date:e.selectedDate,radius:e.results.radius,sort:e.results.sort}},l=t(n);a($(".filter-btn, .sort-btn")),e.resultsLoading=!0,l.success(function(t){e.results=t,e.availableDates=e.results.available_dates,e.selectedDate=e.results.selected_date,e.everciseGroups=shapeEverciseGroups(),e.resultsLoading=!1;var s=e.map.control.getGMap();s.setZoom(12)}),l.error(function(t){console.log("AJAX failed!"),console.log(t),e.resultsLoading=!1})}}]);
