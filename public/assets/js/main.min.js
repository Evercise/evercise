...
function facebookRedirect(t){this.btn=t,this.url=t.attr("href"),this.redirect="",this.addListeners()}facebookRedirect.prototype={constructor:facebookRedirect,addListeners:function(){$('input[name="trainer"]').on("change",$.proxy(this.changeFbUrl,this))},changeFbUrl:function(t){var e=$(t.target).val();this.redirect="yes"==e?"/trainer":"",this.btn.attr("href",this.url+this.redirect)}};
