...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http","uiGmapGoogleMapApi","Angularytics",function(e,t,s,r){e.groupHeight=function(){var e=$(window).width();if(e>992){var t=$(".results").outerHeight(),s=$(".results .heading").outerHeight(),r=$(".results .nav-tabs").outerHeight(),i=$(".results .date-picker-inline").outerHeight(),n=t-s-r-i;return{height:n+"px"}}return{height:"auto"}},e.width=window.innerWidth,e.results=laracasts.results,console.log(e.results),e.resultsLoading=!1,e.view="list",e.switchView=function(t){e.resultsLoading=!0,e.view=t,e.resultsLoading=!1},e.mapOptions={disableDefaultUI:!0,zoomControl:!0,backgroundColor:"#383d48",panControl:!1},e.clusterStyles=[{textColor:"white",url:"/assets/img/icon_default_small_pin_number.png",height:43,width:33,anchorText:[-14,9]}],e.clusterOptions={title:"click to expand",gridSize:5,maxZoom:20,styles:e.clusterStyles,zoomOnClick:!1},e.markerEvents={click:function(t,s,r){e.selectedVenueIds=!1,e.lastActiveMarker.icon="/assets/img/icon_default_small_pin.png",e.lastActiveMarker=r,r.icon="/assets/img/icon_default_large_pink.png",i(r),setTimeout(function(){$(".mb-scroll").mCustomScrollbar("scrollTo",$("#group-"+r.id),{scrollInertia:500,timeout:20})},500)},mouseover:function(e,t,s){$("#venue-"+s.id).addClass("active")},mouseout:function(e,t,s){$("#venue-"+s.id).removeClass("active")}},e.selectedVenueIds=!1,e.selectedVenueName=!1,e.clusterEvents={click:function(t,s){e.selectedVenueIds=!1;var r=t.getCenter(),i=e.map.control.getGMap(),n=new google.maps.LatLng(r.lat(),r.lng());i.panTo(n);var a=[];angular.forEach(s,function(e){a.push(e.id)}),e.selectedVenueIds=a,e.selectedVenueName=s[0].venue.name,e.lastActiveMarker.icon="/assets/img/icon_default_small_pin.png",e.lastActiveMarker=t},mouseover:function(e,t){angular.forEach(t,function(e){$("#venue-"+e.id).addClass("active")})},mouseout:function(e,t){angular.forEach(t,function(e){$("#venue-"+e.id).removeClass("active")})}},e.radius=e.results.radius,e.initialZoom=function(){var t=e.results.radius.substring(0,e.results.radius.length-2),s=e.results.results.total;if(1==s){var r=e.results.results.hits[0].distance;if(r>7)return 10;if(r>5)return 12;if(r>2)return 14}return 1==t?14:3==t?13:5==t?12:10==t?11:void 0},e.circleOptions={center:{latitude:e.results.area.lat,longitude:e.results.area.lng},stroke:{color:"#50c3e2",weight:2},fill:{opacity:0},radius:1609.344*e.results.radius.substring(0,e.results.radius.length-2)},e.setMapCenter=function(){var t=e.results.radius.substring(0,e.results.radius.length-2),s=e.results.area.lng;return e.width>=992?10==t?s+.13:5==t?s+.09:3==t?s+.04:1==t?s+.02:void 0:s},e.map={zoom:e.initialZoom(),maxZoom:16,center:{latitude:e.results.area.lat,longitude:e.setMapCenter()},control:{},clusterOptions:e.clusterOptions},e.mapEvents={},e.lastActiveMarker={},shapeEverciseGroups=function(){var t=[];return angular.forEach(e.results.results.hits,function(e){t.push({id:e.id,name:e.name,icon:"/assets/img/icon_default_small_pin.png",venue:{id:e.id,name:e.venue.name,postcode:e.venue.postcode,latitude:e.venue.lat,longitude:e.venue.lng},slug:e.slug,remaining:e.futuresessions[0].remaining,times:e.times,price:e.default_price,image:"/"+e.user.directory+"/preview_"+e.image})}),t},e.everciseGroups=shapeEverciseGroups();var i=function(t){var s=e.map.control.getGMap(),r=new google.maps.LatLng(t.venue.latitude,t.venue.longitude);s.panTo(r)};e.scrollWidth=function(){var t=$(".date-picker-inline li .day").outerWidth(),s=Object.keys(e.results.available_dates).length;return{width:t*s+"px"}},e.scrollBtnWidth=function(){if(e.width<992){var t=e.width-2*$(".date-picker-inline .scroll").outerWidth();if(e.width>767)var s=t/14;else var s=t/5;return{width:s+"px"}}},e.scroll_clicked=!1,e.scrollDates=function(t,s){s.preventDefault(),e.scroll_clicked=!0;var r=$(s.target).parent();if(e.width<992)var i=r.outerWidth()-2*$(".date-picker-inline .scroll").outerWidth();else var i=r.width();var n=r.find(".content"),a=parseInt(n.css("margin-left")),l=-n.width();if(console.log(a-i),"right"==t)var o=a-i;else var o=a+i;0>=o&&o>=l&&r.find(".content").css({"margin-left":o+"px"}),setTimeout(function(){e.scroll_clicked=!1},500)},e.selectedDate=e.results.selected_date,e.changeSelectedDate=function(t,s){t.preventDefault(),e.selectedDate=s,e.getData()},e.openFilter=null,$(document).on("click",".filter-btn, .sort-btn",function(e){e.preventDefault(),n($(this))});var n=function(t){t.attr("class")==e.openFilter?(e.openFilter=null,window.setTimeout(function(){$(".tab-pane").removeClass("active"),t.parent("li").removeClass("active")},1)):e.openFilter=t.attr("class")};e.sortChanged=function(t,s){t.preventDefault(),e.results.sort=s,e.getData()},e.url=e.results.url,e.getData=function(){var s="/ajax/uk/",r={method:"POST",url:s+e.url,headers:{"X-CSRF-Token":TOKEN},data:{date:e.selectedDate,radius:e.results.radius,sort:e.results.sort,search:e.results.search}},i=t(r);e.openFilter=null,$(".tab-pane").removeClass("active"),$(".filter-btn, .sort-btn").parent().removeClass("active"),e.resultsLoading=!0,i.success(function(t){e.results=t,e.selectedDate=e.results.selected_date,e.everciseGroups=shapeEverciseGroups(),e.resultsLoading=!1,e.circleOptions={center:{latitude:e.results.area.lat,longitude:e.results.area.lng},stroke:{color:"#50c3e2",weight:2},fill:{opacity:0},radius:1609.344*e.results.radius.substring(0,e.results.radius.length-2)},e.map={zoom:e.initialZoom(),maxZoom:16,center:{latitude:e.results.area.lat,longitude:e.setMapCenter()},control:{},clusterOptions:e.clusterOptions}}),i.error(function(){e.resultsLoading=!1})},$(window).resize(function(){e.width=window.innerWidth}),e.$watch("width",function(t){768>t&&(e.view="list")}),e.gaEventTrigger=function(e,t,s){r.trackEvent(e,t,s)}}]);
...
function Login(r){this.form=r,this.addListeners()}Login.prototype={constructor:Login,addListeners:function(){this.form.on("submit",$.proxy(this.submit,this)),this.form.find("input").on("input",$.proxy(this.removeError,this))},removeError:function(){this.form.find(".alert").remove()},submit:function(r){r.preventDefault(),this.form=$(r.target),this.ajax()},ajax:function(){var r=this;$.ajax(r.form.attr("action"),{type:"post",data:r.form.serialize(),dataType:"json",beforeSend:function(){r.form.find("input[type='submit']").prop("disabled",!0),r.form.find(".has-error").removeClass("has-error"),$("#login-error-msg").remove(),r.removeError()},success:function(o){1==o.validation_failed?r.failedValidation(o):window.location.href=o.url},error:function(r,o,i){console.log(r+" - "+o+" - "+i)},complete:function(){r.form.find("input[type='submit']").prop("disabled",!1)}})},failedValidation:function(r){self=this;var o=r.errors;self.form.find("input[name = 'password']").parent().after('<div id="login-error-msg" class="form-control mb10 input-lg input-group has-error">'+o+"</div>")}};
function MailPopup(i){console.log("MAILPOPUP"),this.link=i,this.target="",this.form="",this.id="",this.validIcon="glyphicon glyphicon-ok",this.invalidIcon="glyphicon glyphicon-remove",this.validatingIcon="glyphicon glyphicon-refresh",this.body={validators:{notEmpty:{message:"Your message requires content"}}},this.addListener()}MailPopup.prototype={constructor:MailPopup,addListener:function(){$(document).on("click",".mail-popup",$.proxy(this.grabPopup,this))},grabPopup:function(i){i.preventDefault(),this.link=$(i.target),this.id=this.link.data("id"),this.target=$(i.target).attr("href"),this.link.addClass("icon-loading"),this.ajaxGet()},ajaxGet:function(){var i=this;$.get(this.target,function(a){i.link.after(a.view),$("#mail-trainer-"+i.id).modal("show");var t=i.link.css("margin-top").replace("px",""),n=i.link.css("margin-bottom").replace("px",""),o=i.link.css("margin-left").replace("px",""),e=i.link.css("margin-right").replace("px","");i.link.replaceWith('<a  href="#mail-trainer-'+i.id+'" class="icon icon-mail mt'+t+" mb"+n+" mr"+e+" ml"+o+'" data-toggle="modal" data-target="#mail-trainer-'+i.id+'"></a>'),i.link.replaceWith('<a  href="#mail-trainer-'+i.id+'" class="icon icon-mail ml10 mt15" data-toggle="modal" data-target="#mail-trainer-'+i.id+'"></a>'),i.form=$("#mail-trainer-"+i.id).find("form"),i.validation()}).fail(function(){alert("error")}).always(function(){i.link.removeClass("icon-loading")})},validation:function(){var i=this;this.form.bootstrapValidator({message:"This value is not valid",feedbackIcons:{valid:this.validIcon,invalid:this.invalidIcon,validating:this.validatingIcon},fields:{mail_body:this.body}}).on("success.form.bv",function(a){a.preventDefault(),i.ajaxUpload()})},ajaxUpload:function(){var i=this;$.ajax(i.form.attr("action"),{type:"post",data:i.form.serialize(),dataType:"json",beforeSend:function(){i.form.find("input[type='submit']").prop("disabled",!0).after('<span id="sending-loading" class="icon icon-loading ml10 mt15"></span>')},success:function(){i.form.find("input[type='submit']").before('<strong id="successfull-mail" class="text-primary">Message sent successfully!</strong><br>'),setTimeout(function(){$(".modal").modal("hide")},1500)},error:function(i,a,t){console.log(i+" - "+a+" - "+t)},complete:function(){setTimeout(function(){i.form.find("input[type=submit]").prop("disabled",!1),$("#sending-loading").remove(),$("#successfull-mail").remove()},1500)}})}};
