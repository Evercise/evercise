function redirectTo(t){window.location.href=t.url}function editClass(t){$("#"+t.id).html(t.view),$("#submit-"+t.id).hide(),$("#"+t.id).parent().collapse("show"),$("#infoToggle-"+t.id).removeClass("hide"),$(".update-session").on("submit",function(t){t.preventDefault(),new AjaxRequest($(this),updateHubRow)}),$(".toggle-switch").exists(function(){$(this).on("click",function(){new ToggleSwitch($(this))})}),$(".date-picker").datepicker({format:"dd/mm/yyyy",startDate:"+1d",autoclose:!0,todayHighlight:!0})}function updateHubRow(t){alert("row "+t.id+" edited")}
