...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http","uiGmapGoogleMapApi",function(e,t){e.groupHeight=function(){var e=$(".results").outerHeight(),t=$(".results .heading").outerHeight(),s=$(".results .nav-tabs").outerHeight(),a=$(".results .date-picker-inline").outerHeight(),n=e-t-s-a;return{height:n+"px"}},e.results=laracasts.results,console.log(e.results),e.resultsLoading=!1,e.mapOptions={disableDefaultUI:!0,zoomControl:!0,backgroundColor:"#383d48",panControl:!1},e.clusterStyles=[{textColor:"white",url:"/assets/img/icon_default_small_pin_number.png",height:43,width:33,anchorText:[-14,9]}],e.clusterOptions={title:"click to expand",gridSize:60,maxZoom:20,styles:e.clusterStyles,zoomOnClick:!1},e.clusterEvents={click:function(t){var s=t.getCenter(),a=e.map.control.getGMap(),n=new google.maps.LatLng(s.lat(),s.lng());a.panTo(n)},mouseover:function(e,t){angular.forEach(t,function(e){$("#venue-"+e.id).addClass("text-primary")})},mouseout:function(e,t){angular.forEach(t,function(e){$("#venue-"+e.id).removeClass("text-primary")})}},e.radius=e.results.radius,e.map={zoom:12,maxZoom:18,center:{latitude:e.results.area.lat,longitude:e.results.area.lng},control:{},clusterOptions:e.clusterOptions},e.mapEvents={},e.availableDates=e.results.available_dates,e.lastActiveMarker={},shapeEverciseGroups=function(){var t=[];return angular.forEach(e.results.results.hits,function(a){t.push({id:a.id,name:a.name,icon:"/assets/img/icon_default_small_pin.png",venue:{id:a.id,name:a.venue.name,postcode:a.venue.postcode,latitude:a.venue.lat,longitude:a.venue.lng},slug:a.slug,times:a.times,price:a.default_price,onClicked:function(){var t=this.model;e.lastActiveMarker.icon="/assets/img/icon_default_small_pin.png",e.lastActiveMarker=t,t.icon="/assets/img/icon_default_large_pink.png",s(t)}})}),t},e.everciseGroups=shapeEverciseGroups();var s=function(t){var s=e.map.control.getGMap(),a=new google.maps.LatLng(t.venue.latitude,t.venue.longitude);s.panTo(a)};e.scroll_clicked=!1,e.scrollDates=function(t,s){s.preventDefault(),e.scroll_clicked=!0;var a=$(s.target).parent(),n=a.width(),l=a.find(".content"),r=parseInt(l.css("margin-left")),o=-l.width();if("right"==t)var i=r-n;else var i=r+n;0>=i&&i>=o&&a.find(".content").css({"margin-left":i+"px"}),setTimeout(function(){e.scroll_clicked=!1},500)},e.selectedDate=e.results.selected_date,e.changeSelectedDate=function(t,s){t.preventDefault(),e.selectedDate=s,e.getData()},$(".filter-btn, .sort-btn").click(function(e){e.preventDefault(),a($(this))});var a=function(e){e.parent("li").hasClass("active")&&window.setTimeout(function(){$(".tab-pane").removeClass("active"),e.parent("li").removeClass("active")},1)};e.sortChanged=function(t,s){t.preventDefault(),e.results.sort=s,e.getData()},e.url=e.results.url,e.getData=function(){var s="/ajax/uk/",n={method:"POST",url:s+e.url,headers:{"X-CSRF-Token":TOKEN},data:{date:e.selectedDate,radius:e.results.radius,sort:e.results.sort}},l=t(n);a($(".filter-btn, .sort-btn")),e.resultsLoading=!0,l.success(function(t){console.log(t),e.results=t,e.availableDates=e.results.available_dates,e.selectedDate=e.results.selected_date,e.everciseGroups=shapeEverciseGroups(),e.resultsLoading=!1}),l.error(function(t){console.log("AJAX failed!"),console.log(t),e.resultsLoading=!1})}}]);
