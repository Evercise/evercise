...
function GetMembers(t){this.form=t,this.addListeners()}GetMembers.prototype={constructor:GetMembers,addListeners:function(){this.form.on("submit",$.proxy(this.submit,this))},submit:function(t){t.preventDefault(),this.form=$(t.target);var e=this.form.find('input[name="session_id"]').val();this.form.find('input[type="submit"]').replaceWith('<a  href="#session-members-'+e+'" class="icon icon-people mr15 hover" data-toggle="modal" data-target="#session-members-'+e+'"></a>'),this.ajax()},ajax:function(){var t=this;$.ajax(t.form.attr("action"),{type:"post",data:t.form.serialize(),dataType:"json",beforeSend:function(){t.form.find("input[type='submit']").prop("disabled",!0)},success:function(e){t.form.append(e.view),t.form.find(".modal").modal("show")},error:function(t,e,i){console.log(t+" - "+e+" - "+i)},complete:function(){t.form.find("input[type='submit']").prop("disabled",!1)}})}};
