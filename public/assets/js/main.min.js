...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http",function(e,s){e.mapOptions={disableDefaultUI:!0,panControl:!1},e.map={zoom:8,center:{latitude:51,longitude:-1}},e.mapEvents={},e.results=laracasts.results,e.location=e.results.area.name,e.mapResults=e.results.mapResults,e.pageResultNumber={page:e.results.page,temp:0},e.fetchData={};var t=[];e.markers=[],e.$watch(function(){return e.map.bounds},function(){for(var s in e.mapResults){var u=e.mapResults[s];for(var r in u)if(u.hasOwnProperty(r)){for(lng in u[r].location)var n=lng,l=u[r].location[lng];t.push({id:s,latitude:l,longitude:n,icon:"/assets/img/icon_default_small_pin.png",onClicked:function(){a(this.model)}})}}e.markers=t}),e.everciseGroups=e.results.results.hits,e.venue_id=!1,e.venueResults=!1,e.sortOptions=[{value:"best",name:"Best"},{value:"price_asc",name:"Price Asc"},{value:"price_desc",name:"Price Desc"},{value:"duration_asc",name:"Duration Asc"},{value:"duration_desc",name:"Duration Desc"},{value:"viewed_asc",name:"Viewed Asc"},{value:"viewed_desc",name:"Viewed Desc"}],e.sort={type:e.sortOptions[0].value},e.refreshResults=!1;var a=function(s){e.venue_id=s.id,e.getData(),e.refreshResults=!1};e.nextPage=function(){e.venue_id=!1,e.pageResultNumber.page=e.pageResultNumber.page+1,e.getData(),e.refreshResults=!1},e.sortChanged=function(s){e.venue_id=!1,e.fetchData={sort:s.type},e.refreshResults=!0,e.pageResultNumber.temp=e.pageResultNumber.page,e.pageResultNumber.page=1,e.getData()},e.getData=function(){var t={method:"POST",url:"/ajax/uk/"+e.location,headers:{"X-CSRF-Token":TOKEN},data:{page:e.pageResultNumber.page,venue_id:e.venue_id,sort:e.sort.type}},a=s(t);a.success(function(s){s.venue_id?(e.venueResults=s.results.hits,e.pageResultNumber.page=e.pageResultNumber.temp,e.pageResultNumber.temp=0):e.refreshResults?(e.everciseGroups=s.results.hits,e.pageResultNumber.page=s.page):(e.everciseGroups=e.everciseGroups.concat(s.results.hits),e.pageResultNumber.page=s.page)}),a.error(function(){console.log("AJAX failed!")})}}]);
