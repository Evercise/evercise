...
function trapezium(i){this.wrapper=i,this.btns=[],this.width=i.outerWidth(),this.margin=parseInt(this.wrapper.find(".btn").css("margin-right")),this.init()}trapezium.prototype={constructor:trapezium,init:function(){if($(window).width()>990){var i=this,t=this.width,r=0,p=1,e=10,n=1,o=0,s=0;this.wrapper.find(".trapezium-item").each(function(a,d){if(r+=$(d).outerWidth(!0),console.log(r),console.log(t),r>=t-20){o=r-t;{i.margin+o/s+"px"}r=0,p=++p,i.wrapper.append('<div class="col-sm-'+e+" col-sm-offset-"+n+' mb30" id="row-'+p+'"></div>'),t=i.wrapper.find("#row-"+p).outerWidth(),t>r&&(r+=$(d).outerWidth(!0),i.wrapper.find("#row-"+p).append(d),e-=2,n=++n)}else++s,i.wrapper.find("#row-"+p).append(d)})}}};
