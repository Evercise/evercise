...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http","uiGmapGoogleMapApi","Angularytics","$window",function(e,t,s,n){e.groupHeight=function(){var e=$(window).width();if(e>992){var t=$(".results").outerHeight(),s=$(".results .heading").outerHeight(),n=$(".results .nav-tabs").outerHeight(),r=$(".results .date-picker-inline").outerHeight(),i=t-s-n-r;return{height:i+"px"}}return{height:"auto"}},e.width=window.innerWidth,e.results=laracasts.results,console.log(e.results),e.resultsLoading=!1,e.view="list",e.switchView=function(t){e.resultsLoading=!0,e.view=t,e.resultsLoading=!1},e.mapOptions={minZoom:11,maxZoom:17,disableDefaultUI:!0,zoomControl:!0,backgroundColor:"#383d48",panControl:!1},e.clusterStyles=[{textColor:"white",url:"/assets/img/icon_default_small_pin_number.png",height:43,width:33,anchorText:[-14,9]}],e.clusterOptions={title:"click to expand",gridSize:5,maxZoom:20,styles:e.clusterStyles,zoomOnClick:!1},e.markerEvents={click:function(t,s,n){e.selectedVenueIds=!1,e.lastActiveMarker.icon="/assets/img/icon_default_small_pin.png",e.lastActiveMarker=n,n.icon="/assets/img/icon_default_large_pink.png",i(n),setTimeout(function(){$(".mb-scroll").mCustomScrollbar("scrollTo",$("#group-"+n.id),{scrollInertia:500,timeout:20})},500)},mouseover:function(e,t,s){$("#venue-"+s.id).addClass("active")},mouseout:function(e,t,s){$("#venue-"+s.id).removeClass("active")}},e.selectedVenueIds=!1,e.selectedVenueName=!1,e.clusterEvents={click:function(t,s){e.selectedVenueIds=!1;var n=t.getCenter(),r=e.map.control.getGMap(),i=new google.maps.LatLng(n.lat(),n.lng());r.panTo(i);var a=[];angular.forEach(s,function(e){a.push(e.id)}),e.selectedVenueIds=a,e.selectedVenueName=s[0].venue.name,e.lastActiveMarker.icon="/assets/img/icon_default_small_pin.png",e.lastActiveMarker=t},mouseover:function(e,t){angular.forEach(t,function(e){$("#venue-"+e.id).addClass("active")})},mouseout:function(e,t){angular.forEach(t,function(e){$("#venue-"+e.id).removeClass("active")})}},e.radius=e.results.radius,e.initialZoom=function(){var t=e.results.radius.substring(0,e.results.radius.length-2),s=e.results.results.total;return 1==s?10==t?10:5==t?12:3==t?13:14:1==t?14:3==t?13:5==t?12:10==t?11:void 0},e.circleOptions={center:{latitude:e.results.area.lat,longitude:e.results.area.lng},stroke:{color:"#50c3e2",weight:2},fill:{opacity:0},radius:1609.344*e.results.radius.substring(0,e.results.radius.length-2)},e.setMapCenter=function(){var t=e.results.radius.substring(0,e.results.radius.length-2),s=e.results.area.lng;return e.width>=992?10==t?s+.13:5==t?s+.09:3==t?s+.04:1==t?s+.02:void 0:s},e.map={zoom:e.initialZoom(),center:{latitude:e.results.area.lat,longitude:e.setMapCenter()},control:{},clusterOptions:e.clusterOptions},e.bounds={},e.mapEvents={dragend:function(){r()},zoom_changed:function(){}};var r=function(){var t=e.map.control.getGMap(),s=t.getBounds(),n=s.getNorthEast(),r=s.getSouthWest(),i={};i.ne=n.lat()+","+n.lng(),i.sw=r.lat()+","+r.lng(),e.bounds=i,e.getData(!0)};e.lastActiveMarker={},e.everciseGroups=[],shapeEverciseGroups=function(){var t=[];return angular.forEach(e.results.results.hits,function(s){var n=$.grep(e.everciseGroups,function(e){return e.id!=s.id}),r="/assets/img/icon_default_small_pin_grey.png";-1!=s.dates.indexOf(e.selectedDate)&&(r="/assets/img/icon_default_small_pin.png",console.log("index of")),n&&t.push({id:s.id,name:s.name,icon:r,venue:{id:s.id,name:s.venue.name,postcode:s.venue.postcode,latitude:s.venue.lat,longitude:s.venue.lng},slug:s.slug,remaining:s.futuresessions[0].remaining,times:s.times,price:s.default_price,image:"/"+s.user.directory+"/preview_"+s.image})}),t},e.$watch(function(){return e.map},function(){e.everciseGroups=shapeEverciseGroups()});var i=function(t){var s=e.map.control.getGMap(),n=new google.maps.LatLng(t.venue.latitude,t.venue.longitude);s.panTo(n)};e.available_dates=e.results.available_dates,e.scrollWidth=function(){var t=$(".date-picker-inline li .day").outerWidth(),s=Object.keys(e.available_dates).length;return{width:t*s+"px"}},e.scrollBtnWidth=function(){if(e.width<992){var t=e.width-2*$(".date-picker-inline .scroll").outerWidth();if(e.width>767)var s=t/14;else var s=t/5;return{width:s+"px"}}},e.scroll_clicked=!1,e.scrollDates=function(t,s){s.preventDefault(),e.scroll_clicked=!0;var n=$(s.target).parent();if(e.width<992)var r=n.outerWidth()-2*$(".date-picker-inline .scroll").outerWidth();else var r=n.width();var i=n.find(".content"),a=parseInt(i.css("margin-left")),l=-i.width();if("right"==t)var o=a-r;else var o=a+r;0>=o&&o>=l&&n.find(".content").css({"margin-left":o+"px"}),setTimeout(function(){e.scroll_clicked=!1},500)},e.selectedDate=e.results.selected_date,e.changeSelectedDate=function(t,s){t.preventDefault(),e.selectedDate=s},e.openFilter=null,$(document).on("click",".filter-btn, .sort-btn",function(e){e.preventDefault(),a($(this))});var a=function(t){t.attr("class")==e.openFilter?(e.openFilter=null,window.setTimeout(function(){$(".tab-pane").removeClass("active"),t.parent("li").removeClass("active")},1)):e.openFilter=t.attr("class")};e.sortChanged=function(t,s){t.preventDefault(),e.results.sort=s,e.getData()},e.url=e.results.url,e.getData=function(s){var n=e.bounds.ne,r=e.bounds.sw;if("undefined"==typeof s||null===s){var s=!1;n=!1,r=!1}var i="/ajax/uk/",a={method:"POST",url:i+e.url,headers:{"X-CSRF-Token":TOKEN},data:{date:e.selectedDate,radius:e.results.radius,sort:e.results.sort,search:e.results.search,ne:n,sw:r}},l=t(a);e.openFilter=null,$(".tab-pane").removeClass("active"),$(".filter-btn, .sort-btn").parent().removeClass("active"),e.resultsLoading=!0,l.success(function(t){if(e.results=t,e.available_dates=e.results.available_dates,e.selectedDate=e.results.selected_date,s){var n=shapeEverciseGroups();e.everciseGroups=e.everciseGroups.concat(n)}else e.everciseGroups=shapeEverciseGroups();s||(e.map.center={latitude:e.results.area.lat,longitude:e.setMapCenter()},e.map.zoom=e.initialZoom(),e.circleOptions.center={latitude:e.results.area.lat,longitude:e.results.area.lng},e.circleOptions.radius=1609.344*e.results.radius.substring(0,e.results.radius.length-2)),e.resultsLoading=!1}),l.error(function(){e.resultsLoading=!1})},$(window).resize(function(){e.width=window.innerWidth}),e.$watch("width",function(t){768>t&&(e.view="list")}),e.gaEventTrigger=function(e,t,s){n.trackEvent(e,t,s)}}]);
