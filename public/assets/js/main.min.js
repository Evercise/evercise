...
app.controller("DiscoverController",["$scope","$q",function(e){e.map={center:{latitude:45,longitude:-73},zoom:12};var n=function(e,n){var r={idKey:n.id,name:n.name,latitude:n.venue.lat,longitude:n.venue.lng};return r};e.markers=[],e.$watch(function(){return e.map.bounds},function(){for(var r=[],t=JSON.parse(laracasts.mapResults),a=0;a<t.length;a++)console.log(t[a]),r.push(n(a,t[a]));e.markers=r},!0)}]);
