...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http","uiGmapGoogleMapApi",function(e){e.results=laracasts.results,console.log(e.results),e.mapOptions={disableDefaultUI:!0,zoomControl:!0,backgroundColor:"#383d48",panControl:!1},e.map={zoom:12,center:{latitude:e.results.area.lat,longitude:e.results.area.lng},control:{}},e.mapEvents={},e.availableDates=e.results.available_dates,e.scroll_clicked=!1,e.scrollDates=function(t,l){l.preventDefault(),e.scroll_clicked=!0;var a=$(l.target).parent(),o=a.width(),r=a.find(".content"),s=parseInt(r.css("margin-left")),n=-r.width();if("right"==t)var c=s-o;else var c=s+o;0>=c&&c>=n&&a.find(".content").css({"margin-left":c+"px"}),setTimeout(function(){e.scroll_clicked=!1},500)}}]);