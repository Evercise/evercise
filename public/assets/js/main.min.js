...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$q",function(e){e.mapOptions={disableDefaultUI:!0,panControl:!1},e.map={zoom:8,center:{latitude:51,longitude:-1}},e.mapEvents={},e.results=laracasts.results,e.mapResults=e.results.mapResults,console.log(e.mapResults);for(var l=0;l<e.mapResults.length;l++)console.log(l)}]);
