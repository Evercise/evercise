...
function profileNav(t){this.nav=t,this.scroll=0,this.top=$("#nav").height(),this.stickyTop=this.nav.offset().top-this.nav.height(),this.url=document.URL,this.addListeners(),console.log(this.url)}profileNav.prototype={constructor:profileNav,addListeners:function(){$(window).scroll($.proxy(this.checkScrollPosition,this)),this.nav.find("a").on("click",$.proxy(this.changeTabs,this))},checkScrollPosition:function(t){this.scroll=$(t.target).scrollTop(),this.scroll>this.stickyTop?this.addStickyClass():this.removeStickyClass()},addStickyClass:function(){this.nav.addClass("navbar-fixed-top"),this.nav.css({top:this.top}),$(".profile-panels").css({"margin-top":this.nav.outerHeight(!0)})},removeStickyClass:function(){this.nav.removeClass("navbar-fixed-top"),this.nav.css({top:0}),$(".profile-panels").css({"margin-top":0})},changeTabs:function(t){t.preventDefault();var s=$(t.target).attr("href").substring(1);window.history.pushState(null,s,s)}};
