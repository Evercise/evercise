...
"undefined"!=typeof angular&&app.controller("browseController",["$scope","$http",function(e,t){angular.element(document).ready(function(){e.getCats()}),e.browseTabHeight=function(){$(".nav-browse .items").outerHeight()},e.searchTerm=laracasts.results.search,e.location=laracasts.results.area.name,e.activeCatSwitch=function(t){e.activeCat=t},e.subCategories=function(t,o){t.preventDefault(),e.browse=o,e.browseIsVisible=!0},e.closeBrowse=function(){e.browseIsVisible=!1},e.getCats=function(){var o="/ajax/categories/browse",s={method:"POST",url:o,headers:{"X-CSRF-Token":TOKEN}},r=t(s);r.success(function(t){e.categories=t}),r.error(function(e){console.log("AJAX failed!"),console.log(e)})},e.submit=function(t){e.searchTerm=t,setTimeout(function(){$("#search-form").trigger("submit")},500)}}]);
