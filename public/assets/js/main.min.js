...
function AddSessions(t){this.form=t,this.calendar=this.form.find("#calendar"),this.daysOfWeek="",this.dates=[],this.submitDates=[],this.index="",this.recur="no",this.recurring=6,this.recurringFor=this.form.find("#recurring-days").val(),this.rows=[],this.currentDates=[],this.init()}AddSessions.prototype={constructor:AddSessions,init:function(){this.calendar.datepicker({format:"yyyy-mm-dd",startDate:"+1d",todayHighlight:!0,multidate:!0}).on("changeDate",$.proxy(this.getCurrentDates,this)),this.daysOfWeek=this.calendar.find(".dow"),this.addListener()},addListener:function(){this.daysOfWeek.on("click",$.proxy(this.dayOfWeek,this)),$('input[name="recurring"]').on("change",$.proxy(this.recurringCheck,this)),this.form.on("submit",$.proxy(this.submitForm,this)),this.form.find("#recurring-days").on("change",$.proxy(this.changeRecurringFor,this))},dayOfWeek:function(t){this.index=$(t.target).index(),this.rows=[],this.setdayOfWeeks()},getCurrentDates:function(t){var e=this;this.currentDates=t.dates,this.dates=[],$.each(this.currentDates,function(t,s){e.dates.push({key:s.valueOf(),dates:s})})},setdayOfWeeks:function(){var t=new Date,e=t.getMonth(),s=this;for(t.setDate(1);t.getDay()!==this.index;)t.setDate(t.getDate()+1);for(;t.getMonth()===e;){var a=new Date(t.getFullYear()+"-"+(t.getMonth()+1)+"-"+t.getDate()),r=$.grep(s.dates,function(t){return t.key==a.valueOf()});0==r.length?s.dates.push({key:a.valueOf(),dates:a}):s.dates=s.dates.filter(function(t){return t.key!==a.valueOf()}),t.setDate(t.getDate()+7)}this.setCalendarDates()},recurringDates:function(){this.currentDates=this.calendar.datepicker("getDates");var t=this;$.each(this.currentDates,function(e,s){t.dates.push({key:s.valueOf(),dates:s});var a=Math.ceil(s.getDate()/7),r=s.getDay(),i=s.getMonth()+1;t.setRecurringDays(r,i,a)})},submitForm:function(t){t.preventDefault();var e=this;$.each(this.calendar.datepicker("getDates"),function(t,s){var a=s.getDate(),r=s.getMonth()+1,i=s.getFullYear();e.submitDates.push(i+"-"+r+"-"+a)}),$('input[name="session_array"]').val(this.submitDates),this.ajaxUpload()},ajaxUpload:function(){var t=this;$.ajax(t.form.attr("action"),{type:"post",data:t.form.serialize(),dataType:"json",beforeSend:function(){t.form.find("input[type='submit']").prop("disabled",!0).parent().after('<span id="session-loading" class="icon icon-loading ml10 mt10"></span>')},success:function(e){$("#update-session").html(e.view),t.dates=[],t.submitDates=[],t.setCalendarDates(),$("html, body").animate({scrollTop:$("#update-container").offset().top-20},1e3)},error:function(){console.log("error")},complete:function(){t.form.find("input[type='submit']").prop("disabled",!1),$("#session-loading").remove()}})},setRecurringDays:function(t,e,s){for(var a=this,r=0;r<a.recurringFor;r++){var i,n=new Date;for(n.setMonth(e+r),n.setDate(1);n.getDay()!==t;)n.setDate(n.getDate()+1);for(;Math.ceil(n.getDate()/7)!==s;)n.setDate(n.getDate()+7);i=new Date(n.getFullYear()+"-"+(n.getMonth()+1)+"-"+n.getDate()),a.dates.push({key:i.valueOf(),dates:i})}this.setCalendarDates()},recurringCheck:function(t){"yes"==$(t.target).val()?(this.recur="yes",this.recurringDates()):(this.recur="no",this.resetCalendarDates())},setCalendarDates:function(){var t=[],e={};$.each(this.dates,function(s,a){e[a.key]||(e[a.key]=!0,t.push(a.dates))}),this.calendar.datepicker("setDates",t)},resetCalendarDates:function(){this.calendar.datepicker("setDates",this.currentDates)},changeRecurringFor:function(t){this.recurringFor=$(t.target).val(),"yes"==this.recur&&this.calendar.datepicker("setDates",this.currentDates),$('input[name="recurring"][value="'+this.recur+'"]').trigger("change")}};