...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http","uiGmapGoogleMapApi","Angularytics","$window",function(e,t,s,r){e.groupHeight=function(){var e=$(window).width();if(e>992){var t=$(".results").outerHeight(),s=$(".results .heading").outerHeight(),r=$(".results .nav-tabs").outerHeight(),i=$(".results .date-picker-inline").outerHeight(),n=t-s-r-i;return{height:n+"px"}}return{height:"auto"}},e.width=window.innerWidth,e.results=laracasts.results,e.resultsLoading=!1,e.view="list",e.switchView=function(t){e.resultsLoading=!0,e.view=t,e.resultsLoading=!1},e.mapOptions={minZoom:11,maxZoom:17,disableDefaultUI:!0,zoomControl:!0,backgroundColor:"#383d48",panControl:!1},e.selectedVenueIds=!1,e.selectedVenueName=!1,e.markerEvents={click:function(t,s,r){if(r.active){e.passInGroupId=!1;for(var n=0;n<e.everciseGroups.length;n++)e.everciseGroups[n].tempIcon&&(e.everciseGroups[n].icon="/assets/img/icon_default_small_pin.png",e.everciseGroups[n].tempIcon=!1);i(t,s,r),e.lastActiveMarker.icon="/assets/img/icon_default_small_pin.png",e.lastActiveMarker=r,r.icon="/assets/img/icon_default_large_pink.png"}else e.activeDate=r.otherDates[0],e.passInGroupId=r.id,e.everciseGroups=shapeEverciseGroups(),e.lastActiveMarker=r,setTimeout(function(){i(t,s,r)},500)},mouseover:function(e,t,s){$("#venue-"+s.id).addClass("active")},mouseout:function(e,t,s){$("#venue-"+s.id).removeClass("active")}};var i=function(t,s,r){for(var i=r.venue.id,a=[],u=0;u<e.venues.length;u++)i==e.venues[u].venueId&&a.push(e.venues[u].groupId);a.length>1?(e.selectedVenueIds=!0,e.selectedVenueIds=a,e.selectedVenueName=r.venue.name):(e.activeGroupId=r.id,e.selectedVenueIds=!1,setTimeout(function(){$(".mb-scroll").mCustomScrollbar("scrollTo",$("#group-"+r.id),{scrollInertia:500,timeout:20})},100)),n(r)};e.radius=e.results.radius,e.initialZoom=function(){var t=e.results.radius.substring(0,e.results.radius.length-2),s=e.results.results.total;return 1==s?10==t?10:5==t?12:3==t?13:14:1==t?14:3==t?13:5==t?12:10==t?11:void 0},e.circleOptions={center:{latitude:e.results.area.lat,longitude:e.results.area.lng},stroke:{color:"#50c3e2",weight:2},fill:{opacity:0},radius:1609.344*e.results.radius.substring(0,e.results.radius.length-2)},e.setMapCenter=function(){var t=e.results.radius.substring(0,e.results.radius.length-2),s=e.results.area.lng;return e.width>=992?10==t?s+.13:5==t?s+.09:3==t?s+.04:1==t?s+.02:void 0:s},e.map={zoom:e.initialZoom(),center:{latitude:e.results.area.lat,longitude:e.setMapCenter()},control:{}},e.bounds={},e.mapEvents={dragend:function(){},zoom_changed:function(){}};e.lastActiveMarker={},e.everciseGroups=[],shapeEverciseGroups=function(){for(var t=[],s=[],r=0;r<e.results.results.hits.length;r++){var i=e.results.results.hits[r],n=$.grep(e.everciseGroups,function(e){return e.id!=i.id}),a="/assets/img/icon_default_small_pin_grey.png",u=!1,l=-1,o=[],c=!1,d=$.map(i.dates,function(t,r){return r==e.activeDate?(a="/assets/img/icon_default_small_pin.png",u=!0,l=10,s.push({venueId:i.venue.id,groupId:i.id}),[t]):void o.push(r)});e.passInGroupId==i.id&&(a="/assets/img/icon_default_large_pink.png",c=!0),n&&t.push({id:i.id,name:i.name,icon:a,options:{zIndex:l},venue:{id:i.venue.id,name:i.venue.name,postcode:i.venue.postcode,latitude:i.venue.lat,longitude:i.venue.lng},active:u,tempIcon:c,slug:i.slug,remaining:i.futuresessions[0].remaining,times:d[0],otherDates:o,price:i.default_price,image:"/"+i.user.directory+"/preview_"+i.image})}return e.venues=s,t},e.$watch(function(){return e.map},function(){e.everciseGroups=shapeEverciseGroups()}),e.isClassVisible=function(t){return-1!==$.inArray(t.id,e.selectedVenueIds)?!0:1==t.active};var n=function(t){var s=e.map.control.getGMap(),r=new google.maps.LatLng(t.venue.latitude,t.venue.longitude);s.panTo(r)};e.available_dates=e.results.available_dates,e.scrollWidth=function(){var t=$(".date-picker-inline li .day").outerWidth(),s=Object.keys(e.available_dates).length;return{width:t*s+"px"}},e.scrollBtnWidth=function(){if(e.width<992){var t=e.width-2*$(".date-picker-inline .scroll").outerWidth();if(e.width>767)var s=t/14;else var s=t/5;return{width:s+"px"}}},e.scroll_clicked=!1,e.scrollDates=function(t,s){s.preventDefault(),e.scroll_clicked=!0;var r,i=new Date(e.selectedDate),i=e.selectedDate,n=i.split(/[^0-9]/),a=parseInt(n[0],10),u=parseInt(n[1],10)-1,l=parseInt(n[2],10);r=new Date(a,u,l),r.setDate("right"==t?r.getDate()+7:r.getDate()-7),e.selectedDate=r.getFullYear()+"-"+("0"+(r.getMonth()+1)).slice(-2)+"-"+("0"+r.getDate()).slice(-2),e.getData(),setTimeout(function(){e.scroll_clicked=!1},500)},e.selectedDate=e.results.selected_date,e.activeDate=e.results.selected_date,e.changeActiveDate=function(t,s){t.preventDefault(),e.activeDate=s,e.everciseGroups=shapeEverciseGroups()},e.openFilter=null,$(document).on("click",".filter-btn, .sort-btn",function(e){e.preventDefault(),a($(this))});var a=function(t){t.attr("class")==e.openFilter?(e.openFilter=null,window.setTimeout(function(){$(".tab-pane").removeClass("active"),t.parent("li").removeClass("active")},1)):e.openFilter=t.attr("class")};e.sortChanged=function(t,s){t.preventDefault(),e.results.sort=s,e.getData()},e.url=e.results.url,e.getData=function(s){var r=e.bounds.ne,i=e.bounds.sw;if("undefined"==typeof s||null===s){var s=!1;r=!1,i=!1}var n="/ajax/uk/",a={method:"POST",url:n+e.url,headers:{"X-CSRF-Token":TOKEN},data:{date:e.selectedDate,radius:e.results.radius,sort:e.results.sort,search:e.results.search,ne:r,sw:i}},u=t(a);e.openFilter=null,$(".tab-pane").removeClass("active"),$(".filter-btn, .sort-btn").parent().removeClass("active"),e.resultsLoading=!0,u.success(function(t){if(e.results=t,e.available_dates=e.results.available_dates,e.selectedDate=e.results.selected_date,e.activeDate=e.results.selected_date,e.activeGroupId=!1,s){var r=shapeEverciseGroups();e.everciseGroups=e.everciseGroups.concat(r)}else e.everciseGroups=shapeEverciseGroups();s||(e.map.center={latitude:e.results.area.lat,longitude:e.setMapCenter()},e.map.zoom=e.initialZoom(),e.circleOptions.center={latitude:e.results.area.lat,longitude:e.results.area.lng},e.circleOptions.radius=1609.344*e.results.radius.substring(0,e.results.radius.length-2)),e.resultsLoading=!1}),u.error(function(){e.resultsLoading=!1})},$(window).resize(function(){e.width=window.innerWidth}),e.$watch("width",function(t){768>t&&(e.view="list")}),e.gaEventTrigger=function(e,t,s){r.trackEvent(e,t,s)}}]);
