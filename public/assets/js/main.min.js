...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http","uiGmapGoogleMapApi","Angularytics","$window",function(e,t,s,r){e.groupHeight=function(){var e=$(window).width();if(e>992){var t=$(".results").outerHeight(),s=$(".results .heading").outerHeight(),r=$(".results .nav-tabs").outerHeight(),a=$(".results .date-picker-inline").outerHeight(),i=t-s-r-a;return{height:i+"px"}}return{height:"auto"}},e.width=window.innerWidth,e.results=laracasts.results,console.log(e.results),e.resultsLoading=!1,e.view="list",e.switchView=function(t){e.resultsLoading=!0,e.view=t,e.resultsLoading=!1},e.mapOptions={minZoom:11,maxZoom:17,disableDefaultUI:!0,zoomControl:!0,backgroundColor:"#383d48",panControl:!1},e.selectedVenueIds=!1,e.selectedVenueName=!1,e.markerEvents={click:function(t,s,r){if(r.active){for(var i=0;i<e.everciseGroups.length;i++)e.everciseGroups[i].tempIcon&&(e.everciseGroups[i].icon="/assets/img/icon_default_pin_active.svg",e.everciseGroups[i].tempIcon=!1);a(t,s,r),e.lastActiveMarker.icon="/assets/img/icon_default_pin_active.svg",e.lastActiveMarker=r,r.icon="/assets/img/icon_default_pin_selected.svg"}else e.activeDate=r.otherDates[0],e.passInGroupId=r.id,e.everciseGroups=shapeEverciseGroups(),e.lastActiveMarker=r,a(t,s,r)},mouseover:function(e,t,s){$("#venue-"+s.id).addClass("active")},mouseout:function(e,t,s){$("#venue-"+s.id).removeClass("active")}};var a=function(t,s,r){for(var a=r.venue.id,i=[],u=0;u<e.venues.length;u++)a==e.venues[u].venueId&&i.push(e.venues[u].groupId);i.length>1?(e.selectedVenueIds=!0,e.selectedVenueIds=i,e.selectedVenueName=r.venue.name):(e.activeGroupId=r.id,e.selectedVenueIds=!1,setTimeout(function(){$(".mb-scroll").mCustomScrollbar("scrollTo",$("#group-"+r.id),{scrollInertia:500,timeout:20})},100)),n(r)};e.radius=e.results.radius,e.initialZoom=function(){var t=e.results.radius.substring(0,e.results.radius.length-2),s=e.results.results.total;return 1==s?10==t?10:5==t?12:3==t?13:14:1==t?14:3==t?13:5==t?12:10==t?11:void 0},e.circleOptions={center:{latitude:e.results.area.lat,longitude:e.results.area.lng},stroke:{color:"#50c3e2",weight:2},fill:{opacity:0},radius:1609.344*e.results.radius.substring(0,e.results.radius.length-2)},e.setMapCenter=function(){var t=e.results.radius.substring(0,e.results.radius.length-2),s=e.results.area.lng;return e.width>=992?10==t?s+.13:5==t?s+.09:3==t?s+.04:1==t?s+.02:void 0:s},e.map={zoom:e.initialZoom(),center:{latitude:e.results.area.lat,longitude:e.setMapCenter()},control:{}},e.bounds={},e.mapEvents={dragend:function(){i()},zoom_changed:function(){}};var i=function(){var t=e.map.control.getGMap(),s=t.getBounds(),r=s.getNorthEast(),a=s.getSouthWest(),i={};i.ne=r.lat()+","+r.lng(),i.sw=a.lat()+","+a.lng(),e.bounds=i,e.getData(!0)};e.lastActiveMarker={},e.everciseGroups=[],shapeEverciseGroups=function(){for(var t=[],s=[],r=0;r<e.results.results.hits.length;r++){var a=e.results.results.hits[r],i=$.grep(e.everciseGroups,function(e){return e.id!=a.id}),n="/assets/img/icon_default_pin_inactive.svg",u=!1,o=-1,l=[],c=!1,d=$.map(a.dates,function(t,r){return r==e.activeDate?(n="/assets/img/icon_default_pin_active.svg",u=!0,o=10,s.push({venueId:a.venue.id,groupId:a.id}),[t]):void l.push(r)});e.passInGroupId==a.id&&(n="/assets/img/icon_default_pin_selected.svg",c=!0);var v=a.score;e.results.search||(v=r),i&&t.push({id:a.id,name:a.name,icon:n,options:{zIndex:o},venue:{id:a.venue.id,name:a.venue.name,postcode:a.venue.postcode,latitude:a.venue.lat,longitude:a.venue.lng},active:u,tempIcon:c,slug:a.slug,score:v,remaining:a.futuresessions[0].remaining,times:d[0],otherDates:l,price:a.default_price,image:"/"+a.user.directory+"/preview_"+a.image})}return e.venues=s,t},e.$watch(function(){return e.map},function(){e.everciseGroups=shapeEverciseGroups()}),e.isClassVisible=function(t){return-1!==$.inArray(t.id,e.selectedVenueIds)?!0:1==t.active};var n=function(t){var s=e.map.control.getGMap(),r=new google.maps.LatLng(t.venue.latitude,t.venue.longitude);s.panTo(r)};e.available_dates=e.results.available_dates,e.scroll_clicked=!1,e.scrollDates=function(t,s){s.preventDefault(),e.scroll_clicked=!0;var r,a=new Date(e.selectedDate),a=e.selectedDate,i=a.split(/[^0-9]/),n=parseInt(i[0],10),u=parseInt(i[1],10)-1,o=parseInt(i[2],10);r=new Date(n,u,o),r.setDate("right"==t?r.getDate()+7:r.getDate()-7),e.selectedDate=r.getFullYear()+"-"+("0"+(r.getMonth()+1)).slice(-2)+"-"+("0"+r.getDate()).slice(-2),e.getData(),setTimeout(function(){e.scroll_clicked=!1},500)},e.selectedDate=e.results.selected_date,e.activeDate=e.results.selected_date,e.changeActiveDate=function(t,s){t.preventDefault(),e.activeDate=s,e.everciseGroups=shapeEverciseGroups()},e.openFilter=null,$(document).on("click",".filter-btn, .sort-btn",function(e){e.preventDefault(),u($(this))});var u=function(t){t.attr("class")==e.openFilter?(e.openFilter=null,window.setTimeout(function(){$(".tab-pane").removeClass("active"),t.parent("li").removeClass("active")},1)):e.openFilter=t.attr("class")};e.sortChanged=function(t,s){t.preventDefault(),e.results.sort=s},e.sortGroups="score",e.$watch("results.sort",function(t,s){t!=s&&(e.sortGroups="distance"==t?"distance":"price_desc"==t?"-price":"price_asc"==t?"price":"score"),$(".tab-pane").removeClass("active"),$(".sort-btn").parent("li").removeClass("active"),e.openFilter=null},!0),e.url=e.results.url,e.getData=function(s){var r=e.bounds.ne,a=e.bounds.sw;if("undefined"==typeof s||null===s){var s=!1;r=!1,a=!1}var i="/ajax/uk/",n={method:"POST",url:i+e.url,headers:{"X-CSRF-Token":TOKEN},data:{date:e.selectedDate,radius:e.results.radius,sort:e.results.sort,search:e.results.search,ne:r,sw:a}},u=t(n);e.openFilter=null,$(".tab-pane").removeClass("active"),$(".filter-btn, .sort-btn").parent().removeClass("active"),e.resultsLoading=!0,u.success(function(t){if(e.results=t,e.available_dates=e.results.available_dates,e.selectedDate=e.results.selected_date,e.activeDate=e.results.selected_date,e.activeGroupId=!1,s){var r=shapeEverciseGroups();e.everciseGroups=e.everciseGroups.concat(r)}else e.everciseGroups=shapeEverciseGroups();s||(e.map.center={latitude:e.results.area.lat,longitude:e.setMapCenter()},e.map.zoom=e.initialZoom(),e.circleOptions.center={latitude:e.results.area.lat,longitude:e.results.area.lng},e.circleOptions.radius=1609.344*e.results.radius.substring(0,e.results.radius.length-2)),e.resultsLoading=!1}),u.error(function(){e.resultsLoading=!1})},$(window).resize(function(){e.width=window.innerWidth}),e.$watch("width",function(t){768>t&&(e.view="list")}),e.gaEventTrigger=function(e,t,s){r.trackEvent(e,t,s)}}]);
