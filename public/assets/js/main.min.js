function redirectTo(e){window.location.href=e.url}function editClass(e){$("#"+e.id).html(e.view),$("#submit-"+e.id).hide(),$("#"+e.id).parent().collapse("show"),$("#infoToggle-"+e.id).removeClass("hide"),$(".update-session").on("submit",function(e){e.preventDefault(),new AjaxRequest($(this),updateHubRow)})}function updateHubRow(e){alert("row "+e.id+" edited")}
