...
function GetMembers(t){this.form=t,this.addListeners()}GetMembers.prototype={constructor:GetMembers,addListeners:function(){this.form.on("submit",$.proxy(this.submit,this))},submit:function(t){t.preventDefault(),this.form=$(t.target),this.form.find('input[type="submit"]').replaceWith('<a  href="#session-members" class="icon icon-people mr15 hover" data-toggle="modal" data-target="#session-members"></a>'),this.ajax()},ajax:function(){var t=this;$.ajax(t.form.attr("action"),{type:"post",data:t.form.serialize(),dataType:"json",beforeSend:function(){t.form.find("input[type='submit']").prop("disabled",!0)},success:function(e){t.form.after(e.view),$("#session-members").modal("show")},error:function(t,e,s){console.log(t+" - "+e+" - "+s)},complete:function(){t.form.find("input[type='submit']").prop("disabled",!1)}})}};
