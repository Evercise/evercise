...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http",function(e,s){e.mapOptions={disableDefaultUI:!0,panControl:!1},e.map={zoom:8,center:{latitude:51,longitude:-1}},e.mapEvents={},e.results=laracasts.results,e.mapResults=e.results.mapResults;var t=[];e.markers=[],e.$watch(function(){return e.map.bounds},function(){for(var s in e.mapResults){var o=e.mapResults[s];for(var n in o)if(o.hasOwnProperty(n)){for(lng in o[n].location)var a=lng,r=o[n].location[lng];t.push({id:s,latitude:r,longitude:a,icon:"/assets/img/icon_default_small_pin.png"})}}e.markers=t,setTimeout(e.moreResults,1e3)}),e.everciseGroups=e.results.results.hits,e.moreResults=function(){var e={method:"POST",url:"/ajax/map/uk/london",headers:{"X-CSRF-Token":TOKEN},data:{page:3}},t=s(e);t.success(function(e){console.log(e)}),t.error(function(){console.log("AJAX failed!")})}}]);