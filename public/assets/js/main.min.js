...
function RemoveSession(o){console.log("remove"),this.form=o,this.id="",this.addListeners()}RemoveSession.prototype={constructor:RemoveSession,addListeners:function(){this.form.on("submit",$.proxy(this.submit,this))},submit:function(o){o.preventDefault(),this.form=$(o.target),this.id=this.form.find('input[name="id"]').val(),this.ajax(),console.log("sub")},ajax:function(){var o=this;$.ajax(o.form.attr("action"),{type:"post",data:o.form.serialize(),dataType:"json",beforeSend:function(){o.form.find("input[type='submit']").prop("disabled",!0),$("#hub-edit-row-"+o.id).addClass("bg-danger")},success:function(t){o.remove(t)},error:function(o,t,i){console.log(o+" - "+t+" - "+i)},complete:function(){o.form.find("input[type='submit']").prop("disabled",!1),$("#hub-edit-row-"+o.id).removeClass("bg-info")}})},remove:function(o){$("#hub-edit-row-"+o.id).fadeOut(400)}};
