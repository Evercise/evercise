...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http","uiGmapGoogleMapApi","Angularytics","$window",function(e,t,s,a){e.groupHeight=function(){var e=$(window).width();if(e>992){var t=$(".results").outerHeight(),s=$(".results .heading").outerHeight(),a=$(".results .nav-tabs").outerHeight(),i=$(".results .date-picker-inline").outerHeight(),r=t-s-a-i;return{height:r+"px"}}return{height:"auto"}},e.width=window.innerWidth,e.results=laracasts.results,e.resultsLoading=!1,e.view="list",e.switchView=function(t){e.resultsLoading=!0,e.view=t,e.resultsLoading=!1},e.mapOptions={minZoom:11,maxZoom:17,disableDefaultUI:!0,zoomControl:!0,backgroundColor:"#383d48",panControl:!1},e.clusterStyles=[{textColor:"white",url:"/assets/img/icon_default_small_pin_number.png",height:43,width:33,anchorText:[-14,9]}],e.clusterOptions={title:"click to expand",gridSize:5,maxZoom:20,styles:e.clusterStyles,zoomOnClick:!1},e.markerEvents={click:function(t,s,a){e.selectedVenueIds=!1,e.lastActiveMarker.icon="/assets/img/icon_default_small_pin.png",e.lastActiveMarker=a,a.icon="/assets/img/icon_default_large_pink.png",i(a),setTimeout(function(){$(".mb-scroll").mCustomScrollbar("scrollTo",$("#group-"+a.id),{scrollInertia:500,timeout:20})},500)},mouseover:function(e,t,s){$("#venue-"+s.id).addClass("active")},mouseout:function(e,t,s){$("#venue-"+s.id).removeClass("active")}},e.selectedVenueIds=!1,e.selectedVenueName=!1,e.clusterEvents={click:function(t,s){e.selectedVenueIds=!1;var a=t.getCenter(),i=e.map.control.getGMap(),r=new google.maps.LatLng(a.lat(),a.lng());i.panTo(r);var n=[];angular.forEach(s,function(e){n.push(e.id)}),e.selectedVenueIds=n,e.selectedVenueName=s[0].venue.name,e.lastActiveMarker.icon="/assets/img/icon_default_small_pin.png",e.lastActiveMarker=t},mouseover:function(e,t){angular.forEach(t,function(e){$("#venue-"+e.id).addClass("active")})},mouseout:function(e,t){angular.forEach(t,function(e){$("#venue-"+e.id).removeClass("active")})}},e.radius=e.results.radius,e.initialZoom=function(){var t=e.results.radius.substring(0,e.results.radius.length-2),s=e.results.results.total;return 1==s?10==t?10:5==t?12:3==t?13:14:1==t?14:3==t?13:5==t?12:10==t?11:void 0},e.circleOptions={center:{latitude:e.results.area.lat,longitude:e.results.area.lng},stroke:{color:"#50c3e2",weight:2},fill:{opacity:0},radius:1609.344*e.results.radius.substring(0,e.results.radius.length-2)},e.setMapCenter=function(){var t=e.results.radius.substring(0,e.results.radius.length-2),s=e.results.area.lng;return e.width>=992?10==t?s+.13:5==t?s+.09:3==t?s+.04:1==t?s+.02:void 0:s},e.map={zoom:e.initialZoom(),center:{latitude:e.results.area.lat,longitude:e.setMapCenter()},control:{},clusterOptions:e.clusterOptions},e.bounds={},e.mapEvents={dragend:function(){},zoom_changed:function(){}};e.lastActiveMarker={},e.everciseGroups=[],shapeEverciseGroups=function(){for(var t=[],s=0;s<e.results.results.hits.length;s++){var a=e.results.results.hits[s],i=$.grep(e.everciseGroups,function(e){return e.id!=a.id}),r="/assets/img/icon_default_small_pin_grey.png",n=!0,l=!1;angular.forEach(a.dates,function(t,s){n&&s==e.activeDate&&(r="/assets/img/icon_default_small_pin.png",l=!0)});var u=$.map(a.dates,function(t,s){return s==e.activeDate?[t]:void 0});i&&t.push({id:a.id,name:a.name,icon:r,venue:{id:a.id,name:a.venue.name,postcode:a.venue.postcode,latitude:a.venue.lat,longitude:a.venue.lng},active:l,slug:a.slug,remaining:a.futuresessions[0].remaining,times:u[0],price:a.default_price,image:"/"+a.user.directory+"/preview_"+a.image})}return t},e.$watch(function(){return e.map},function(){e.everciseGroups=shapeEverciseGroups()}),e.isClassVisible=function(t){return-1!==$.inArray(t.id,e.selectedVenueIds)?!0:1==t.active};var i=function(t){var s=e.map.control.getGMap(),a=new google.maps.LatLng(t.venue.latitude,t.venue.longitude);s.panTo(a)};e.available_dates=e.results.available_dates,e.scrollWidth=function(){var t=$(".date-picker-inline li .day").outerWidth(),s=Object.keys(e.available_dates).length;return{width:t*s+"px"}},e.scrollBtnWidth=function(){if(e.width<992){var t=e.width-2*$(".date-picker-inline .scroll").outerWidth();if(e.width>767)var s=t/14;else var s=t/5;return{width:s+"px"}}},e.scroll_clicked=!1,e.scrollDates=function(t,s){s.preventDefault(),e.scroll_clicked=!0;var a,i=new Date(e.selectedDate),i=e.selectedDate,r=i.split(/[^0-9]/),n=parseInt(r[0],10),l=parseInt(r[1],10)-1,u=parseInt(r[2],10);a=new Date(n,l,u),a.setDate("right"==t?a.getDate()+7:a.getDate()-7),e.selectedDate=a.getFullYear()+"-"+("0"+(a.getMonth()+1)).slice(-2)+"-"+("0"+a.getDate()).slice(-2),e.getData(),setTimeout(function(){e.scroll_clicked=!1},500)},e.selectedDate=e.results.selected_date,e.activeDate=e.results.selected_date,e.changeActiveDate=function(t,s){t.preventDefault(),e.activeDate=s,e.everciseGroups=shapeEverciseGroups()},e.openFilter=null,$(document).on("click",".filter-btn, .sort-btn",function(e){e.preventDefault(),r($(this))});var r=function(t){t.attr("class")==e.openFilter?(e.openFilter=null,window.setTimeout(function(){$(".tab-pane").removeClass("active"),t.parent("li").removeClass("active")},1)):e.openFilter=t.attr("class")};e.sortChanged=function(t,s){t.preventDefault(),e.results.sort=s,e.getData()},e.url=e.results.url,e.getData=function(s){var a=e.bounds.ne,i=e.bounds.sw;if("undefined"==typeof s||null===s){var s=!1;a=!1,i=!1}var r="/ajax/uk/",n={method:"POST",url:r+e.url,headers:{"X-CSRF-Token":TOKEN},data:{date:e.selectedDate,radius:e.results.radius,sort:e.results.sort,search:e.results.search,ne:a,sw:i}},l=t(n);e.openFilter=null,$(".tab-pane").removeClass("active"),$(".filter-btn, .sort-btn").parent().removeClass("active"),e.resultsLoading=!0,l.success(function(t){if(e.results=t,e.available_dates=e.results.available_dates,e.selectedDate=e.results.selected_date,e.activeDate=e.results.selected_date,s){var a=shapeEverciseGroups();e.everciseGroups=e.everciseGroups.concat(a)}else e.everciseGroups=shapeEverciseGroups();s||(e.map.center={latitude:e.results.area.lat,longitude:e.setMapCenter()},e.map.zoom=e.initialZoom(),e.circleOptions.center={latitude:e.results.area.lat,longitude:e.results.area.lng},e.circleOptions.radius=1609.344*e.results.radius.substring(0,e.results.radius.length-2)),e.resultsLoading=!1}),l.error(function(){e.resultsLoading=!1})},$(window).resize(function(){e.width=window.innerWidth}),e.$watch("width",function(t){768>t&&(e.view="list")}),e.gaEventTrigger=function(e,t,s){a.trackEvent(e,t,s)}}]);
