...
"undefined"!=typeof angular&&app.controller("browseController",["$scope","$http",function(e,o){angular.element(document).ready(function(){e.getCats()}),e.searchTerm=laracasts.results.search,e.location=laracasts.results.area.name,e.activeCatSwitch=function(o){e.activeCat=o},e.subCategories=function(o,t){o.preventDefault(),e.browse=t,e.browseIsVisible=!0},e.closeBrowse=function(){e.browseIsVisible=!1},e.getCats=function(){var t="/ajax/categories/browse",s={method:"POST",url:t,headers:{"X-CSRF-Token":TOKEN}},r=o(s);r.success(function(o){e.categories=o,console.log(e.categories)}),r.error(function(e){console.log("AJAX failed!"),console.log(e)})},e.submit=function(o){e.searchTerm=o,setTimeout(function(){$("#search-form").trigger("submit")},500)}}]);
