...
function MailPopup(i){this.link=i,this.target="",this.form="",this.id="",this.validIcon="glyphicon glyphicon-ok",this.invalidIcon="glyphicon glyphicon-remove",this.validatingIcon="glyphicon glyphicon-refresh",this.body={validators:{notEmpty:{message:"Your message requires content"}}},this.addListener()}MailPopup.prototype={constructor:MailPopup,addListener:function(){$(document).on("click",".mail-popup",$.proxy(this.grabPopup,this))},grabPopup:function(i){i.preventDefault(),this.link=$(i.target),this.id=this.link.data("id"),this.target=$(i.target).attr("href"),this.link.addClass("icon-loading"),this.ajaxGet()},ajaxGet:function(){var i=this;$.get(this.target,function(t){i.link.after(t.view),$("#mail-trainer-"+i.id).modal("show");var a=i.link.css("margin-top").replace("px",""),n=i.link.css("margin-bottom").replace("px",""),o=i.link.css("margin-left").replace("px",""),e=i.link.css("margin-right").replace("px","");i.link.replaceWith('<a  href="#mail-trainer-'+i.id+'" class="icon icon-mail mt'+a+" mb"+n+" mr"+e+" ml"+o+' hover" data-toggle="modal" data-target="#mail-trainer-'+i.id+'"></a>'),i.form=$("#mail-trainer-"+i.id).find("form"),i.validation()}).fail(function(){alert("error")}).always(function(){i.link.removeClass("icon-loading")})},validation:function(){var i=this;this.form.bootstrapValidator({message:"This value is not valid",feedbackIcons:{valid:this.validIcon,invalid:this.invalidIcon,validating:this.validatingIcon},fields:{mail_body:this.body}}).on("success.form.bv",function(t){t.preventDefault(),i.ajaxUpload()})},ajaxUpload:function(){var i=this;$.ajax(i.form.attr("action"),{type:"post",data:i.form.serialize(),dataType:"json",beforeSend:function(){i.form.find("input[type='submit']").prop("disabled",!0).after('<span id="sending-loading" class="icon icon-loading ml10 mt15"></span>')},success:function(){i.form.find("input[type='submit']").before('<strong id="successfull-mail" class="text-primary">Message sent successfully!</strong><br>'),setTimeout(function(){$(".modal").modal("hide")},1500)},error:function(i,t,a){console.log(i+" - "+t+" - "+a)},complete:function(){setTimeout(function(){i.form.find("input[type=submit]").prop("disabled",!1),$("#sending-loading").remove(),$("#successfull-mail").remove()},1500)}})}};
function GetMembers(t){this.form=t,this.addListeners()}GetMembers.prototype={constructor:GetMembers,addListeners:function(){this.form.on("submit",$.proxy(this.submit,this))},submit:function(t){t.preventDefault(),this.form=$(t.target);var e=this.form.find('input[name="session_id"]').val(),i=this.form.find('input[type="submit"]').css("margin-top").replace("px",""),s=this.form.find('input[type="submit"]').css("margin-bottom").replace("px",""),o=this.form.find('input[type="submit"]').css("margin-left").replace("px",""),n=this.form.find('input[type="submit"]').css("margin-right").replace("px","");this.form.find('input[type="submit"]').replaceWith('<a  href="#session-members-'+e+'" class="icon icon-people mt'+i+" mb"+s+" mr"+n+" ml"+o+' hover" data-toggle="modal" data-target="#session-members-'+e+'"></a>'),this.ajax()},ajax:function(){var t=this;$.ajax(t.form.attr("action"),{type:"post",data:t.form.serialize(),dataType:"json",beforeSend:function(){t.form.find(".icon-people").addClass("disabled")},success:function(e){t.form.append(e.view),t.form.find(".modal").modal("show")},error:function(t,e,i){console.log(t+" - "+e+" - "+i)},complete:function(){t.form.find(".icon-people").removeClass("disabled")}})}};
