...
if("undefined"!=typeof angular){var app=angular.module("DiscoverApp",["google-maps".ns()],["$interpolateProvider",function(n){n.startSymbol("{[{"),n.endSymbol("}]}")}]);app.config(["GoogleMapApiProvider".ns(),function(n){n.configure({v:"3.17",libraries:"places",uk:!0})}]),app.filter("truncate",function(){return function(n,r,e){return isNaN(r)&&(r=10),void 0===e&&(e="..."),n.length<=r||n.length-e.length<=r?n:String(n).substring(0,r-e.length)+e}}),app.filter("repeat",function(){return function(n,r){r=parseInt(r);for(var e=0;r>e;e++)n.push(e);return n}})}
...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http",function(e,s){e.mapOptions={disableDefaultUI:!0,panControl:!1},e.map={zoom:8,center:{latitude:51,longitude:-1}},e.mapEvents={},e.results=laracasts.results,e.location=e.results.area.name,e.mapResults=e.results.mapResults,e.pageResultNumber={page:e.results.page,temp:0};var a=[];e.markers=[],e.$watch(function(){return e.map.bounds},function(){for(var s in e.mapResults){var u=e.mapResults[s];for(var n in u)if(u.hasOwnProperty(n)){for(lng in u[n].location)var r=lng,l=u[n].location[lng];a.push({id:s,latitude:l,longitude:r,icon:"/assets/img/icon_default_small_pin.png",onClicked:function(){t(this.model)}})}}e.markers=a}),e.everciseGroups=e.results.results.hits,e.venue_id=!1,e.venueResults=!1,e.sortOptions=[{value:"best",name:"Best"},{value:"price_asc",name:"Price Asc"},{value:"price_desc",name:"Price Desc"},{value:"duration_asc",name:"Duration Asc"},{value:"duration_desc",name:"Duration Desc"},{value:"viewed_asc",name:"Viewed Asc"},{value:"viewed_desc",name:"Viewed Desc"}],e.sort={type:e.results.sort},e.distanceOptions=[{value:"1/2 mile",name:"Up to half a mile"},{value:"1mi",name:"1 mile"},{value:"2mi",name:"2 miles"},{value:"3mi",name:"3 mile"},{value:"5mi",name:"5 miles"},{value:"10mi",name:"10 miles"},{value:"25mi",name:"25 miles"}],e.distance={type:e.results.radius},e.refreshResults=!1;var t=function(s){e.venue_id=s.id,u(),e.refreshResults=!1,e.getData()};e.nextPage=function(){e.venue_id=!1,e.pageResultNumber.page=e.pageResultNumber.page+1,e.refreshResults=!1,e.getData()},e.sortChanged=function(){e.venue_id=!1,e.refreshResults=!0,u(),e.getData()},e.distanceChanged=function(){e.venue_id=!1,e.refreshResults=!0,u(),e.getData()};var u=function(){e.pageResultNumber.temp=e.pageResultNumber.page,e.pageResultNumber.page=1};e.getData=function(){var a={method:"POST",url:"/ajax/uk/"+e.location,headers:{"X-CSRF-Token":TOKEN},data:{page:e.pageResultNumber.page,venue_id:e.venue_id,sort:e.sort.type,distance:e.distance.type}},t=s(a);t.success(function(s){s.venue_id?(e.venueResults=s.results.hits,e.pageResultNumber.page=e.pageResultNumber.temp,e.pageResultNumber.temp=0):e.refreshResults?(e.everciseGroups=s.results.hits,e.pageResultNumber.page=s.page):(e.everciseGroups=e.everciseGroups.concat(s.results.hits),e.pageResultNumber.page=s.page)}),t.error(function(e){console.log("AJAX failed!"),console.log(e)})}}]);
