...
function UpdateSessions(t){this.form=t,self.data="",this.init()}UpdateSessions.prototype={constructor:UpdateSessions,init:function(){this.addListeners()},addListeners:function(){$(document).on("submit","#update-sessions",$.proxy(this.submitUpdate,this)),$(document).on("click","#more-sessions",$.proxy(this.scrollToCalendar,this))},submitUpdate:function(t){t.preventDefault(),this.ajaxUpload()},ajaxUpload:function(){var t=this;t.data=t.form.serialize(),$.ajax(t.form.attr("action"),{type:"post",data:t.data,dataType:"json",beforeSend:function(){t.form.find("input[type='submit']").prop("disabled",!0).append('<span id="sessionupdate-loading" class="icon icon-loading ml10 mt10"></span>')},success:function(t){window.location.href=t.url},error:function(){console.log("error")},complete:function(){t.form.find("input[type='submit']").prop("disabled",!1),$("#sessionupdate-loading").remove()}})},scrollToCalendar:function(t){t.preventDefault(),console.log(t),$("html, body").animate({scrollTop:$(t.target.attr("href")).offset().top-60},1e3)}};
