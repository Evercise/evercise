...
function EditClass(i){this.form=i,this.addListeners()}EditClass.prototype={constructor:EditClass,addListeners:function(){this.form.on("submit",$.proxy(this.submit,this))},submit:function(i){i.preventDefault(),this.form=$(i.target),this.ajax()},ajax:function(){var i=this;$.ajax(i.form.attr("action"),{type:"post",data:i.form.serialize(),dataType:"json",beforeSend:function(){i.form.find("input[type='submit']").prop("disabled",!0),i.form.find(".btn-toggle-down").prop("disabled",!0).addClass("loading")},success:function(t){i.edit(t)},error:function(i,t,e){console.log(i+" - "+t+" - "+e)},complete:function(){i.form.find("input[type='submit']").prop("disabled",!1)}})},edit:function(i){$("#"+i.id).html(i.view),$("#edit-"+i.id).removeClass("disabled"),$("#submit-"+i.id).hide(),$("#"+i.id).parent().collapse("show"),$("#infoToggle-"+i.id).removeClass("hide"),datepick(),new UpdateSession($(".update-session")),new RemoveSession($(".remove-session"))}};
