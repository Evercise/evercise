...
"undefined"!=typeof angular&&app.controller("DiscoverController",["$scope","$q",function(e){function t(e){$(".class-snippet").addClass("fade-out"),$(".class-snippet").removeClass("active"),$(e).addClass("active"),$(".mb-scroll").mCustomScrollbar("scrollTo",e,{scrollInertia:500,timeout:10})}e.everciseGroups=laracasts.mapResults,e.results=e.everciseGroups.length,e.sort="id",e.dropwdownStyle={top:0,left:0},e.active={},e.originalDistance=parseInt($('select[name="distance"]').val()),e.maxDistance=parseInt($('select[name="distance"]').val()),e.myMarkers=[],e.markers=[];var i=function(t){var i={id:t.id,name:t.name,directory:t.user.directory,image:t.image,latitude:t.venue.lat,longitude:t.venue.lng,coords:{latitude:t.venue.lat,longitude:t.venue.lng},icon:"/assets/img/icon_default_small_pin.png",price:t.default_price,rating:t.ratings.length,reviews:t.ratings,description:t.description,stars:e.getStars(t.ratings),capacity:t.capacity,sessions:t.futuresessions,distance:t.distance,nextClassDate:t.futuresessions[0].date_time,nextClassDuration:t.futuresessions[0].duration,link:"/classes/"+t.slug,click:function(){e.clicked(this.model)}};return i};e.distanceFilter=function(t){return t.distance<=e.maxDistance||t==e.active?t:void 0},e.toggle=function(t,i){var s=$(t.target),n=s.offset(),r=1.5*s.height();e.dropwdownStyle={top:n.top+r,left:n.left},$(t.target).parent().hasClass("active")&&window.setTimeout(function(){$("#"+i).removeClass("active"),$(t.target).parent().removeClass("active")},1)},$(document).mouseup(function(e){var t=$(".custom-dropdown");t.parent().hasClass("active")&&(t.is(e.target)||0!==t.has(e.target).length||($(".sort-btn").removeClass("active"),$(".filter-btn").removeClass("active"),$(".tab-pane-sort").removeClass("active")))}),e.closeDropdown=function(t){$("img.lazy").trigger("sort"),window.setTimeout(function(){$(".tab-pane-sort").removeClass("active"),$("."+t+"-btn").removeClass("active")},1),window.setTimeout(function(){"undefined"!=typeof e.lastActiveMarker.id?$(".mb-scroll").mCustomScrollbar("scrollTo","#"+e.lastActiveMarker.id,{scrollInertia:500,timeout:10}):$(".mb-scroll").mCustomScrollbar("scrollTo","1px",{scrollInertia:500,timeout:10})},100)},e.setDistance=function(t,i){t.preventDefault(),e.maxDistance=i},e.changeView=function(t){e.view=t},e.isPreviewOpen=!1,e.returnPreview=function(){e.isPreviewOpen=!1},e.map={center:{latitude:50,longitude:-.2},pan:{},options:{streetViewControl:!1,maxZoom:19,minZoom:3},zoom:12},e.clusterStyles=[{textColor:"white",url:"/assets/img/icon_default_small_pin_number.png",height:43,width:33,anchorText:[-14,9]}],e.clusterOptions={gridSize:8,maxZoom:15,zoom:15,styles:e.clusterStyles},e.clusterEvents={click:function(t,i){angular.forEach(i,function(t){e.clicked(t)})}},e.mask=!1,e.initialLoad=e.everciseGroups.length<200?e.everciseGroups.length:200,e.lastActiveMarker="",e.clicked=function(i){e.active=i,e.distanceFilter(i),e.isPreviewOpen=!0,e.preview.id="preview-"+i.id,e.preview.name=i.name,e.preview.image=i.directory+"/preview_"+i.image,e.preview.description=i.description,e.preview.nextClassDate=i.sessions[0].date_time,e.preview.nextClassDuration=i.sessions[0].duration,e.preview.capacity=i.capacity,e.preview.link=i.link,e.preview.sessions=i.sessions,e.preview.reviews=i.reviews,e.lastActiveMarker.icon="/assets/img/icon_default_small_pin.png",e.lastActiveMarker=i,i.icon="/assets/img/icon_default_large_pink.png",e.mask=!0,google.maps.event.trigger(e.map,"resize"),e.map.center={latitude:i.latitude,longitude:i.longitude},e.map.zoom=15,e.mask=!0,t("#"+i.id),0==e.preview.sessions.length&&$("#preview-"+i.id).find('a[href="about"]').trigger("click")},e.getStars=function(e){var t=0;if(e.length>0){for(var i=0;i<e.length;i++)t+=e[i].stars;result=Math.round(t/e.length)}else result=0;return result},e.preview={id:1,image:"",description:"",nextClassDate:"",nextClassDuration:"",capacity:"",link:""},e.hasTickets=function(e){return e.remaining>0?!0:!1},e.view=window.innerWidth>=992?"mapview":window.innerWidth>=767?"listview":"gridview",$(window).resize(function(){window.innerWidth<992&&window.innerWidth>=767?e.$apply(function(){e.view="listview"}):window.innerWidth<767&&e.$apply(function(){e.view="gridview"})}),e.$watch(function(){return e.map.bounds},function(){for(var t=0;t<e.initialLoad;t++)e.myMarkers.push(i(e.everciseGroups[t]));e.markers=e.myMarkers,$("img.lazy").lazyload({container:$(".snippet-body"),event:"sort"}),e.scrollHeight()},!0),e.scrollHeight=function(){return e.windowHeight=$(document).height(),e.navHeight=$("#nav").outerHeight(),e.searchHeight=$(".discover-nav").outerHeight(),e.filterHeight=104,e.scrollBarHeight=e.windowHeight-e.navHeight-e.searchHeight-e.filterHeight,{height:e.scrollBarHeight+"px"}},$(window).resize(function(){e.$apply(function(){e.scrollHeight()})})}]);
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http","uiGmapGoogleMapApi",function(e,t,s){e.results=laracasts.results,console.log(e.results),e.location=e.results.area.name,e.lastBounds={},e.url=e.results.url,e.mapResults=e.results.mapResults,e.pageResultNumber={page:e.results.page,temp:0},e.mapOptions={disableDefaultUI:!0,zoomControl:!0,backgroundColor:"#383d48",panControl:!1},e.distanceOptions=[];for(var a in e.results.allowed_radius)e.distanceOptions.push({value:a,name:e.results.allowed_radius[a]});e.distance={type:e.results.radius},e.circleOptions={center:{latitude:e.results.area.lat,longitude:e.results.area.lng},stroke:{color:"#50c3e2",weight:0},fill:{color:"#50c3e2",opacity:.5},radius:1609.344*e.results.radius.substring(0,e.results.radius.length-2)},e.setInitialZoom=function(){var t=e.results.radius.substring(0,e.results.radius.length-2);return 2>=t?13:3>=t?12:5>=t?11:25>t?10:9},e.clusterStyles=[{textColor:"white",url:"/assets/img/icon_default_small_pin_number.png",height:43,width:33,anchorText:[-14,9]}],e.clusterOptions={title:"click to expand",gridSize:60,maxZoom:13,styles:e.clusterStyles},e.map={zoom:e.setInitialZoom(),center:{latitude:e.results.area.lat,longitude:e.results.area.lng},control:{},clusterOptions:e.clusterOptions},e.mapEvents={dragend:function(){var t=e.map.control.getGMap(),s=t.getBounds(),a=s.getNorthEast(),r=s.getSouthWest(),l=e.originalBounds.getNorthEast(),o=e.originalBounds.getSouthWest(),u={};u.ne=a.lat()+","+a.lng(),u.sw=r.lat()+","+r.lng(),e.refreshResults=!0,l.lat()<a.lat()||l.lng()<a.lng()||o.lat()>r.lat()||o.lng()>r.lng()?(n(t,l,o),e.getData(u,!0)):(n(t,a,r),e.getData(u)),e.lastBounds={ne:{lat:a.lat(),lng:a.lng()},sw:{lat:r.lat(),lng:r.lng()}}}};var n=function(e,t,s){var a=[t,new google.maps.LatLng(t.lat(),s.lng()),s,new google.maps.LatLng(s.lat(),t.lng()),t];viewportBox=new google.maps.Polyline({path:a,strokeColor:"#FF0000",strokeOpacity:1,strokeWeight:3}),viewportBox.setMap(e)};e.refreshMap=function(){var t=e.map.control.getGMap(),s=t.getCenter();google.maps.event.trigger(t,"resize"),t.setCenter(s)};var r=function(e,t,s){s>=t||(z=google.maps.event.addListener(e,"zoom_changed",function(){google.maps.event.removeListener(z),r(e,t,s+1)}),setTimeout(function(){e.setZoom(s)},80))},l=[];e.markers=[],e.$watch(function(){return e.map},function(){o(),s.then(function(t){var s=new t.LatLng(e.results.area.lat,e.results.area.lng);e.originalBounds=new google.maps.Circle({center:s,radius:1609.344*e.results.radius.substring(0,e.results.radius.length-2)}).getBounds()})});var o=function(){for(var t in e.mapResults){var s=e.mapResults[t];for(var a in s)if(s.hasOwnProperty(a)){for(lng in s[a].location)var n=lng,r=s[a].location[lng];l.push({id:t,latitude:r,longitude:n,icon:"/assets/img/icon_default_small_pin.png",onClicked:function(){u(this.model)}})}}e.markers=l};e.everciseGroups=e.results.results.hits,e.totalHits=e.results.results.total,e.hitsPerPage=e.results.size,e.venue_id=!1,e.venueResults=!1,e.sortOptions=[{value:"best",name:"Best"},{value:"price_asc",name:"Price Asc"},{value:"price_desc",name:"Price Desc"},{value:"duration_asc",name:"Duration Asc"},{value:"duration_desc",name:"Duration Desc"},{value:"viewed_asc",name:"Viewed Asc"},{value:"viewed_desc",name:"Viewed Desc"}],e.sort={type:e.results.sort},e.refreshResults=!1,e.lastActiveMarker={};var u=function(t){e.venue_id=t.id,i(),e.refreshResults=!1,e.getData();var s=e.map.control.getGMap(),a=new google.maps.LatLng(t.latitude,t.longitude);s.panTo(a),r(s,14,s.getZoom()),e.lastActiveMarker.icon="/assets/img/icon_default_small_pin.png",e.lastActiveMarker=t,t.icon="/assets/img/icon_default_large_pink.png"};e.nextPage=function(){e.venue_id=!1,e.pageResultNumber.page=e.pageResultNumber.page+1,e.refreshResults=!1,e.getData()},e.sortChanged=function(){e.venue_id=!1,e.refreshResults=!0,i(),e.getData()},e.distanceChanged=function(){e.venue_id=!1,e.refreshResults=!0,i(),e.getData()};var i=function(){e.pageResultNumber.temp=e.pageResultNumber.page,e.pageResultNumber.page=1};e.getData=function(s,a){s="undefined"!=typeof s?s:!1,a="undefined"!=typeof a?a:!1;var n="/ajax/uk/",r={method:"POST",url:n+e.url,headers:{"X-CSRF-Token":TOKEN},data:{page:e.pageResultNumber.page,venue_id:e.venue_id,sort:e.sort.type,distance:e.distance.type,ne:s.ne,sw:s.sw,map:a}},l=t(r);l.success(function(t){t.venue_id?(e.venueResults=t.results.hits,e.pageResultNumber.page=e.pageResultNumber.temp,e.pageResultNumber.temp=0):e.refreshResults?(a&&(e.mapResults=t.mapResults),e.everciseGroups=t.results.hits,e.pageResultNumber.page=t.page,e.totalHits=t.results.total,e.hitsPerPage=t.size):(e.everciseGroups=e.everciseGroups.concat(t.results.hits),e.pageResultNumber.page=t.page,e.totalHits=t.results.total,e.hitsPerPage=t.size)}),l.error(function(e){console.log("AJAX failed!"),console.log(e)})},$(window).resize(function(){e.$apply(function(){e.refreshMap()})}),e.$watch("mapResults",function(e,t){e!=t&&o()},!0)}]);
...
function AddSessionsToCalendar(e){this.form=e,this.calendar=this.form.find("#calendar"),this.index="",this.dates=[],this.selectedDates=[],this.submitDates=[],this.currentMonthYear=[],this.init()}AddSessionsToCalendar.prototype={constructor:AddSessionsToCalendar,init:function(){this.calendar.datepicker({format:"yyyy-mm-dd",startDate:"+1d",todayHighlight:!0,multidate:!0}).on("changeDate",$.proxy(this.getCurrentDates,this)),this.addListener()},addListener:function(){$(document).on("click",".dow",$.proxy(this.dayOfWeek,this)),this.form.on("submit",$.proxy(this.submitForm,this))},getCurrentDates:function(e){var t=this;this.selectedDates=e.dates,this.dates=[],$.each(this.selectedDates,function(e,s){t.dates.push({key:s.valueOf(),dates:s})})},dayOfWeek:function(e){this.currentMonthYear=$(".datepicker-switch").first().text().split(" ");var t=new Date,s=this.getMonthNumber(this.currentMonthYear[0],this.currentMonthYear[1]),a=this.currentMonthYear[1],n=this;for(this.index=$(e.target).index(),t.setDate(1),t.setMonth(s),t.setFullYear(a);t.getDay()!==this.index;)t.setDate(t.getDate()+1);for(;t.getMonth()===s;){var i=t.getFullYear()+"-"+("0"+(t.getMonth()+1)).slice(-2)+"-"+("0"+t.getDate()).slice(-2)+" 00:00:00 AM";i=i.replace(/-/g,"/");var r=new Date(i),o=$.grep(n.dates,function(e){return e.key==r.valueOf()}),d=$.grep(n.dates,function(e){return e.key==r.valueOf()-36e5});0==o.length&&0==d.length?n.dates.push({key:r.valueOf(),dates:r}):n.dates=n.dates.filter(function(e){return e.key!==r.valueOf()}),t.setDate(t.getDate()+7)}this.setCalendarDates()},setCalendarDates:function(){var e=[],t={};$.each(this.dates,function(s,a){t[a.key]||(t[a.key]=!0,e.push(a.dates))}),this.calendar.datepicker("setDates",e)},getMonthNumber:function(e,t){var s=Date.parse(e+"1, "+t);return isNaN(s)?-1:new Date(s).getMonth()},submitForm:function(e){e.preventDefault();var t=this;$.each(this.calendar.datepicker("getDates"),function(e,s){var a=s.getDate(),n=s.getMonth()+1,i=s.getFullYear();t.submitDates.push(i+"-"+n+"-"+a)}),$('input[name="session_array"]').val(this.submitDates),this.ajaxUpload()},ajaxUpload:function(){var e=this;$.ajax(e.form.attr("action"),{type:"post",data:e.form.serialize(),dataType:"json",beforeSend:function(){e.form.find("input[type='submit']").prop("disabled",!0).parent().after('<span id="session-loading" class="icon icon-loading ml10 mt10"></span>')},success:function(t){$("#update-session").html(t.view),$('input[name="recurring"][value="no"]').click(),e.dates=[],e.submitDates=[],e.selectedDates=[],e.setCalendarDates(),$("html, body").animate({scrollTop:$("#update-container").offset().top-20},1e3),0==RemoveSession.length&&new RemoveSession($(".remove-session"))},error:function(){console.log("error")},complete:function(){e.form.find("input[type='submit']").prop("disabled",!1),$("#session-loading").remove()}})}};
...
function LocationAutoComplete(t){this.input=t,this.autoCompleteStarted=!1,this.addScript=!1,this.mapOptions={},this.address_components=[],this.town="london",this.init()}LocationAutoComplete.prototype={constructor:LocationAutoComplete,init:function(){this.form=this.input.closest("form");var t=this;if("undefined"!=typeof angular)window.google?this.load():setTimeout(function(){t.init()},1e3);else{if(!t.addScript){var o=document.createElement("script");o.src="//maps.googleapis.com/maps/api/js?libraries=places&callback=autocomplete.load",o.type="text/javascript",document.getElementsByTagName("head")[0].appendChild(o),t.addScript=!0}setTimeout(function(){t.init()},500)}},load:function(){if(void 0==google.maps||this.autoCompleteStarted){var t=this;setTimeout(function(){t.load()},500)}else{this.autoCompleteStarted=!0;var o=new google.maps.LatLng(54.8,-4.6);this.mapOptions={zoom:5,center:o,mapTypeControl:!1,panControl:!1,zoomControl:!1,streetViewControl:!1,componentRestrictions:{country:"uk"}};var t=this,e=new google.maps.places.Autocomplete(document.getElementById(t.input.attr("id")),this.mapOptions);google.maps.event.addListener(e,"place_changed",function(){var o=e.getPlace();t.address_components=o.address_components,t.getTown(),t.updateCity()})}},getTown:function(){for(var t=this,o=this.address_components,e=0;e<o.length;++e)"locality"==o[e].types[0]?t.town=o[e].long_name:"political"==o[e].types[0]?t.town=o[e].long_name:"postal_town"==o[e].types[0]&&(t.town=o[e].long_name)},updateCity:function(){this.form.find('input[name="city"]').val(this.town)}};
