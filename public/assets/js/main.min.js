...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http","uiGmapGoogleMapApi",function(e){e.groupHeight=function(){var e=$(".results").outerHeight(),t=$(".results .heading").outerHeight(),r=$(".results .nav-tabs").outerHeight(),l=$(".results .date-picker-inline").outerHeight(),s=e-t-r-l;return{height:s+"px"}},e.results=laracasts.results,console.log(e.results),e.mapOptions={disableDefaultUI:!0,zoomControl:!0,backgroundColor:"#383d48",panControl:!1},e.map={zoom:12,center:{latitude:e.results.area.lat,longitude:e.results.area.lng},control:{}},e.mapEvents={},e.availableDates=e.results.available_dates,e.everciseGroups=e.results.results.hits,e.scroll_clicked=!1,e.scrollDates=function(t,r){r.preventDefault(),e.scroll_clicked=!0;var l=$(r.target).parent(),s=l.width(),a=l.find(".content"),o=parseInt(a.css("margin-left")),n=-a.width();if("right"==t)var i=o-s;else var i=o+s;0>=i&&i>=n&&l.find(".content").css({"margin-left":i+"px"}),setTimeout(function(){e.scroll_clicked=!1},500)}}]);
