...
function AddSessions(t){this.form=t,this.calendar=this.form.find("#calendar"),this.daysOfWeek="",this.dates=[],this.index="",this.recurring=6,this.recurringFor=this.form.find("#recurring-days").val(),this.rows=[],this.currentDates=[],this.init()}AddSessions.prototype={constructor:AddSessions,init:function(){this.calendar.datepicker({format:"yyyy-mm-dd",startDate:"+1d",todayHighlight:!0,multidate:!0}),this.daysOfWeek=this.calendar.find(".dow"),this.addListener()},addListener:function(){this.daysOfWeek.on("click",$.proxy(this.dayOfWeek,this)),$('input[name="recurring"]').on("change",$.proxy(this.recurringCheck,this)),this.form.on("submit",$.proxy(this.submitForm,this)),this.form.find("#recurring-days").on("change",$.proxy(this.changeRecurringFor,this))},dayOfWeek:function(t){this.index=$(t.target).index(),this.rows=[],this.setdayOfWeeks()},setdayOfWeeks:function(){this.currentDates=this.calendar.datepicker("getDates");var t=new Date,e=t.getMonth(),a=this;for(t.setDate(1);t.getDay()!==this.index;)t.setDate(t.getDate()+1);for(;t.getMonth()===e;)a.dates.push(new Date(t.getFullYear()+"-"+(t.getMonth()+1)+"-"+t.getDate())),t.setDate(t.getDate()+7);this.setCalendarDates()},recurringDates:function(){this.currentDates=this.calendar.datepicker("getDates");var t=this;$.each(this.currentDates,function(e,a){t.dates.push(a);var s=Math.ceil(a.getDate()/7),i=a.getDay(),r=a.getMonth()+1;t.setRecurringDays(i,r,s)})},submitForm:function(t){t.preventDefault(),this.ajaxUpload()},ajaxUpload:function(){var t=this;$.ajax(t.form.attr("action"),{type:"post",data:t.form.serialize(),dataType:"json",beforeSend:function(){t.form.find("input[type='submit']").prop("disabled",!0).after('<span id="cropping-loading" class="icon icon-loading ml10"></span>')},success:function(t){console.log(t)},error:function(t,e,a){console.log(t+" - "+e+" - "+a)},complete:function(){console.log("comaplete")}})},setRecurringDays:function(t,e,a){for(var s=this,i=0;i<s.recurringFor;i++){var r=new Date;for(r.setMonth(e+i),r.setDate(1);r.getDay()!==t;)r.setDate(r.getDate()+1);for(;Math.ceil(r.getDate()/7)!==a;)r.setDate(r.getDate()+7);s.dates.push(new Date(r.getFullYear()+"-"+(r.getMonth()+1)+"-"+r.getDate()))}this.setCalendarDates()},recurringCheck:function(t){"yes"==$(t.target).val()?this.recurringDates():this.resetCalendarDates()},setCalendarDates:function(){this.calendar.datepicker("setDates",this.dates),$('input[name="session_array[]"]').val(this.dates)},resetCalendarDates:function(){this.calendar.datepicker("setDates",this.currentDates),$('input[name="session_array[]"]').val(this.currentDates)},changeRecurringFor:function(t){this.recurringFor=$(t.target).val()}};