function redirectTo(t){window.location.href=t.url}function updateCart(t){var o=$(".nav-cart");console.log(t.cartRows),o.dropdown("toggle"),$(".nav-cart").find("#cart-sub-total").html(5e3),o.find("#cart-sub-total").remove(),o.find("#cart-total").html(t.total),o.find("#cart-discount").html(t.discount)}
