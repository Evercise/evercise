...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http","uiGmapGoogleMapApi",function(e,t){e.groupHeight=function(){var e=$(".results").outerHeight(),t=$(".results .heading").outerHeight(),s=$(".results .nav-tabs").outerHeight(),l=$(".results .date-picker-inline").outerHeight(),a=e-t-s-l;return{height:a+"px"}},e.results=laracasts.results,console.log(e.results),e.resultsLoading=!1,e.mapOptions={disableDefaultUI:!0,zoomControl:!0,backgroundColor:"#383d48",panControl:!1},e.clusterStyles=[{textColor:"white",url:"/assets/img/icon_default_small_pin_number.png",height:43,width:33,anchorText:[-14,9]}],e.clusterOptions={title:"click to expand",gridSize:60,maxZoom:20,styles:e.clusterStyles},e.clusterEvents={click:function(t){var s=e.map.control.getGMap(),l=new google.maps.LatLng(t.center_.k,t.center_.C);s.panTo(l);var a=s.getZoom();s.setZoom(a>=14?18:14)},mouseover:function(e,t){angular.forEach(t,function(e){$("#venue-"+e.id).addClass("text-primary")})},mouseout:function(e,t){angular.forEach(t,function(e){$("#venue-"+e.id).removeClass("text-primary")})}},e.radius=e.results.radius,e.map={zoom:12,maxZoom:18,center:{latitude:e.results.area.lat,longitude:e.results.area.lng+.07},control:{},clusterOptions:e.clusterOptions},e.mapEvents={},e.availableDates=e.results.available_dates,shapeEverciseGroups=function(){var t=[];return angular.forEach(e.results.results.hits,function(e){t.push({id:e.id,name:e.name,icon:"/assets/img/icon_default_small_pin.png",venue:{id:e.id,name:e.venue.name,postcode:e.venue.postcode,latitude:e.venue.lat,longitude:e.venue.lng},slug:e.slug,times:e.times,price:e.default_price,onClicked:function(){s(this.model)}})}),t},e.everciseGroups=shapeEverciseGroups();var s=function(e){console.log(e)};e.scroll_clicked=!1,e.scrollDates=function(t,s){s.preventDefault(),e.scroll_clicked=!0;var l=$(s.target).parent(),a=l.width(),o=l.find(".content"),r=parseInt(o.css("margin-left")),n=-o.width();if("right"==t)var u=r-a;else var u=r+a;0>=u&&u>=n&&l.find(".content").css({"margin-left":u+"px"}),setTimeout(function(){e.scroll_clicked=!1},500)},e.selectedDate=e.results.selected_date,e.changeSelectedDate=function(t,s){t.preventDefault(),e.selectedDate=s,e.getData()},e.updateResults=function(t){console.log(t),console.log(e.results.radius)},e.url=e.results.url,e.getData=function(){var s="/ajax/uk/",l={method:"POST",url:s+e.url,headers:{"X-CSRF-Token":TOKEN},data:{date:e.selectedDate,radius:e.results.radius}},a=t(l);e.resultsLoading=!0,a.success(function(t){console.log(t),e.results=t,e.availableDates=e.results.available_dates,e.selectedDate=e.results.selected_date,e.everciseGroups=shapeEverciseGroups(),e.resultsLoading=!1}),a.error(function(t){console.log("AJAX failed!"),console.log(t),e.resultsLoading=!1})}}]);