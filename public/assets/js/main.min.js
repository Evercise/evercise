...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http","uiGmapGoogleMapApi",function(e,t){e.groupHeight=function(){var e=$(window).width();if(e>992){var t=$(".results").outerHeight(),s=$(".results .heading").outerHeight(),n=$(".results .nav-tabs").outerHeight(),i=$(".results .date-picker-inline").outerHeight(),a=t-s-n-i;return{height:a+"px"}}return{height:"auto"}},e.results=laracasts.results,e.resultsLoading=!1,e.view="list",e.switchView=function(t){e.resultsLoading=!0,e.view=t,e.resultsLoading=!1},e.mapOptions={disableDefaultUI:!0,zoomControl:!0,backgroundColor:"#383d48",panControl:!1},e.clusterStyles=[{textColor:"white",url:"/assets/img/icon_default_small_pin_number.png",height:43,width:33,anchorText:[-14,9]}],e.clusterOptions={title:"click to expand",gridSize:5,maxZoom:20,styles:e.clusterStyles,zoomOnClick:!1},e.markerEvents={click:function(t,n,i){e.selectedVenueIds=!1,e.lastActiveMarker.icon="/assets/img/icon_default_small_pin.png",e.lastActiveMarker=i,i.icon="/assets/img/icon_default_large_pink.png",s(i),setTimeout(function(){$(".mb-scroll").mCustomScrollbar("scrollTo",$("#group-"+i.id),{scrollInertia:500,timeout:20})},500)},mouseover:function(e,t,s){$("#venue-"+s.id).addClass("active")},mouseout:function(e,t,s){$("#venue-"+s.id).removeClass("active")}},e.selectedVenueIds=!1,e.selectedVenueName=!1,e.clusterEvents={click:function(t,s){e.selectedVenueIds=!1;var n=t.getCenter(),i=e.map.control.getGMap(),a=new google.maps.LatLng(n.lat(),n.lng());i.panTo(a);var r=[];angular.forEach(s,function(e){r.push(e.id)}),e.selectedVenueIds=r,e.selectedVenueName=s[0].venue.name,e.lastActiveMarker.icon="/assets/img/icon_default_small_pin.png",e.lastActiveMarker=t},mouseover:function(e,t){angular.forEach(t,function(e){$("#venue-"+e.id).addClass("active")})},mouseout:function(e,t){angular.forEach(t,function(e){$("#venue-"+e.id).removeClass("active")})}},e.radius=e.results.radius,e.initialZoom=function(){var t=e.results.radius.substring(0,e.results.radius.length-2);return 2>=t?15:3>=t?13:5>=t?12:25>t?11:10},e.map={zoom:e.initialZoom(),maxZoom:16,center:{latitude:e.results.area.lat,longitude:e.results.area.lng},control:{},clusterOptions:e.clusterOptions},e.mapEvents={},e.lastActiveMarker={},shapeEverciseGroups=function(){var t=[];return angular.forEach(e.results.results.hits,function(e){t.push({id:e.id,name:e.name,icon:"/assets/img/icon_default_small_pin.png",venue:{id:e.id,name:e.venue.name,postcode:e.venue.postcode,latitude:e.venue.lat,longitude:e.venue.lng},slug:e.slug,remaining:e.futuresessions[0].remaining,times:e.times,price:e.default_price,image:"/"+e.user.directory+"/preview_"+e.image})}),t},e.everciseGroups=shapeEverciseGroups();var s=function(t){var s=e.map.control.getGMap(),n=new google.maps.LatLng(t.venue.latitude,t.venue.longitude);s.panTo(n)};e.scrollWidth=function(){var t=$(".date-picker-inline li .day").outerWidth(),s=Object.keys(e.results.available_dates).length;return{width:t*s+"px"}},e.scroll_clicked=!1,e.scrollDates=function(t,s){s.preventDefault(),e.scroll_clicked=!0;var n=$(s.target).parent(),i=n.width(),a=n.find(".content"),r=parseInt(a.css("margin-left")),l=-a.width();if("right"==t)var o=r-i;else var o=r+i;0>=o&&o>=l&&n.find(".content").css({"margin-left":o+"px"}),setTimeout(function(){e.scroll_clicked=!1},500)},e.selectedDate=e.results.selected_date,e.changeSelectedDate=function(t,s){t.preventDefault(),e.selectedDate=s,e.getData()},$(".filter-btn, .sort-btn").click(function(e){e.preventDefault(),n($(this))});var n=function(e){e.parent("li").hasClass("active")&&window.setTimeout(function(){$(".tab-pane").removeClass("active"),e.parent("li").removeClass("active")},1)};e.sortChanged=function(t,s){t.preventDefault(),e.results.sort=s,e.getData()},e.url=e.results.url,e.getData=function(){var s="/ajax/uk/",i={method:"POST",url:s+e.url,headers:{"X-CSRF-Token":TOKEN},data:{date:e.selectedDate,radius:e.results.radius,sort:e.results.sort,search:e.results.search}},a=t(i);n($(".filter-btn, .sort-btn")),e.resultsLoading=!0,a.success(function(t){e.results=t,e.selectedDate=e.results.selected_date,e.everciseGroups=shapeEverciseGroups(),e.resultsLoading=!1;var s=e.map.control.getGMap();s.setZoom(e.initialZoom())}),a.error(function(){e.resultsLoading=!1})},e.width=window.innerWidth,$(window).resize(function(){e.width=window.innerWidth}),e.$watch("width",function(t){768>t&&(e.view="list")})}]);