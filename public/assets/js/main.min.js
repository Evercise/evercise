...
var Navigation=function(s,i,t){this.nav=s,this.hero=i,this.sticky=t,this.stickyTop=0,this.height=s.height(),this.heroClass="nav-hero",this.scroll=0,this.init()};Navigation.prototype={constructor:Navigation,init:function(){this.hero.length>0&&this.addHeroClass()},addHeroClass:function(){this.nav.addClass(this.heroClass)},removeHeroClass:function(){this.nav.removeClass(this.heroClass)}};
