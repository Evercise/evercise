...
"undefined"!=typeof angular&&app.controller("DiscoverController",["$scope","$q",function(e){function i(e){$(".class-snippet").addClass("fade-out"),$(".class-snippet").removeClass("active"),$(e).addClass("active"),$(".mb-scroll").mCustomScrollbar("scrollTo",e,{scrollInertia:500,timeout:10})}e.everciseGroups=laracasts.mapResults,e.results=e.everciseGroups.length,e.sort="id",e.dropwdownStyle={top:0,left:0},e.active={},e.maxDistance=5,e.myMarkers=[],e.markers=[];var t=function(i){console.log(i);var t={id:i.id,name:i.name,directory:i.user.directory,image:i.image,latitude:i.venue.lat,longitude:i.venue.lng,coords:{latitude:i.venue.lat,longitude:i.venue.lng},icon:"/assets/img/icon_default_small_pin.png",price:i.default_price,rating:i.ratings.length,reviews:i.ratings,description:i.description,stars:e.getStars(i.ratings),capacity:i.capacity,sessions:i.futuresessions,distance:i.distance,nextClassDate:i.futuresessions[0].date_time,nextClassDuration:i.futuresessions[0].duration,link:"/classes/"+i.slug,click:function(){e.clicked(this.model)}};return t};e.distanceFilter=function(i){return i.distance<=e.maxDistance||i==e.active?i:void 0},e.toggle=function(i,t){var s=$(i.target).offset(),n=1.5*$(i.target).height();e.dropwdownStyle={top:s.top+n,left:s.left},$(i.target).parent().hasClass("active")&&window.setTimeout(function(){$("#"+t).removeClass("active"),$(i.target).parent().removeClass("active")},1)},e.closeDropdown=function(i){window.setTimeout(function(){$(".tab-pane-sort").removeClass("active"),$("."+i+"-btn").removeClass("active")},1),window.setTimeout(function(){$(".mb-scroll").mCustomScrollbar("scrollTo","#"+e.lastActiveMarker.id,{scrollInertia:500,timeout:10})},100)},e.setDistance=function(i){e.maxDistance=i},e.changeView=function(i){e.view=i},e.isPreviewOpen=!1,e.returnPreview=function(){e.isPreviewOpen=!1},e.map={center:{latitude:50,longitude:-.2},pan:{},options:{streetViewControl:!1,maxZoom:19,minZoom:3},zoom:12},e.clusterStyles=[{textColor:"white",url:"/assets/img/icon_default_small_pin_number.png",height:43,width:33,anchorText:[-14,9]}],e.clusterOptions={gridSize:8,maxZoom:20,zoom:15,styles:e.clusterStyles},e.clusterEvents={click:function(i,t){angular.forEach(t,function(i){e.clicked(i)})}},e.mask=!1,e.initialLoad=e.everciseGroups.length<200?e.everciseGroups.length:200,e.lastActiveMarker="",e.clicked=function(t){e.active=t,e.distanceFilter(t),e.isPreviewOpen=!0,e.preview.id="preview-"+t.id,e.preview.name=t.name,e.preview.image=t.directory+"/search_"+t.image,e.preview.description=t.description,e.preview.nextClassDate=t.sessions[0].date_time,e.preview.nextClassDuration=t.sessions[0].duration,e.preview.capacity=t.capacity,e.preview.link=t.link,e.preview.sessions=t.sessions,e.preview.reviews=t.reviews,e.lastActiveMarker.icon="/assets/img/icon_default_small_pin.png",e.lastActiveMarker=t,t.icon="/assets/img/icon_default_small_pin_grey.png",e.mask=!0,google.maps.event.trigger(e.map,"resize"),e.map.center={latitude:t.latitude,longitude:t.longitude},e.map.zoom=15,e.mask=!0,i("#"+t.id)},e.getStars=function(e){var i=0;if(e.length>0){for(var t=0;t<e.length;t++)i+=e[t].stars;result=Math.round(i/e.length)}else result=0;return result},e.preview={id:1,image:"",description:"",nextClassDate:"",nextClassDuration:"",capacity:"",link:""},e.hasTickets=function(e){return e.remaining>0?!0:!1},e.view=window.innerWidth>=1200?"mapview":window.innerWidth>=767?"listview":"gridview",$(window).resize(function(){window.innerWidth<1200&&window.innerWidth>=767?e.$apply(function(){e.view="listview"}):window.innerWidth<767&&e.$apply(function(){e.view="gridview"})}),e.$watch(function(){return e.map.bounds},function(){for(var i=0;i<e.initialLoad;i++)e.myMarkers.push(t(e.everciseGroups[i]));e.markers=e.myMarkers,$("img.lazy").lazyload({container:$(".snippet-body")})},!0)}]);
