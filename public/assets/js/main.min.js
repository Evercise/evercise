...
function MailPopup(i){this.link=i,this.target="",this.form="",this.validIcon="glyphicon glyphicon-ok",this.invalidIcon="glyphicon glyphicon-remove",this.validatingIcon="glyphicon glyphicon-refresh",this.subject={validators:{notEmpty:{message:"Your message requires a subject"}}},this.body={validators:{notEmpty:{message:"Your message requires content"}}},this.addListener()}MailPopup.prototype={constructor:MailPopup,addListener:function(){this.link.on("click",$.proxy(this.getPopup,this))},getPopup:function(i){i.preventDefault(),this.target=$(i.target).attr("href"),$(i.target).prop("disabled",!0).after('<span id="mail-loading" class="icon icon-loading ml10 mt25"></span>'),this.ajaxGet()},ajaxGet:function(){var i=this;$.get(this.target,function(a){i.link.after(a.view),$("#mail-trainer").modal("show"),i.link.replaceWith('<a  href="#mail-trainer" class="icon icon-mail ml10 mt25" data-toggle="modal" data-target="#mail-trainer"></a>'),i.form=$("#mail_trainer"),i.validation()}).fail(function(){alert("error")}).always(function(){i.link.prop("disabled",!1),$("#mail-loading").remove()})},validation:function(){var i=this;this.form.bootstrapValidator({message:"This value is not valid",feedbackIcons:{valid:this.validIcon,invalid:this.invalidIcon,validating:this.validatingIcon},fields:{mail_subject:this.subject,mail_body:this.body}}).on("success.form.bv",function(a){a.preventDefault(),i.ajaxUpload()})},ajaxUpload:function(){var i=this;$.ajax(i.form.attr("action"),{type:"post",data:i.form.serialize(),dataType:"json",beforeSend:function(){i.form.find("input[type='submit']").prop("disabled",!0).after('<span id="sending-loading" class="icon icon-loading ml10 mt15"></span>')},success:function(i){$("#mail-trainer").modal("hide"),$("body").append(i.view)},error:function(i,a,t){console.log(i+" - "+a+" - "+t)},complete:function(){i.form.find("input[type=submit]").prop("disabled",!1),$("#sending-loading").remove()}})}};
