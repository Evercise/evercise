function redirectTo(i){window.location.href=i.url}function editClass(i){$("#"+i.id).html(i.view),$("#submit-"+i.id).hide(),$("#"+i.id).parent().collapse("show"),$("#infoToggle-"+i.id).removeClass("hide")}
...
var ToggleSwitch=function(t){this.button=t,this.html="",this.toggledHtml="",this.init()};ToggleSwitch.prototype={constructor:ToggleSwitch,init:function(){var t=this;this.button.on("click",function(i){i.preventDefault(),t.changeState(),$($(this).attr("data-target")).collapse("toggle")})},changeState:function(){this.html=this.button.html(),this.toggledHtml=this.button.data("toggled"),this.button.html(this.toggledHtml),this.button.data("toggled",this.html)}};
