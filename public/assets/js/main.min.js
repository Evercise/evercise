...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http","uiGmapIsReady","Angularytics","uiGmapGoogleMapApi","$window",function(e,t,s,r,n){e.groupHeight=function(){var e=$(window).width();if(e>992){var t=$(".results").outerHeight(),s=$(".results .heading").outerHeight(),r=$(".results .nav-tabs").outerHeight(),n=$(".results .date-picker-inline").outerHeight(),a=t-s-r-n;return{height:a+"px"}}return{height:"auto"}},e.width=window.innerWidth,e.results=laracasts.results,e.resultsLoading=!1,e.view="list",e.switchView=function(t){e.resultsLoading=!0,e.view=t,e.resultsLoading=!1},e.mapOptions={minZoom:11,maxZoom:17,disableDefaultUI:!0,zoomControl:!0,backgroundColor:"#383d48",panControl:!1},e.selectedVenueIds=!1,e.selectedVenueName=!1,e.otherDates=[],e.closeVenue=function(){e.selectedVenueIds=!1,e.otherDates.length=0,e.lastActiveMarker.icon=e.activeIcon},e.radius=e.results.radius,e.initialZoom=function(){var t=e.results.radius.substring(0,e.results.radius.length-2),s=e.results.results.total;return 1==s?10==t?10:5==t?12:3==t?13:14:1==t?14:3==t?13:5==t?12:10==t?11:void 0},e.circleOptions={center:{latitude:e.results.area.lat,longitude:e.results.area.lng},stroke:{color:"#50c3e2",weight:2},fill:{opacity:0},radius:1609.344*e.results.radius.substring(0,e.results.radius.length-2)},e.setMapCenter=function(){var t=e.results.radius.substring(0,e.results.radius.length-2),s=e.results.area.lng;return e.width>=992?10==t?s+.13:5==t?s+.09:3==t?s+.04:1==t?s+.02:void 0:s},e.map={zoom:e.initialZoom(),center:{latitude:e.results.area.lat,longitude:e.setMapCenter()},control:{}},e.bounds={},e.mapEvents={drag:function(){},dragend:function(){var t=a();t&&(e.bounds=t,e.getData(!0))},zoom_changed:function(){}};var a=function(){var t=e.map.control.getGMap(),s=t.getBounds(),r=s.getNorthEast(),n=s.getSouthWest(),a={};return n.lat()>e.furthestBottom&&r.lat()<e.furthestTop&&n.lng()>e.furthestLeft&&r.lng()<e.furthestRight?!1:(n.lat()<e.furthestBottom&&(e.furthestBottom=n.lat()),r.lat()>e.furthestTop&&(e.furthestTop=r.lat()),n.lng()<e.furthestLeft&&(e.furthestLeft=n.lng()),r.lng()>e.furthestRight&&(e.furthestRight=r.lng()),a.ne=e.furthestTop+","+e.furthestRight,a.sw=e.furthestBottom+","+e.furthestLeft,a)};e.lastActiveMarker={},e.everciseGroups=[],shapeEverciseGroups=function(){for(var t=[],s=[],r=0;r<e.results.results.hits.length;r++){var n=e.results.results.hits[r],a=!0;if(a){var i=e.inactiveIcon,o=!1,u=-1,l=[],c=!1,d=$.map(n.dates,function(t,r){return r==e.activeDate?(i=e.activeIcon,o=!0,u=10,s.push({venueId:n.venue.id,groupId:n.id}),[t]):void l.push(r)});e.passInGroupId==n.id&&(i=e.selectedIcon,c=!0,e.otherDates=l,u=20);var g=n.score;e.results.search||(g=r),t.push({id:n.id,keyId:n.id+"."+Math.floor(6e3*Math.random())+1,name:n.name,icon:i,options:{zIndex:u},venue:{id:n.venue.id,name:n.venue.name,postcode:n.venue.postcode,latitude:n.venue.lat,longitude:n.venue.lng},active:o,tempIcon:c,slug:n.slug,score:g,remaining:n.futuresessions[0].remaining,times:d[0],otherDates:l,price:n.default_price,image:"/"+n.user.directory+"/preview_"+n.image})}}return e.venues=s,t},e.markerEvents={click:function(t,s,r){if(e.passInGroupId=r.id,e.otherDates=r.otherDates,r.active){for(var n=0;n<e.everciseGroups.length;n++)e.everciseGroups[n].tempIcon&&(e.everciseGroups[n].icon=e.activeIcon,e.everciseGroups[n].tempIcon=!1);e.lastActiveMarker.icon=e.activeIcon,e.lastActiveMarker=r,r.icon=e.selectedIcon,r.options.zIndex=20,i(t,s,r)}else e.activeDate=r.otherDates[0],e.everciseGroups=shapeEverciseGroups(),e.lastActiveMarker=r,i(t,s,r)},mouseover:function(){},mouseout:function(){}};var i=function(t,s,r){for(var n=r.venue.id,a=[],i=0;i<e.venues.length;i++)n==e.venues[i].venueId&&a.push(e.venues[i].groupId);a.length>1?(e.selectedVenueIds=!0,e.selectedVenueIds=a,e.selectedVenueName=r.venue.name):(e.activeGroupId=r.id,e.selectedVenueIds=!1,setTimeout(function(){$(".mb-scroll").mCustomScrollbar("scrollTo",$("#group-"+r.id),{scrollInertia:500,timeout:20})},100),setTimeout(function(){o(r)},200))};s.promise(1).then(function(){e.activeIcon={url:"/assets/img/icon_default_pin_active.svg",size:new google.maps.Size(40,40),scaledSize:new google.maps.Size(40,40)},e.inactiveIcon={url:"/assets/img/icon_default_pin_inactive.svg",size:new google.maps.Size(28,28),scaledSize:new google.maps.Size(28,28)},e.selectedIcon={url:"/assets/img/icon_default_pin_selected.svg",size:new google.maps.Size(40,40),scaledSize:new google.maps.Size(40,40)},e.everciseGroups=shapeEverciseGroups()}),e.$watch(function(){return e.map},function(){n.then(function(t){var s=new t.LatLng(e.results.area.lat,e.results.area.lng);e.originalBounds=new google.maps.Circle({center:s,radius:1609.344*e.results.radius.substring(0,e.results.radius.length-2)}).getBounds();var r=e.originalBounds.getNorthEast(),n=e.originalBounds.getSouthWest();e.furthestTop=r.lat(),e.furthestBottom=n.lat(),e.furthestLeft=n.lng(),e.furthestRight=r.lng()})}),e.isClassVisible=function(t){return-1!==$.inArray(t.id,e.selectedVenueIds)?!0:1==t.active};var o=function(t){var s=e.map.control.getGMap(),r=new google.maps.LatLng(t.venue.latitude,t.venue.longitude);s.panTo(r)};e.available_dates=e.results.available_dates,e.scroll_clicked=!1,e.scrollDates=function(t,s){s.preventDefault(),e.scroll_clicked=!0;var r,n=e.selectedDate,a=n.split(/[^0-9]/),i=parseInt(a[0],10),o=parseInt(a[1],10)-1,u=parseInt(a[2],10);r=new Date(i,o,u),r.setDate("right"==t?r.getDate()+7:r.getDate()-7),e.selectedDate=r.getFullYear()+"-"+("0"+(r.getMonth()+1)).slice(-2)+"-"+("0"+r.getDate()).slice(-2),e.getData(),setTimeout(function(){e.scroll_clicked=!1},500)},e.selectedDate=e.results.selected_date,e.activeDate=e.results.selected_date,e.changeActiveDate=function(t,s){t.preventDefault(),e.activeDate=s,e.everciseGroups=shapeEverciseGroups(),setTimeout(function(){$(".mb-scroll").mCustomScrollbar("scrollTo",$("#group-"+e.activeGroupId),{scrollInertia:500,timeout:20})},100)},e.openFilter=null,$(document).on("click",".filter-btn, .sort-btn",function(e){e.preventDefault(),u($(this))});var u=function(t){t.attr("class")==e.openFilter?(e.openFilter=null,window.setTimeout(function(){$(".tab-pane").removeClass("active"),t.parent("li").removeClass("active")},1)):e.openFilter=t.attr("class")};e.sortChanged=function(t,s){t.preventDefault(),e.results.sort=s},e.sortGroups="score",e.$watch("results.sort",function(t,s){t!=s&&(e.sortGroups="distance"==t?"distance":"price_desc"==t?"-price":"price_asc"==t?"price":"score"),$(".tab-pane").removeClass("active"),$(".sort-btn").parent("li").removeClass("active"),e.openFilter=null},!0),e.url=e.results.url,e.getData=function(s){var r=e.bounds.ne,n=e.bounds.sw;if("undefined"==typeof s||null===s){var s=!1;r=!1,n=!1}var a="/ajax/uk/",i={method:"POST",url:a+e.url,headers:{"X-CSRF-Token":TOKEN},data:{date:e.selectedDate,radius:e.results.radius,sort:e.results.sort,search:e.results.search,ne:r,sw:n}},o=t(i);e.openFilter=null,$(".tab-pane").removeClass("active"),$(".filter-btn, .sort-btn").parent().removeClass("active"),e.resultsLoading=!0,o.success(function(t){e.results=t,e.available_dates=e.results.available_dates,e.selectedDate=e.results.selected_date,e.activeDate=e.results.selected_date,e.activeGroupId=!1,e.everciseGroups=shapeEverciseGroups(),s||(e.map.center={latitude:e.results.area.lat,longitude:e.setMapCenter()},e.map.zoom=e.initialZoom(),e.circleOptions.center={latitude:e.results.area.lat,longitude:e.results.area.lng},e.circleOptions.radius=1609.344*e.results.radius.substring(0,e.results.radius.length-2)),e.resultsLoading=!1}),o.error(function(){e.resultsLoading=!1})},$(window).resize(function(){e.width=window.innerWidth}),e.$watch("width",function(t){768>t&&(e.view="list")}),e.gaEventTrigger=function(e,t,s){r.trackEvent(e,t,s)}}]);
