...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http","uiGmapGoogleMapApi","Angularytics",function(e,t,s,n){e.groupHeight=function(){var e=$(window).width();if(e>992){var t=$(".results").outerHeight(),s=$(".results .heading").outerHeight(),n=$(".results .nav-tabs").outerHeight(),r=$(".results .date-picker-inline").outerHeight(),i=t-s-n-r;return{height:i+"px"}}return{height:"auto"}},e.width=window.innerWidth,e.results=laracasts.results,console.log(e.results),e.resultsLoading=!1,e.view="list",e.switchView=function(t){e.resultsLoading=!0,e.view=t,e.resultsLoading=!1},e.mapOptions={disableDefaultUI:!0,zoomControl:!0,backgroundColor:"#383d48",panControl:!1},e.clusterStyles=[{textColor:"white",url:"/assets/img/icon_default_small_pin_number.png",height:43,width:33,anchorText:[-14,9]}],e.clusterOptions={title:"click to expand",gridSize:5,maxZoom:20,styles:e.clusterStyles,zoomOnClick:!1},e.markerEvents={click:function(t,s,n){e.selectedVenueIds=!1,e.lastActiveMarker.icon="/assets/img/icon_default_small_pin.png",e.lastActiveMarker=n,n.icon="/assets/img/icon_default_large_pink.png",r(n),setTimeout(function(){$(".mb-scroll").mCustomScrollbar("scrollTo",$("#group-"+n.id),{scrollInertia:500,timeout:20})},500)},mouseover:function(e,t,s){$("#venue-"+s.id).addClass("active")},mouseout:function(e,t,s){$("#venue-"+s.id).removeClass("active")}},e.selectedVenueIds=!1,e.selectedVenueName=!1,e.clusterEvents={click:function(t,s){e.selectedVenueIds=!1;var n=t.getCenter(),r=e.map.control.getGMap(),i=new google.maps.LatLng(n.lat(),n.lng());r.panTo(i);var a=[];angular.forEach(s,function(e){a.push(e.id)}),e.selectedVenueIds=a,e.selectedVenueName=s[0].venue.name,e.lastActiveMarker.icon="/assets/img/icon_default_small_pin.png",e.lastActiveMarker=t},mouseover:function(e,t){angular.forEach(t,function(e){$("#venue-"+e.id).addClass("active")})},mouseout:function(e,t){angular.forEach(t,function(e){$("#venue-"+e.id).removeClass("active")})}},e.radius=e.results.radius,e.initialZoom=function(){var t=e.results.radius.substring(0,e.results.radius.length-2),s=e.results.results.total;if(1==s){var n=e.results.results.hits[0].distance;if(n>7)return 10;if(n>5)return 12;if(n>2)return 14}return 1==t?14:3==t?13:5==t?12:10==t?11:void 0},e.circleOptions={center:{latitude:e.results.area.lat,longitude:e.results.area.lng},stroke:{color:"#50c3e2",weight:2},fill:{opacity:0},radius:1609.344*e.results.radius.substring(0,e.results.radius.length-2)},e.setMapCenter=function(){var t=e.results.radius.substring(0,e.results.radius.length-2),s=e.results.area.lng;return e.width>=992?10==t?s+.13:5==t?s+.09:3==t?s+.04:1==t?s+.02:void 0:s},e.map={zoom:e.initialZoom(),maxZoom:16,center:{latitude:e.results.area.lat,longitude:e.setMapCenter()},control:{},clusterOptions:e.clusterOptions},e.bounds={},e.mapEvents={dragend:function(){var t=e.map.control.getGMap(),s=t.getBounds(),n=s.getNorthEast(),r=s.getSouthWest(),i={};i.ne=n.lat()+","+n.lng(),i.sw=r.lat()+","+r.lng(),e.bounds=i,e.getData()}},e.lastActiveMarker={},shapeEverciseGroups=function(){var t=[];return angular.forEach(e.results.results.hits,function(e){t.push({id:e.id,name:e.name,icon:"/assets/img/icon_default_small_pin.png",venue:{id:e.id,name:e.venue.name,postcode:e.venue.postcode,latitude:e.venue.lat,longitude:e.venue.lng},slug:e.slug,remaining:e.futuresessions[0].remaining,times:e.times,price:e.default_price,image:"/"+e.user.directory+"/preview_"+e.image})}),t},e.everciseGroups=shapeEverciseGroups();var r=function(t){var s=e.map.control.getGMap(),n=new google.maps.LatLng(t.venue.latitude,t.venue.longitude);s.panTo(n)};e.scrollWidth=function(){var t=$(".date-picker-inline li .day").outerWidth(),s=Object.keys(e.results.available_dates).length;return{width:t*s+"px"}},e.scrollBtnWidth=function(){if(e.width<992){var t=e.width-2*$(".date-picker-inline .scroll").outerWidth();if(e.width>767)var s=t/14;else var s=t/5;return{width:s+"px"}}},e.scroll_clicked=!1,e.scrollDates=function(t,s){s.preventDefault(),e.scroll_clicked=!0;var n=$(s.target).parent();if(e.width<992)var r=n.outerWidth()-2*$(".date-picker-inline .scroll").outerWidth();else var r=n.width();var i=n.find(".content"),a=parseInt(i.css("margin-left")),l=-i.width();if(console.log(a-r),"right"==t)var o=a-r;else var o=a+r;0>=o&&o>=l&&n.find(".content").css({"margin-left":o+"px"}),setTimeout(function(){e.scroll_clicked=!1},500)},e.selectedDate=e.results.selected_date,e.changeSelectedDate=function(t,s){t.preventDefault(),e.selectedDate=s,e.getData()},e.openFilter=null,$(document).on("click",".filter-btn, .sort-btn",function(e){e.preventDefault(),i($(this))});var i=function(t){t.attr("class")==e.openFilter?(e.openFilter=null,window.setTimeout(function(){$(".tab-pane").removeClass("active"),t.parent("li").removeClass("active")},1)):e.openFilter=t.attr("class")};e.sortChanged=function(t,s){t.preventDefault(),e.results.sort=s,e.getData()},e.url=e.results.url,e.getData=function(){var s="/ajax/uk/",n={method:"POST",url:s+e.url,headers:{"X-CSRF-Token":TOKEN},data:{date:e.selectedDate,radius:e.results.radius,sort:e.results.sort,search:e.results.search,ne:e.bounds.ne,sw:e.bounds.sw}},r=t(n);e.openFilter=null,$(".tab-pane").removeClass("active"),$(".filter-btn, .sort-btn").parent().removeClass("active"),e.resultsLoading=!0,r.success(function(t){console.log(t),e.results=t,e.selectedDate=e.results.selected_date,e.everciseGroups=shapeEverciseGroups(),e.resultsLoading=!1,e.circleOptions={center:{latitude:e.results.area.lat,longitude:e.results.area.lng},stroke:{color:"#50c3e2",weight:2},fill:{opacity:0},radius:1609.344*e.results.radius.substring(0,e.results.radius.length-2)},e.map.center={latitude:e.results.area.lat,longitude:e.setMapCenter()},e.map.zoom=e.initialZoom()}),r.error(function(){e.resultsLoading=!1})},$(window).resize(function(){e.width=window.innerWidth}),e.$watch(function(){return e.map},function(){s.then(function(t){var s=new t.LatLng(e.results.area.lat,e.results.area.lng);e.originalBounds=new google.maps.Circle({center:s,radius:1609.344*e.results.radius.substring(0,e.results.radius.length-2)}).getBounds(),e.bounds={ne:e.originalBounds.getNorthEast().toString(),sw:e.originalBounds.getSouthWest().toString()}})}),e.$watch("width",function(t){768>t&&(e.view="list")}),e.gaEventTrigger=function(e,t,s){n.trackEvent(e,t,s)}}]);
