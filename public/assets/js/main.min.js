...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http","uiGmapGoogleMapApi",function(e,t){e.groupHeight=function(){var e=$(".results").outerHeight(),t=$(".results .heading").outerHeight(),s=$(".results .nav-tabs").outerHeight(),a=$(".results .date-picker-inline").outerHeight(),l=e-t-s-a;return{height:l+"px"}},e.results=laracasts.results,console.log(e.results),e.resultsLoading=!1,e.mapOptions={disableDefaultUI:!0,zoomControl:!0,backgroundColor:"#383d48",panControl:!1},e.clusterStyles=[{textColor:"white",url:"/assets/img/icon_default_small_pin_number.png",height:43,width:33,anchorText:[-14,9]}],e.clusterOptions={title:"click to expand",gridSize:60,maxZoom:20,styles:e.clusterStyles},e.clusterEvents={click:function(t){var s=e.map.control.getGMap(),a=new google.maps.LatLng(t.center_.k,t.center_.C);s.panTo(a);var l=s.getZoom();s.setZoom(l>=14?18:14)},mouseover:function(e,t){angular.forEach(t,function(e){$("#venue-"+e.id).addClass("text-primary")})},mouseout:function(e,t){angular.forEach(t,function(e){$("#venue-"+e.id).removeClass("text-primary")})}},e.radius=e.results.radius,e.map={zoom:12,maxZoom:18,center:{latitude:e.results.area.lat,longitude:e.results.area.lng+.07},control:{},clusterOptions:e.clusterOptions},e.mapEvents={},e.availableDates=e.results.available_dates,shapeEverciseGroups=function(){var t=[];return angular.forEach(e.results.results.hits,function(e){t.push({id:e.id,name:e.name,icon:"/assets/img/icon_default_small_pin.png",venue:{id:e.id,name:e.venue.name,postcode:e.venue.postcode,latitude:e.venue.lat,longitude:e.venue.lng},slug:e.slug,times:e.times,price:e.default_price,onClicked:function(){s(this.model)}})}),t},e.everciseGroups=shapeEverciseGroups();var s=function(e){console.log(e)};e.scroll_clicked=!1,e.scrollDates=function(t,s){s.preventDefault(),e.scroll_clicked=!0;var a=$(s.target).parent(),l=a.width(),r=a.find(".content"),n=parseInt(r.css("margin-left")),o=-r.width();if("right"==t)var i=n-l;else var i=n+l;0>=i&&i>=o&&a.find(".content").css({"margin-left":i+"px"}),setTimeout(function(){e.scroll_clicked=!1},500)},e.selectedDate=e.results.selected_date,e.changeSelectedDate=function(t,s){t.preventDefault(),e.selectedDate=s,e.getData()},$(".filter-btn, .sort-btn").click(function(e){e.preventDefault();var t=$(this);t.parent("li").hasClass("active")&&window.setTimeout(function(){$(".tab-pane").removeClass("active"),t.parent("li").removeClass("active")},1)}),e.url=e.results.url,e.getData=function(){var s="/ajax/uk/",a={method:"POST",url:s+e.url,headers:{"X-CSRF-Token":TOKEN},data:{date:e.selectedDate,radius:e.results.radius}},l=t(a);e.resultsLoading=!0,l.success(function(t){console.log(t),e.results=t,e.availableDates=e.results.available_dates,e.selectedDate=e.results.selected_date,e.everciseGroups=shapeEverciseGroups(),e.resultsLoading=!1}),l.error(function(t){console.log("AJAX failed!"),console.log(t),e.resultsLoading=!1})}}]);
