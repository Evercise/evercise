...
function Withdrawal(t){this.form=t,this.addListeners()}Withdrawal.prototype={constructor:Withdrawal,addListeners:function(){this.form.on("submit",$.proxy(this.getWithrawelView,this))},getWithrawelView:function(t){t.preventDefault(),this.ajax()},ajax:function(){var t=this;$.ajax(t.form.attr("action"),{type:"post",data:t.form.serialize(),dataType:"json",beforeSend:function(){t.form.find('input[type="submit"]').prop("disabled",!0)},success:function(e){t.form.append(e.view),t.form.find('input[type="submit"]').replaceWith('<a  href="#request-withdrawal" class="btn btn-default" data-toggle="modal" data-target="#request-withdrawal">Request Funds</a>'),t.form.find("#request-withdrawal").modal("show")},error:function(t,e,a){console.log(t+" - "+e+" - "+a)},complete:function(){t.form.find('input[type="submit"]').prop("disabled",!1)}})}};
