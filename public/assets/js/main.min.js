...
function LocationAutoComplete(t){this.input=t,this.autoCompleteStarted=!1,this.addScript=!1,this.mapOptions={},this.address_components=[],this.town="london",this.width=0,this.init()}LocationAutoComplete.prototype={constructor:LocationAutoComplete,init:function(){this.form=this.input.closest("form");var t=this;if("undefined"!=typeof angular)window.google?this.load():setTimeout(function(){t.init()},500);else{if(!t.addScript){var e=document.createElement("script");e.src="//maps.googleapis.com/maps/api/js?libraries=places&callback=autocomplete.load",e.type="text/javascript",document.getElementsByTagName("head")[0].appendChild(e),t.addScript=!0}setTimeout(function(){t.init()},500)}},load:function(){if(void 0==google.maps||this.autoCompleteStarted){var t=this;setTimeout(function(){t.load()},500)}else{this.autoCompleteStarted=!0,this.mapOptions={componentRestrictions:{country:"uk"}};var t=this,e=new google.maps.places.Autocomplete(document.getElementById(t.input.attr("id")),this.mapOptions);t.addListeners(),google.maps.event.addListener(e,"place_changed",function(){var i=e.getPlace();t.address_components=i.address_components,t.getTown(),t.updateCity()})}},getTown:function(){for(var t=this,e=this.address_components,i=0;i<e.length;++i)"locality"==e[i].types[0]?t.town=e[i].long_name:"political"==e[i].types[0]?t.town=e[i].long_name:"postal_town"==e[i].types[0]&&(t.town=e[i].long_name)},updateCity:function(){this.form.find('input[name="city"]').val(this.town)},addListeners:function(){this.input.on("click",$.proxy(this.addNearMe,this))},addNearMe:function(t){this.width=$(t.target).parent().width();var e=$(".pac-container");0==$("#near-me").length&&(e.append('<li id="near-me" class="heading locator"><span class="icon icon-lg icon-locator-pink"></span> my Current Location</li>'),this.setWidth(e))},setWidth:function(t){if(t.is(":visible"))t.width(this.width-2);else{var e=this;setTimeout(function(){e.setWidth(t)},300)}}};
...
function myLocation(){this.town="london",this.form,this.addListeners()}myLocation.prototype={constructor:myLocation,addListeners:function(){$(document).on("click",".locator",$.proxy(this.init,this))},init:function(o){this.form=$(o.target).closest("form"),o.preventDefault(),o.stopPropagation(),navigator.geolocation.getCurrentPosition($.proxy(this.displayPosition,this),$.proxy(this.displayError,this))},displayPosition:function(o){var t=o.coords.latitude,n=o.coords.longitude;this.getLocation(t,n)},displayError:function(o){var t={1:"Permission denied",2:"Position unavailable",3:"Request timeout"};alert("Error: "+t[o.code])},getLocation:function(o,t){geocoder=new google.maps.Geocoder;var n=new google.maps.LatLng(o,t),i=this;geocoder.geocode({latLng:n},function(o,t){if(o[0]&&"OK"==t){var n=o[0].formatted_address;i.form.find('input[name="location"]').val(n),i.getTown(o[0].address_components),i.form.find('input[name="city"]').val(this.town)}else console.log(t)})},getTown:function(o){for(var t=this,n=o,i=0;i<n.length;++i)"locality"==n[i].types[0]?t.town=n[i].long_name:"political"==n[i].types[0]?t.town=n[i].long_name:"postal_town"==n[i].types[0]&&(t.town=n[i].long_name)}};
