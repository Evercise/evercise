...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http",function(e,s){e.results=laracasts.results,console.log(e.results),e.location=e.results.area.name,e.mapResults=e.results.mapResults,e.pageResultNumber={page:e.results.page,temp:0},e.mapOptions={disableDefaultUI:!0,zoomControl:!0,backgroundColor:"#383d48",panControl:!1},e.clusterStyles=[{textColor:"white",url:"/assets/img/icon_default_small_pin_number.png",height:43,width:33,anchorText:[-14,9]}],e.clusterOptions={title:"click to expand",gridSize:60,maxZoom:11,styles:e.clusterStyles},e.map={zoom:8,center:{latitude:e.results.area.lat,longitude:e.results.area.lng},control:{},clusterOptions:e.clusterOptions},e.mapEvents={},e.refreshMap=function(){var s=e.map.control.getGMap(),t=s.getCenter();google.maps.event.trigger(s,"resize"),s.setCenter(t)};var t=function(e,s,a){a>=s||(z=google.maps.event.addListener(e,"zoom_changed",function(){google.maps.event.removeListener(z),t(e,s,a+1)}),setTimeout(function(){e.setZoom(a)},80))},a=[];e.markers=[],e.$watch(function(){return e.map.bounds},function(){for(var s in e.mapResults){var t=e.mapResults[s];for(var r in t)if(t.hasOwnProperty(r)){for(lng in t[r].location)var u=lng,o=t[r].location[lng];a.push({id:s,latitude:o,longitude:u,icon:"/assets/img/icon_default_small_pin.png",onClicked:function(){n(this.model)}})}}e.markers=a,25!=e.results.radius&&console.log("do business")}),e.everciseGroups=e.results.results.hits,e.totalHits=e.results.results.total,e.hitsPerPage=e.results.size,e.venue_id=!1,e.venueResults=!1,e.sortOptions=[{value:"best",name:"Best"},{value:"price_asc",name:"Price Asc"},{value:"price_desc",name:"Price Desc"},{value:"duration_asc",name:"Duration Asc"},{value:"duration_desc",name:"Duration Desc"},{value:"viewed_asc",name:"Viewed Asc"},{value:"viewed_desc",name:"Viewed Desc"}],e.sort={type:e.results.sort},e.distanceOptions=[];for(var r in e.results.allowed_radius)e.distanceOptions.push({value:r,name:e.results.allowed_radius[r]});e.distance={type:e.results.radius},e.refreshResults=!1,e.lastActiveMarker={};var n=function(s){e.venue_id=s.id,u(),e.refreshResults=!1,e.getData();var a=e.map.control.getGMap(),r=new google.maps.LatLng(s.latitude,s.longitude);a.panTo(r),t(a,12,a.getZoom()),e.lastActiveMarker.icon="/assets/img/icon_default_small_pin.png",e.lastActiveMarker=s,s.icon="/assets/img/icon_default_large_pink.png"};e.nextPage=function(){e.venue_id=!1,e.pageResultNumber.page=e.pageResultNumber.page+1,e.refreshResults=!1,e.getData()},e.sortChanged=function(){e.venue_id=!1,e.refreshResults=!0,u(),e.getData()},e.distanceChanged=function(){e.venue_id=!1,e.refreshResults=!0,u(),e.getData()};var u=function(){e.pageResultNumber.temp=e.pageResultNumber.page,e.pageResultNumber.page=1};e.getData=function(){var t={method:"POST",url:"/ajax/uk/"+e.location,headers:{"X-CSRF-Token":TOKEN},data:{page:e.pageResultNumber.page,venue_id:e.venue_id,sort:e.sort.type,distance:e.distance.type}},a=s(t);a.success(function(s){s.venue_id?(e.venueResults=s.results.hits,e.pageResultNumber.page=e.pageResultNumber.temp,e.pageResultNumber.temp=0):e.refreshResults?(e.everciseGroups=s.results.hits,e.pageResultNumber.page=s.page):(e.everciseGroups=e.everciseGroups.concat(s.results.hits),e.pageResultNumber.page=s.page)}),a.error(function(e){console.log("AJAX failed!"),console.log(e)})},$(window).resize(function(){e.$apply(function(){e.refreshMap()})})}]);
