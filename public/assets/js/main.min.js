...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http",function(e,t){e.results=laracasts.results,console.log(e.results),e.location=e.results.area.name,e.ne=!1,e.sw=!1,e.url=e.results.url,e.mapResults=e.results.mapResults,e.pageResultNumber={page:e.results.page,temp:0},e.mapOptions={disableDefaultUI:!0,zoomControl:!0,backgroundColor:"#383d48",panControl:!1},e.distanceOptions=[];for(var s in e.results.allowed_radius)e.distanceOptions.push({value:s,name:e.results.allowed_radius[s]});e.distance={type:e.results.radius},e.circleOptions={center:{latitude:e.results.area.lat,longitude:e.results.area.lng},stroke:{color:"#50c3e2",weight:0},fill:{color:"#50c3e2",opacity:.5},radius:1609.344*e.results.radius.substring(0,e.results.radius.length-2)},e.setInitialZoom=function(){var t=e.results.radius.substring(0,e.results.radius.length-2);return 2>=t?13:3>=t?12:5>=t?11:25>t?10:9},e.clusterStyles=[{textColor:"white",url:"/assets/img/icon_default_small_pin_number.png",height:43,width:33,anchorText:[-14,9]}],e.clusterOptions={title:"click to expand",gridSize:60,maxZoom:13,styles:e.clusterStyles},e.map={zoom:e.setInitialZoom(),center:{latitude:e.results.area.lat,longitude:e.results.area.lng},control:{},clusterOptions:e.clusterOptions},e.mapEvents={dragend:function(){var t=e.map.control.getGMap(),s=t.getBounds(),a=s.getNorthEast();e.ne=a.lng()+","+a.lat();var r=s.getSouthWest();e.sw=r.lng()+","+r.lat(),e.refreshResults=!0;var n=[a,new google.maps.LatLng(a.lat(),r.lng()),r,new google.maps.LatLng(r.lat(),a.lng()),a];viewportBox=new google.maps.Polyline({path:n,strokeColor:"#FF0000",strokeOpacity:1,strokeWeight:4}),viewportBox.setMap(t),e.getData()}},e.refreshMap=function(){var t=e.map.control.getGMap(),s=t.getCenter();google.maps.event.trigger(t,"resize"),t.setCenter(s)};var a=function(e,t,s){s>=t||(z=google.maps.event.addListener(e,"zoom_changed",function(){google.maps.event.removeListener(z),a(e,t,s+1)}),setTimeout(function(){e.setZoom(s)},80))},r=[];e.markers=[],e.$watch(function(){return e.map.bounds},function(){for(var t in e.mapResults){var s=e.mapResults[t];for(var a in s)if(s.hasOwnProperty(a)){for(lng in s[a].location)var l=lng,o=s[a].location[lng];r.push({id:t,latitude:o,longitude:l,icon:"/assets/img/icon_default_small_pin.png",onClicked:function(){n(this.model)}})}}e.markers=r}),e.everciseGroups=e.results.results.hits,e.totalHits=e.results.results.total,e.hitsPerPage=e.results.size,e.venue_id=!1,e.venueResults=!1,e.sortOptions=[{value:"best",name:"Best"},{value:"price_asc",name:"Price Asc"},{value:"price_desc",name:"Price Desc"},{value:"duration_asc",name:"Duration Asc"},{value:"duration_desc",name:"Duration Desc"},{value:"viewed_asc",name:"Viewed Asc"},{value:"viewed_desc",name:"Viewed Desc"}],e.sort={type:e.results.sort},e.refreshResults=!1,e.lastActiveMarker={};var n=function(t){e.venue_id=t.id,l(),e.refreshResults=!1,e.getData();var s=e.map.control.getGMap(),r=new google.maps.LatLng(t.latitude,t.longitude);s.panTo(r),a(s,14,s.getZoom()),e.lastActiveMarker.icon="/assets/img/icon_default_small_pin.png",e.lastActiveMarker=t,t.icon="/assets/img/icon_default_large_pink.png"};e.nextPage=function(){e.venue_id=!1,e.pageResultNumber.page=e.pageResultNumber.page+1,e.refreshResults=!1,e.getData()},e.sortChanged=function(){e.venue_id=!1,e.refreshResults=!0,l(),e.getData()},e.distanceChanged=function(){e.venue_id=!1,e.refreshResults=!0,l(),e.getData()};var l=function(){e.pageResultNumber.temp=e.pageResultNumber.page,e.pageResultNumber.page=1};e.getData=function(){var s={method:"POST",url:"/ajax/uk/"+e.url,headers:{"X-CSRF-Token":TOKEN},data:{page:e.pageResultNumber.page,venue_id:e.venue_id,sort:e.sort.type,distance:e.distance.type,ne:e.ne,sw:e.sw}},a=t(s);a.success(function(t){t.venue_id?(e.venueResults=t.results.hits,e.pageResultNumber.page=e.pageResultNumber.temp,e.pageResultNumber.temp=0):e.refreshResults?(e.everciseGroups=t.results.hits,e.pageResultNumber.page=t.page):(e.everciseGroups=e.everciseGroups.concat(t.results.hits),e.pageResultNumber.page=t.page)}),a.error(function(e){console.log("AJAX failed!"),console.log(e)})},$(window).resize(function(){e.$apply(function(){e.refreshMap()})})}]);
