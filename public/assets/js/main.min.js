...
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http","uiGmapGoogleMapApi",function(e){e.results=laracasts.results,console.log(e.results),e.mapOptions={disableDefaultUI:!0,zoomControl:!0,backgroundColor:"#383d48",panControl:!1},e.map={zoom:12,center:{latitude:e.results.area.lat,longitude:e.results.area.lng},control:{}},e.mapEvents={},e.availableDates=e.results.available_dates,e.everciseGroups=e.results.results.hits,e.scroll_clicked=!1,e.scrollDates=function(t,l){l.preventDefault(),e.scroll_clicked=!0;var s=$(l.target).parent(),a=s.width(),r=s.find(".content"),o=parseInt(r.css("margin-left")),n=-r.width();if("right"==t)var c=o-a;else var c=o+a;0>=c&&c>=n&&s.find(".content").css({"margin-left":c+"px"}),setTimeout(function(){e.scroll_clicked=!1},500)}}]);
