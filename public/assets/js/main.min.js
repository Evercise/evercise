function redirectTo(t){window.location.href=t.url}function updateCart(t){var o=$(".dropdown-cart");o.find("#cart-sub-total").html(t.subTotal),o.find("#cart-total").html(t.total),o.find("#cart-discount").html(t.discount),o.dropdown("toggle"),o.find(".btn").prop("disabled",!1),console.log(t)}
...
function Cart(t){this.cart=t,this.subTotalElem=t.find("#cart-sub-total"),this.totalElem=t.find("#cart-total"),this.discountElem=t.find("#cart-discount"),this.empty=t.find("#empty-cart"),this.addTo=$(".add-to-class"),this.watch()}Cart.prototype={constructor:Cart,watch:function(){var t=this;this.empty.on("click",function(a){t.submit($(this),a)}),this.addTo.on("submit",function(a){t.submit($(this),a)})},submit:function(t,a){a.preventDefault(),a.stopPropagation(),new AjaxRequest(t,cart.updateCart)},updateCart:function(t){cart.cart.dropdown("toggle"),cart.cart.replaceWith(t.view)}};