...
function UpdateSessions(t){this.form=t,this.init()}UpdateSessions.prototype={constructor:UpdateSessions,init:function(){this.addListeners()},addListeners:function(){this.form.on("submit",$.proxy(this.submitUpdate,this))},submitUpdate:function(t){t.preventDefault(),this.ajaxUpload()},ajaxUpload:function(){var t=this;$.ajax(t.form.attr("action"),{type:"post",data:t.form.serialize(),dataType:"json",beforeSend:function(){t.form.find("input[type='submit']").prop("disabled",!0).append('<span id="sessionupdate-loading" class="icon icon-loading ml10 mt10"></span>')},success:function(t){console.log(t)},error:function(){console.log("error")},complete:function(){t.form.find("input[type='submit']").prop("disabled",!1),$("#sessionupdate-loading").remove()}})}};
