function redirectTo(i){window.location.href=i.url}function editClass(i){$("#"+i.id).html(i.view),$("#submit-"+i.id).hide(),$("#"+i.id).parent().collapse("show"),$("#infoToggle-"+i.id).removeClass("hide"),datepick()}function updateHubRow(i){alert("row "+i.id+" edited")}function newSessionAdded(i){$("#"+i.id).html(i.view),addSession(),datepick()}function removeSessionRow(i){$("#hub-static-row-"+i.id).remove()}
