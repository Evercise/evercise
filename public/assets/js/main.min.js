...
"undefined"!=typeof angular&&app.controller("DiscoverController",["$scope","$q",function(e){function t(e){console.log(e),$(".class-snippet").addClass("fade-out"),$(".class-snippet").removeClass("active"),$(e).addClass("active"),$(".mb-scroll").mCustomScrollbar("scrollTo",e,{scrollInertia:500,timeout:10})}e.everciseGroups=laracasts.mapResults,e.results=e.everciseGroups.length,e.view="mapview",e.sort="id",e.dropwdownStyle={top:0,left:0},e.active={},e.distance=10,e.$watch(function(){return e.map.bounds},function(){for(var t=0;t<e.initialLoad;t++)e.myMarkers.push(i(e.everciseGroups[t]));e.markers=e.myMarkers,$("img.lazy").lazyload({container:$(".snippet-body")})},!0);var i=function(t){var i={id:t.id,name:t.name,directory:t.user.directory,image:t.image,latitude:t.venue.lat,longitude:t.venue.lng,coords:{latitude:t.venue.lat,longitude:t.venue.lng},icon:"/assets/img/icon_default_small_pin.png",price:t.default_price,rating:t.ratings.length,reviews:t.ratings,description:t.description,stars:e.getStars(t.ratings),capacity:t.capacity,sessions:t.futuresessions,distance:t.distance,nextClassDate:t.futuresessions[0].date_time,nextClassDuration:t.futuresessions[0].duration,link:"/classes/"+t.id,click:function(){e.clicked(this.model)}};return i};e.distanceFilter=function(t){return t.distance<=e.distance||t==e.active?t:void 0},e.toggle=function(t,i){var s=$(t.target).offset(),r=1.5*$(t.target).height();e.dropwdownStyle={top:s.top+r,left:s.left},$(t.target).parent().hasClass("active")&&window.setTimeout(function(){$("#"+i).removeClass("active"),$(t.target).parent().removeClass("active")},1)},e.closeDropdown=function(t){window.setTimeout(function(){$(".tab-pane-sort").removeClass("active"),$("."+t+"-btn").removeClass("active")},1),window.setTimeout(function(){$(".mb-scroll").mCustomScrollbar("scrollTo","#"+e.lastActiveMarker.id,{scrollInertia:500,timeout:10})},100)},e.changeView=function(t){e.view=t},e.isPreviewOpen=!1,e.currentCenter={latitude:50,longitude:-.2},e.map={center:e.currentCenter,pan:{},options:{streetViewControl:!1,maxZoom:19,minZoom:3},zoom:12},e.results=e.everciseGroups.length,e.myMarkers=[],e.clusterStyles=[{textColor:"white",url:"/assets/img/icon_default_small_pin_number.png",height:43,width:33,anchorText:[-14,9]}],e.clusterOptions={gridSize:8,maxZoom:20,zoom:15,styles:e.clusterStyles},e.mask=!1,e.initialLoad=e.everciseGroups.length<200?e.everciseGroups.length:200,e.markers=[],e.clusterEvents={click:function(t,i){angular.forEach(i,function(t){e.clicked(t)})}},e.returnPreview=function(){e.isPreviewOpen=!1},e.lastActiveMarker="",e.clicked=function(i){e.map.zoom=15,e.currentCenter={latitude:i.latitude,longitude:i.longitude},e.active=i,e.distanceFilter(i),e.preview.id="preview-"+i.id,e.preview.image=i.directory+"/search_"+i.image,e.preview.description=i.description,e.preview.nextClassDate=i.sessions[0].date_time,e.preview.nextClassDuration=i.sessions[0].duration,e.preview.capacity=i.capacity,e.preview.link=i.link,e.preview.sessions=i.sessions,e.preview.reviews=i.reviews,e.lastActiveMarker.icon="/assets/img/icon_default_small_pin.png",e.lastActiveMarker=i,i.icon="/assets/img/icon_default_small_pin_grey.png",e.mask=!0,google.maps.event.trigger(e.map,"resize"),e.map.zoom=15,e.map.center=e.currentCenter,t("#"+i.id),e.isPreviewOpen=!0},e.getStars=function(e){var t=0;if(e.length>0){for(var i=0;i<e.length;i++)t+=e[i].stars;result=Math.round(t/e.length)}else result=0;return result},e.preview={id:1,image:"",description:"",nextClassDate:"",nextClassDuration:"",capacity:"",link:""},e.hasTickets=function(e){return e.remaining>0?!0:!1}}]);
...
function facebookRedirect(t){this.btn=t,this.url=t.attr("href"),this.redirect="",this.addListeners()}facebookRedirect.prototype={constructor:facebookRedirect,addListeners:function(){$('input[name="trainer"]').on("change",$.proxy(this.changeFbUrl,this))},changeFbUrl:function(t){var e=$(t.target).val();this.redirect="yes"==e?"trainers.create":"",this.btn.attr("href",this.url+this.redirect)}};
...
function AddSessionsToCalendar(t){this.form=t,this.calendar=this.form.find("#calendar"),this.index="",this.dates=[],this.selectedDates=[],this.submitDates=[],this.currentMonthYear=[],this.init()}AddSessionsToCalendar.prototype={constructor:AddSessionsToCalendar,init:function(){this.calendar.datepicker({format:"yyyy-mm-dd",startDate:"+1d",todayHighlight:!0,multidate:!0}).on("changeDate",$.proxy(this.getCurrentDates,this)),this.addListener()},addListener:function(){$(document).on("click",".dow",$.proxy(this.dayOfWeek,this)),this.form.on("submit",$.proxy(this.submitForm,this))},getCurrentDates:function(t){var e=this;this.selectedDates=t.dates,this.dates=[],$.each(this.selectedDates,function(t,a){e.dates.push({key:a.valueOf(),dates:a})})},dayOfWeek:function(t){this.currentMonthYear=$(".datepicker-switch").first().text().split(" ");var e=new Date,a=this.getMonthNumber(this.currentMonthYear[0],this.currentMonthYear[1]),s=this.currentMonthYear[1],n=this;for(console.log(a+" - "+s),this.index=$(t.target).index(),e.setDate(1),e.setMonth(a),e.setFullYear(s);e.getDay()!==this.index;)e.setDate(e.getDate()+1);for(;e.getMonth()===a;){var i=new Date(e.getFullYear()+"-"+("0"+(e.getMonth()+1)).slice(-2)+"-"+("0"+e.getDate()).slice(-2)),r=$.grep(n.dates,function(t){return t.key==i.valueOf()});0==r.length?n.dates.push({key:i.valueOf(),dates:i}):n.dates=n.dates.filter(function(t){return t.key!==i.valueOf()}),e.setDate(e.getDate()+7)}this.setCalendarDates()},setCalendarDates:function(){var t=[],e={};$.each(this.dates,function(a,s){e[s.key]||(e[s.key]=!0,t.push(s.dates))}),this.calendar.datepicker("setDates",t)},getMonthNumber:function(t,e){var a=Date.parse(t+"1, "+e);return isNaN(a)?-1:new Date(a).getMonth()},submitForm:function(t){t.preventDefault();var e=this;$.each(this.calendar.datepicker("getDates"),function(t,a){var s=a.getDate(),n=a.getMonth()+1,i=a.getFullYear();e.submitDates.push(i+"-"+n+"-"+s)}),$('input[name="session_array"]').val(this.submitDates),this.ajaxUpload()},ajaxUpload:function(){var t=this;$.ajax(t.form.attr("action"),{type:"post",data:t.form.serialize(),dataType:"json",beforeSend:function(){t.form.find("input[type='submit']").prop("disabled",!0).parent().after('<span id="session-loading" class="icon icon-loading ml10 mt10"></span>')},success:function(e){$("#update-session").html(e.view),$('input[name="recurring"][value="no"]').click(),t.dates=[],t.submitDates=[],t.selectedDates=[],t.setCalendarDates(),$("html, body").animate({scrollTop:$("#update-container").offset().top-20},1e3)},error:function(){console.log("error")},complete:function(){t.form.find("input[type='submit']").prop("disabled",!1),$("#session-loading").remove()}})}};
function registerUser(a){this.form=a,this.validIcon="glyphicon glyphicon-ok",this.invalidIcon="glyphicon glyphicon-remove",this.validatingIcon="glyphicon glyphicon-refresh",this.displayName={message:"Your username is not valid",validators:{notEmpty:{message:"Your display name is required"},stringLength:{min:5,max:20,message:"Your display name must be more than 5 and less than 20 characters long"},regexp:{regexp:/^[a-zA-Z0-9_]+$/,message:"Your display name can only consist of alphabetical, number and underscore"}}},this.email={validators:{notEmpty:{message:"Your email is required and cannot be empty"},emailAddress:{message:"Your email is not a valid email address"}}},this.first_name={validators:{notEmpty:{message:"Your first name is required and cannot be empty"},stringLength:{min:2,max:15,message:"Your first name must be more than 2 and less than 15 characters long"}}},this.last_name={validators:{notEmpty:{message:"Your surname is required and cannot be empty"},stringLength:{min:2,max:15,message:"Your surname must be more than 2 and less than 15 characters long"}}},this.password={validators:{notEmpty:{message:"Your password is required and cannot be empty"},stringLength:{min:6,max:32,message:"Your Password must be more than 6 and less than 32 characters long"},identical:{field:"confirmed_password",message:"Your passwords do not match"}}},this.confirmed_password={validators:{notEmpty:{message:"Your password is required and cannot be empty"},stringLength:{min:6,max:32,message:"Your Password must be more than 6 and less than 32 characters long"},identical:{field:"password",message:"Your passwords do not match"}}},this.init()}registerUser.prototype={constructor:registerUser,init:function(){this.form.find("input[type='submit']").prop("disabled",!0),this.validation()},validation:function(){var a=this;this.form.bootstrapValidator({message:"This value is not valid",feedbackIcons:{valid:this.validIcon,invalid:this.invalidIcon,validating:this.validatingIcon},fields:{display_name:this.displayName,email:this.email,first_name:this.first_name,last_name:this.last_name,password:this.password,confirmed_password:this.confirmed_password}}).on("success.form.bv",function(s){s.preventDefault(),a.ajaxUpload()})},ajaxUpload:function(){var a=this;$.ajax(a.form.attr("action"),{type:"post",data:a.form.serialize(),dataType:"json",beforeSend:function(){a.form.find("input[type='submit']").prop("disabled",!0).after('<span id="register-loading" class="icon icon-loading ml10"></span>')},success:function(s){1==s.validation_failed?a.failedValidation(s):window.location.href=s.url},error:function(a,s,e){console.log(a+" - "+s+" - "+e)},complete:function(){a.form.find("input[type=submit]").prop("disabled",!1),$("#register-loading").remove()}})},failedValidation:function(a){self=this;var s=a.errors;$.each(s,function(a,s){self.form.find('input[name="'+a+'"]').parent().addClass("has-error"),self.form.find('input[name="'+a+'"]').parent().find(".glyphicon-ok").remove(),self.form.find('input[name="'+a+'"]').after('<small class="help-block" data-bv-validator="notEmpty" data-bv-for="'+a+'" data-bv-result="INVALID">'+s+"</small>"),self.form.find('input[name="'+a+'"]').after('<i class="form-control-feedback glyphicon glyphicon-remove" data-bv-icon-for="'+a+'"></i>')})}};
...
function Referral(t){this.form=t,this.addListeners()}Referral.prototype={constructor:Referral,addListeners:function(){this.form.on("submit",$.proxy(this.submitForm,this)),this.form.find("input[name='referee_email']").on("keydown",$.proxy(this.emailChange,this))},emailChange:function(t){$(t.target).parent().addClass("has-error")&&($(t.target).parent().removeClass("has-error"),this.form.find("#validation-error-text").remove(),this.form.find("#validation-error-icon").remove())},submitForm:function(t){t.preventDefault(),this.ajaxSubmit()},ajaxSubmit:function(){var t=this;$.ajax(t.form.attr("action"),{type:"post",data:t.form.serialize(),dataType:"json",beforeSend:function(){t.form.find("input[type='submit']").prop("disabled",!0)},success:function(i){1==i.validation_failed?t.failedValidation(i):window.location.href=i.url},error:function(t,i,e){console.log(t+" - "+i+" - "+e)},complete:function(){t.form.find("input[type=submit]").prop("disabled",!1)}})},failedValidation:function(t){self=this;var i=t.errors;$.each(i,function(t,i){self.form.find('input[name="'+t+'"]').parent().addClass("has-error"),self.form.find('input[name="'+t+'"]').after('<small id="validation-error-text" class="help-block" data-bv-validator="notEmpty" data-bv-for="'+t+'" data-bv-result="INVALID">'+i+"</small>"),self.form.find('input[name="'+t+'"]').after('<i id="validation-error-icon" class="form-control-feedback bv-no-label glyphicon glyphicon-remove" data-bv-icon-for="'+t+'"></i>')})}};
function EditClass(t){this.form=t,this.addListeners()}EditClass.prototype={constructor:EditClass,addListeners:function(){this.form.on("submit",$.proxy(this.submit,this))},submit:function(t){t.preventDefault(),this.form=$(t.target),this.ajax()},ajax:function(){var t=this;$.ajax(t.form.attr("action"),{type:"post",data:t.form.serialize(),dataType:"json",beforeSend:function(){t.form.find("input[type='submit']").prop("disabled",!0),t.form.find(".btn-toggle-down").prop("disabled",!0).addClass("loading")},success:function(i){t.edit(i)},error:function(t,i,s){console.log(t+" - "+i+" - "+s)},complete:function(){t.form.find("input[type='submit']").prop("disabled",!1)}})},edit:function(t){$("#"+t.id).html(t.view),$("#edit-"+t.id).removeClass("disabled"),$("#submit-"+t.id).hide(),$("#"+t.id).parent().collapse("show"),$("#infoToggle-"+t.id).removeClass("hide"),datepick(),new UpdateSession($(".update-session"))}};
...
function updateProfile(a){this.form=a,this.validIcon="glyphicon glyphicon-ok",this.invalidIcon="glyphicon glyphicon-remove",this.validatingIcon="glyphicon glyphicon-refresh",this.email={validators:{notEmpty:{message:"Your email is required and cannot be empty"},emailAddress:{message:"Your email is not a valid email address"}}},this.first_name={validators:{stringLength:{min:2,max:15,message:"Your first name must be more than 2 and less than 15 characters long"}}},this.last_name={validators:{stringLength:{min:2,max:15,message:"Your surname must be more than 2 and less than 15 characters long"}}},this.password={validators:{stringLength:{min:6,max:32,message:"Your Password must be more than 6 and less than 32 characters long"},identical:{field:"confirmed_password",message:"Your passwords do not match"}}},this.confirmed_password={validators:{stringLength:{min:6,max:32,message:"Your Password must be more than 6 and less than 32 characters long"},identical:{field:"password",message:"Your passwords do not match"}}},this.init()}updateProfile.prototype={constructor:updateProfile,init:function(){this.form.find("input[type='submit']").prop("disabled",!0),this.validation()},validation:function(){var a=this;this.form.bootstrapValidator({message:"This value is not valid",feedbackIcons:{valid:this.validIcon,invalid:this.invalidIcon,validating:this.validatingIcon},fields:{email:this.email,first_name:this.first_name,last_name:this.last_name,password:this.password,confirmed_password:this.confirmed_password}}).on("success.form.bv",function(i){i.preventDefault(),a.ajaxUpload()})},ajaxUpload:function(){var a=this;$.ajax(a.form.attr("action"),{type:"post",data:a.form.serialize(),dataType:"json",beforeSend:function(){a.form.find("input[type='submit']").prop("disabled",!0).after('<span id="register-loading" class="icon icon-loading ml10"></span>')},success:function(i){1==i.validation_failed?a.failedValidation(i):window.location.href=i.url},error:function(a,i,s){console.log(a+" - "+i+" - "+s)},complete:function(){a.form.find("input[type=submit]").prop("disabled",!1),$("#register-loading").remove()}})},failedValidation:function(a){self=this;var i=a.errors;$.each(i,function(a,i){self.form.find('input[name="'+a+'"]').parent().addClass("has-error"),self.form.find('input[name="'+a+'"]').parent().find(".glyphicon-ok").remove(),self.form.find('input[name="'+a+'"]').after('<small class="help-block" data-bv-validator="notEmpty" data-bv-for="'+a+'" data-bv-result="INVALID">'+i+"</small>"),self.form.find('input[name="'+a+'"]').after('<i class="form-control-feedback glyphicon glyphicon-remove" data-bv-icon-for="'+a+'"></i>')})}};
...
function Cart(t){this.cart=t,this.form="",this.addListeners()}Cart.prototype={constructor:Cart,addListeners:function(){$(document).on("submit","#empty-cart",$.proxy(this.submit,this)),$(document).on("submit",".remove-row",$.proxy(this.submit,this)),$(document).on("submit",".add-to-class",$.proxy(this.submit,this)),$(document).on("change",".btn-select",$.proxy(this.changeSelectDropdown,this))},changeSelectDropdown:function(t){$(t.target).val()?($(t.target).css("z-index",1),$(t.target).closest(".add-to-class").trigger("submit")):$(t.target).css("z-index",0)},submit:function(t){t.preventDefault(),t.stopPropagation(),this.form=$(t.target),this.ajaxSubmit()},ajaxSubmit:function(){var t=this;$.ajax(t.form.attr("action"),{type:"post",data:t.form.serialize(),dataType:"json",beforeSend:function(){t.form.find('input[type="submit"]').hasClass("add-btn")?t.form.find("input[type='submit']").prop("disabled",!0):t.form.find("input[type='submit']").replaceWith('<span id="cart-loading" class="icon icon-loading ml10"></span>')},success:function(o){o.view?t.updateCart(o):o.refresh&&location.reload()},error:function(t,o,i){console.log(t+" - "+o+" - "+i)},complete:function(){t.form.find("input[type=submit]").prop("disabled",!1),$("#cart-loading").remove()}})},updateCart:function(t){$("#cart-dropdown").addClass("open"),$("#cart-dropdown .dropdown-cart").replaceWith(t.view)}};
