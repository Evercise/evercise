...
if("undefined"!=typeof angular){var app=angular.module("everApp",["ng.deviceDetector","angularytics","uiGmapgoogle-maps"],["$interpolateProvider",function(r){r.startSymbol("{[{"),r.endSymbol("}]}")}]);app.config(["uiGmapGoogleMapApiProvider","AngularyticsProvider",function(r,n){r.configure({v:"3.18",libraries:"places",uk:!0}),n.setEventHandlers(["Console","GoogleUniversal"])}]).run(["Angularytics",function(r){r.init()}]),app.filter("truncate",function(){return function(r,n,e){return isNaN(n)&&(n=10),void 0===e&&(e="..."),r.length<=n||r.length-e.length<=n?r:String(r).substring(0,n-e.length)+e}}),app.filter("repeat",function(){return function(r,n){n=parseInt(n);for(var e=0;n>e;e++)r.push(e);return r}}),app.filter("objLimitTo",[function(){return function(r,n){var e=Object.keys(r);if(e.length<1)return[];var t=new Object,i=0;return angular.forEach(e,function(e){return i>=n?!1:(t[e]=r[e],void i++)}),t}}]),app.directive("errSrc",function(){return{link:function(r,n,e){n.bind("error",function(){e.src!=e.errSrc&&e.$set("src",e.errSrc)})}}})}
...
"undefined"!=typeof angular&&app.controller("browseController",["$scope","$http",function(e,a){angular.element(document).ready(function(){e.getCats()}),e.browseTabHeight=function(){$(".nav-browse .items").outerHeight()},e.searchTerm=laracasts.results.search,e.location=laracasts.results.area.name,e.area=laracasts.results.area.id,$("#near-me").click(function(){e.area="",e.$apply()}),$('input[name="location"]').change(function(){e.area="",e.$apply()}),e.activeCatSwitch=function(a){e.activeCat=a},e.subCategories=function(a,t){a.preventDefault(),e.browse=t,e.browseIsVisible=!0},e.closeBrowse=function(){e.browseIsVisible=!1},e.getCats=function(){var t="/ajax/categories/browse",r={method:"POST",url:t,headers:{"X-CSRF-Token":TOKEN}},n=a(r);n.success(function(a){e.categories=a}),n.error(function(){})},e.submit=function(a){e.searchTerm=a,e.location="",e.area="",setTimeout(function(){$("#search-form").trigger("submit")},500)}}]);
...
"undefined"!=typeof angular&&app.controller("calendarController",["$scope","$filter",function(e,t){function a(t){for(var a=0;a<e.rows.length;a++)if(e.rows[a].id==t)return!0;return!1}e.sessions=JSON.parse($('input[name="sessions"]').val()),e.rows=[],e.activeDate,e.cartItems=JSON.parse(CART),$("#class-calendar").datepicker({format:"yyyy-mm-dd",startDate:"-1d",weekStart:1,todayHighlight:!1,multidate:!1,setDate:null,beforeShowDay:function(r){var n=r.getFullYear()+"-"+("0"+(r.getMonth()+1)).slice(-2)+"-"+("0"+r.getDate()).slice(-2),i=$.grep(e.sessions,function(e){if(e.remaining>0){var t=e.date_time;return t=t.split(/\s+/),t[0]==n}});if(i.length>0){for(var s in i)if(!a(i[s].id)){var o,n=i[s].date_time,l=n.split(/[^0-9]/),c=parseInt(l[0],10),d=parseInt(l[1],10)-1,p=parseInt(l[2],10),u=parseInt(l[3],10),f=parseInt(l[4],10),g=parseInt(l[5],10);o=new Date(c,d,p,u,f,g);var m=t("date")(o,"hh:mm a");i[s].remaining>0&&e.rows.push({id:i[s].id,date:o,time:m,price:i[s].price,remaining:i[s].remaining,default_tickets:i[s].default_tickets,selected:e.cartItems[i[s].id],show:!1})}return{enabled:!0,classes:"session"}}return{enabled:!1,classes:!1}}}).on("changeDate",function(t){e.activeDate=t.date,e.$apply(),$(".select-box").selectbox()}),e.activeFilter=function(t){if("undefined"!=typeof e.activeDate){var a=t.date;return a.setHours(0,0,0,0),a.toString()==e.activeDate.toString()}}}]);
"undefined"!=typeof angular&&app.controller("searchController",["$scope","$http","uiGmapIsReady","Angularytics","uiGmapGoogleMapApi","$window",function(e,t,s,r,i){e.groupHeight=function(){var e=$(window).width();if(e>992){var t=$(".results").outerHeight(),s=$(".results .heading").outerHeight(),r=$(".results .nav-tabs").outerHeight(),i=$(".results .date-picker-inline").outerHeight(),a=t-s-r-i;return{height:a+"px"}}return{height:"auto"}},e.width=window.innerWidth,e.results=laracasts.results,console.log(e.results),e.resultsLoading=!1,e.view="list",e.switchView=function(t){e.resultsLoading=!0,e.view=t,e.resultsLoading=!1},e.mapOptions={minZoom:11,maxZoom:17,disableDefaultUI:!0,zoomControl:!0,backgroundColor:"#383d48",panControl:!1},e.selectedVenueIds=!1,e.selectedVenueName=!1,e.otherDates=[],e.closeVenue=function(){e.selectedVenueIds=!1,e.otherDates.length=0,e.lastActiveMarker.icon={url:"/assets/img/icon_default_pin_active.svg",size:new google.maps.Size(40,40),scaledSize:new google.maps.Size(40,40)}},e.radius=e.results.radius,e.initialZoom=function(){var t=e.results.radius.substring(0,e.results.radius.length-2),s=e.results.results.total;return 1==s?10==t?10:5==t?12:3==t?13:14:1==t?14:3==t?13:5==t?12:10==t?11:void 0},e.circleOptions={center:{latitude:e.results.area.lat,longitude:e.results.area.lng},stroke:{color:"#50c3e2",weight:2},fill:{opacity:0},radius:1609.344*e.results.radius.substring(0,e.results.radius.length-2)},e.setMapCenter=function(){var t=e.results.radius.substring(0,e.results.radius.length-2),s=e.results.area.lng;return e.width>=992?10==t?s+.13:5==t?s+.09:3==t?s+.04:1==t?s+.02:void 0:s},e.map={zoom:e.initialZoom(),center:{latitude:e.results.area.lat,longitude:e.setMapCenter()},control:{}},e.bounds={},e.mapEvents={drag:function(){},dragend:function(){var t=a();t&&(e.bounds=t,e.getData(!0))},zoom_changed:function(){}};var a=function(){var t=e.map.control.getGMap(),s=t.getBounds(),r=s.getNorthEast(),i=s.getSouthWest(),a={};return i.lat()>e.furthestBottom&&r.lat()<e.furthestTop&&i.lng()>e.furthestLeft&&r.lng()<e.furthestRight?!1:(i.lat()<e.furthestBottom&&(e.furthestBottom=i.lat()),r.lat()>e.furthestTop&&(e.furthestTop=r.lat()),i.lng()<e.furthestLeft&&(e.furthestLeft=i.lng()),r.lng()>e.furthestRight&&(e.furthestRight=r.lng()),a.ne=e.furthestTop+","+e.furthestRight,a.sw=e.furthestBottom+","+e.furthestLeft,a)};e.lastActiveMarker={},e.everciseGroups=[],shapeEverciseGroups=function(){for(var t=[],s=[],r=0;r<e.results.results.hits.length;r++){var i=e.results.results.hits[r],a=!0;if(a){var n={url:"/assets/img/icon_default_pin_inactive.svg",size:new google.maps.Size(28,28),scaledSize:new google.maps.Size(28,28)},o=!1,u=-1,l=[],c=!1,d=$.map(i.dates,function(t,r){return r==e.activeDate?(n={url:"/assets/img/icon_default_pin_active.svg",size:new google.maps.Size(40,40),scaledSize:new google.maps.Size(40,40)},o=!0,u=10,s.push({venueId:i.venue.id,groupId:i.id}),[t]):void l.push(r)});e.passInGroupId==i.id&&1==o&&(n={url:"/assets/img/icon_default_pin_selected.svg",size:new google.maps.Size(40,40),scaledSize:new google.maps.Size(40,40)},c=!0,e.otherDates=l,u=20);var g=i.score;e.results.search||(g=r),t.push({id:i.id,keyId:i.id+"."+Math.floor(6e3*Math.random())+1,name:i.name,icon:n,options:{zIndex:u},venue:{id:i.venue.id,name:i.venue.name,postcode:i.venue.postcode,latitude:i.venue.lat,longitude:i.venue.lng},active:o,tempIcon:c,slug:i.slug,score:g,remaining:i.futuresessions[0].remaining,times:d[0],otherDates:l,price:i.default_price,image:"/"+i.user.directory+"/preview_"+i.image})}}return e.venues=s,t},e.markerEvents={click:function(t,s,r){if(e.passInGroupId=r.id,e.otherDates=r.otherDates,r.active){for(var i=0;i<e.everciseGroups.length;i++)e.everciseGroups[i].tempIcon&&(e.everciseGroups[i].icon.url="/assets/img/icon_default_pin_active.svg",e.everciseGroups[i].icon.scaledSize=new google.maps.Size(40,40),e.everciseGroups[i].icon.size=new google.maps.Size(40,40),e.everciseGroups[i].tempIcon=!1);e.lastActiveMarker.icon={url:"/assets/img/icon_default_pin_active.svg",size:new google.maps.Size(40,40),scaledSize:new google.maps.Size(40,40)},e.lastActiveMarker=r,r.icon.url="/assets/img/icon_default_pin_selected.svg",r.icon.scaledSize=new google.maps.Size(40,40),r.icon.size=new google.maps.Size(40,40),r.options.zIndex=20,n(t,s,r)}else e.activeDate=r.otherDates[0],e.everciseGroups=shapeEverciseGroups(),e.lastActiveMarker=r,n(t,s,r)},mouseover:function(){},mouseout:function(){}};var n=function(t,s,r){for(var i=r.venue.id,a=[],n=0;n<e.venues.length;n++)i==e.venues[n].venueId&&a.push(e.venues[n].groupId);a.length>1?(e.selectedVenueIds=!0,e.selectedVenueIds=a,e.selectedVenueName=r.venue.name):(e.activeGroupId=r.id,e.selectedVenueIds=!1,setTimeout(function(){$(".mb-scroll").mCustomScrollbar("scrollTo",$("#group-"+r.id),{scrollInertia:800,timeout:200})},100),setTimeout(function(){u(r)},200))};s.promise(1).then(function(){e.everciseGroups=shapeEverciseGroups(),o()}),e.$watch(function(){return e.map},function(){i.then(function(t){var s=new t.LatLng(e.results.area.lat,e.results.area.lng);e.originalBounds=new google.maps.Circle({center:s,radius:1609.344*e.results.radius.substring(0,e.results.radius.length-2)}).getBounds();var r=e.originalBounds.getNorthEast(),i=e.originalBounds.getSouthWest();e.furthestTop=r.lat(),e.furthestBottom=i.lat(),e.furthestLeft=i.lng(),e.furthestRight=r.lng()})});var o=function(){if(e.results.results.total>e.everciseGroups.length){var t=e.results.page+1;setTimeout(function(){e.getData(!1,t)},2e3)}};e.isClassVisible=function(t){return-1!==$.inArray(t.id,e.selectedVenueIds)?!0:1==t.active};var u=function(t){var s=e.map.control.getGMap(),r=new google.maps.LatLng(t.venue.latitude,t.venue.longitude);s.panTo(r)};e.available_dates=e.results.available_dates,e.scroll_clicked=!1,e.scrollDates=function(t,s){s.preventDefault(),e.scroll_clicked=!0;var r,i=e.selectedDate,a=i.split(/[^0-9]/),n=parseInt(a[0],10),o=parseInt(a[1],10)-1,u=parseInt(a[2],10);r=new Date(n,o,u),r.setDate("right"==t?r.getDate()+7:r.getDate()-7),e.selectedDate=r.getFullYear()+"-"+("0"+(r.getMonth()+1)).slice(-2)+"-"+("0"+r.getDate()).slice(-2),e.getData(),setTimeout(function(){e.scroll_clicked=!1},500)},e.selectedDate=e.results.selected_date,e.activeDate=e.results.selected_date,e.changeActiveDate=function(t,s){t.preventDefault(),e.activeDate=s,e.everciseGroups=shapeEverciseGroups(),setTimeout(function(){$(".mb-scroll").mCustomScrollbar("scrollTo",$("#group-"+e.activeGroupId),{scrollInertia:800,timeout:200})},100)},e.openFilter=null,$(document).on("click",".filter-btn, .sort-btn",function(e){e.preventDefault(),l($(this))});var l=function(t){t.attr("class")==e.openFilter?(e.openFilter=null,window.setTimeout(function(){$(".tab-pane").removeClass("active"),t.parent("li").removeClass("active")},1)):e.openFilter=t.attr("class")};e.sortChanged=function(t,s){t.preventDefault(),e.results.sort=s},e.sortGroups="score",e.$watch("results.sort",function(t,s){t!=s&&(e.sortGroups="distance"==t?"distance":"price_desc"==t?"-price":"price_asc"==t?"price":"score"),$(".tab-pane").removeClass("active"),$(".sort-btn").parent("li").removeClass("active"),e.openFilter=null},!0),e.url=e.results.url,e.getData=function(s,r){var i=e.bounds.ne,a=e.bounds.sw;if("undefined"==typeof s||null===s){var s=!1;i=!1,a=!1}if("undefined"==typeof r||null===r)var r=!1;var n="/ajax/uk/",u={method:"POST",url:n+e.url,headers:{"X-CSRF-Token":TOKEN},data:{date:e.selectedDate,radius:e.results.radius,sort:e.results.sort,search:e.results.search,ne:i,sw:a,page:r}},l=t(u);e.openFilter=null,$(".tab-pane").removeClass("active"),$(".filter-btn, .sort-btn").parent().removeClass("active"),r||(e.resultsLoading=!0),l.success(function(t){if(e.results=t,e.available_dates=e.results.available_dates,e.selectedDate=e.results.selected_date,e.activeDate=e.results.selected_date,e.activeGroupId=!1,r){var i=shapeEverciseGroups();e.everciseGroups=e.everciseGroups.concat(i)}else e.everciseGroups=shapeEverciseGroups();s||(e.results.results.total>e.everciseGroups.length&&o(),e.map.center={latitude:e.results.area.lat,longitude:e.setMapCenter()},e.map.zoom=e.initialZoom(),e.circleOptions.center={latitude:e.results.area.lat,longitude:e.results.area.lng},e.circleOptions.radius=1609.344*e.results.radius.substring(0,e.results.radius.length-2)),e.resultsLoading=!1}),l.error(function(){e.resultsLoading=!1})},$(window).resize(function(){e.width=window.innerWidth}),e.$watch("width",function(t){768>t&&(e.view="list")}),e.gaEventTrigger=function(e,t,s){r.trackEvent(e,t,s)}}]);
...
function LocationAutoComplete(t){this.input=t,this.autoCompleteStarted=!1,this.addScript=!1,this.mapOptions={},this.address_components=[],this.town="london",this.width=0,this.form,this.init()}LocationAutoComplete.prototype={constructor:LocationAutoComplete,init:function(){this.form=this.input.closest("form");var t=this;if("undefined"!=typeof angular)window.google?this.load():setTimeout(function(){t.init()},1e3);else{if(!t.addScript){var o=document.createElement("script");o.src="//maps.googleapis.com/maps/api/js?libraries=places&callback=autocomplete.load",o.type="text/javascript",document.getElementsByTagName("head")[0].appendChild(o),t.addScript=!0}setTimeout(function(){t.init()},500)}},load:function(){if(void 0==google.maps||this.autoCompleteStarted){var t=this;setTimeout(function(){t.load()},500)}else this.autoCompleteStarted=!0,this.addListeners()},addListeners:function(){var t=this;$("#location-auto-complete").on("focus",function(){$(this).parent().addClass("open")}),$("body").on("click",function(t){$("#location-auto-complete").parent().is(t.target)||0!==$("#location-auto-complete").parent().has(t.target).length||0!==$(".open").has(t.target).length||$("#location-auto-complete").parent().removeClass("open")}),this.input.keyup(function(){if(!(this.value.length<1)){var o=new google.maps.places.AutocompleteService;o.getPlacePredictions({input:t.input.val(),componentRestrictions:{country:"uk"}},function(t,o){if(o==google.maps.places.PlacesServiceStatus.OK){$("#locaction-autocomplete .autocomplete-content").html("");for(var e,n=0;e=t[n];n++)$("#locaction-autocomplete .autocomplete-content").append('<li><a href="'+e.description+'">'+e.description+"</a></li>")}})}}),$(document).on("click","#locaction-autocomplete .autocomplete-content a",$.proxy(this.changeLocation,this)),$(document).on("change",'input[name="location"]',function(t){""!=$(t.target).val()&&$(".autocomplete-content li:first a").trigger("click")})},changeLocation:function(t){t.preventDefault();var o=$(t.target).attr("href"),e=this;geocoder=new google.maps.Geocoder,this.form=this.input.closest("form"),geocoder.geocode({address:o},function(t,o){if(t[0]&&"OK"==o){var n=t[0].formatted_address;e.form.find('input[name="location"]').val(n),e.getTown(t[0].address_components),e.form.find('input[name="city"]').val(e.town),e.form.find('input[name="fullLocation"]').val(JSON.stringify(t[0]))}else console.log(o)})},getTown:function(t){for(var o=this,e=t,n=0;n<e.length;++n)"locality"==e[n].types[0]?o.town=e[n].long_name:"political"==e[n].types[0]?o.town=e[n].long_name:"postal_town"==e[n].types[0]&&(o.town=e[n].long_name)}};
...
function updateProfile(a){this.form=a,this.validIcon="glyphicon glyphicon-ok",this.invalidIcon="glyphicon glyphicon-remove",this.validatingIcon="glyphicon glyphicon-refresh",this.email={validators:{notEmpty:{message:"Your email is required and cannot be empty"},emailAddress:{message:"Your email is not a valid email address"}}},this.first_name={validators:{regexp:{regexp:/^[a-zA-Z]+$/,message:"Your first name can only contain letters"},notEmpty:{message:"Your first name is required and cannot be empty"},stringLength:{min:2,max:15,message:"Your first name must be more than 2 and less than 15 characters long"}}},this.last_name={validators:{regexp:{regexp:/^[a-zA-Z]+$/,message:"Your surname name can only contain letters"},notEmpty:{message:"Your surname is required and cannot be empty"},stringLength:{min:2,max:15,message:"Your surname must be more than 2 and less than 15 characters long"}}},this.profession={message:"Your profession is not valid",validators:{notEmpty:{message:"You must add a profession"},stringLength:{min:2,max:50,message:"Your profession must be more than 2 and less than 50 characters long"}}},this.bio={message:"Your bio is not valid",validators:{notEmpty:{message:"You must add a bio"},stringLength:{min:50,max:500,message:"Your bio must be more than 50 and less than 500 characters long"}}},this.phone={validators:{phone:{country:"areacode",message:"The value is not valid %s phone number"}}},this.init()}updateProfile.prototype={constructor:updateProfile,init:function(){this.validation(),this.form.find("input[type='submit']").prop("disabled",!1)},validation:function(){var a=this;this.form.bootstrapValidator({message:"This value is not valid",feedbackIcons:{valid:this.validIcon,invalid:this.invalidIcon,validating:this.validatingIcon},fields:{email:this.email,first_name:this.first_name,last_name:this.last_name,profession:this.profession,bio:this.bio,phone:this.phone}}).on("success.form.bv",function(e){e.preventDefault(),a.ajaxUpload()})},ajaxUpload:function(){var a=this;$.ajax(a.form.attr("action"),{type:"post",data:a.form.serialize(),dataType:"json",beforeSend:function(){a.form.find("input[type='submit']").prop("disabled",!0).after('<span id="register-loading" class="icon icon-loading ml10"></span>')},success:function(e){1==e.validation_failed?a.failedValidation(e):window.location.href=e.url},error:function(a,e,i){console.log(a+" - "+e+" - "+i)},complete:function(){a.form.find("input[type=submit]").prop("disabled",!1),$("#register-loading").remove()}})},failedValidation:function(a){self=this;var e=a.errors;$.each(e,function(a,e){self.form.find('input[name="'+a+'"],input[textarea="'+a+'"] ').parent().addClass("has-error"),self.form.find('input[name="'+a+'"],input[textarea="'+a+'"] ').parent().find(".glyphicon").remove(),self.form.find('input[name="'+a+'"],input[textarea="'+a+'"] ').parent().find(".help-block:visible").remove(),self.form.find('input[name="'+a+'"],input[textarea="'+a+'"] ').after('<small class="help-block" data-bv-validator="notEmpty" data-bv-for="'+a+'" data-bv-result="INVALID">'+e+"</small>"),self.form.find('input[name="'+a+'"],input[textarea="'+a+'"] ').after('<i class="form-control-feedback glyphicon glyphicon-remove" data-bv-icon-for="'+a+'"></i>')})}};
...
function Login(r){this.form=r,this.addListeners()}Login.prototype={constructor:Login,addListeners:function(){this.form.on("submit",$.proxy(this.submit,this)),this.form.find("input").on("input",$.proxy(this.removeError,this))},removeError:function(){this.form.find(".alert").remove()},submit:function(r){r.preventDefault(),this.form=$(r.target),this.ajax()},ajax:function(){var r=this;$.ajax(r.form.attr("action"),{type:"post",data:r.form.serialize(),dataType:"json",beforeSend:function(){r.form.find("input[type='submit']").prop("disabled",!0),$("#cart-account").length&&$("#cart-account").prop("disabled",!0).addClass("disabled"),r.form.find(".has-error").removeClass("has-error"),$("#login-error-msg").remove(),r.removeError()},success:function(o){1==o.validation_failed?r.failedValidation(o):window.location.href=o.url},error:function(r,o,t){console.log(r+" - "+o+" - "+t)},complete:function(){r.form.find("input[type='submit']").prop("disabled",!1),$("#cart-account").length&&$("#cart-account").prop("disabled",!1).removeClass("disabled")}})},failedValidation:function(r){self=this;var o=r.errors;self.form.find("input[name = 'password']").parent().after('<div id="login-error-msg" class="form-control mb10 input-lg input-group has-error">'+o+"</div>")}};
function MailPopup(i){this.link=i,this.target="",this.form="",this.id="",this.validIcon="glyphicon glyphicon-ok",this.invalidIcon="glyphicon glyphicon-remove",this.validatingIcon="glyphicon glyphicon-refresh",this.body={validators:{notEmpty:{message:"Your message requires content"}}},this.addListener()}MailPopup.prototype={constructor:MailPopup,addListener:function(){$(document).on("click",".mail-popup",$.proxy(this.getPopup,this))},getPopup:function(i){i.preventDefault(),this.link=$(i.target),this.id=this.link.data("id"),this.target=$(i.target).attr("href"),this.link.addClass("icon-loading"),this.ajaxGet()},ajaxGet:function(){var i=this;$.get(this.target,function(t){i.link.after(t.view),$("#mail-trainer-"+i.id).modal("show");var a=i.link.css("margin-top").replace("px",""),n=i.link.css("margin-bottom").replace("px",""),o=i.link.css("margin-left").replace("px",""),e=i.link.css("margin-right").replace("px","");i.link.replaceWith('<a  href="#mail-trainer-'+i.id+'" class="icon icon-mail mt'+a+" mb"+n+" mr"+e+" ml"+o+'" data-toggle="modal" data-target="#mail-trainer-'+i.id+'"></a>'),i.form=$("#mail-trainer-"+i.id).find("form"),i.validation()}).fail(function(){alert("error")}).always(function(){i.link.removeClass("icon-loading")})},validation:function(){var i=this;this.form.bootstrapValidator({message:"This value is not valid",feedbackIcons:{valid:this.validIcon,invalid:this.invalidIcon,validating:this.validatingIcon},fields:{mail_body:this.body}}).on("success.form.bv",function(t){t.preventDefault(),i.ajaxUpload()})},ajaxUpload:function(){var i=this;$.ajax(i.form.attr("action"),{type:"post",data:i.form.serialize(),dataType:"json",beforeSend:function(){i.form.find("input[type='submit']").prop("disabled",!0).after('<span id="sending-loading" class="icon icon-loading ml10 mt15"></span>')},success:function(){i.form.find("input[type='submit']").before('<strong id="successfull-mail" class="text-primary">Message sent successfully!</strong><br>'),setTimeout(function(){$(".modal").modal("hide")},1500)},error:function(i,t,a){console.log(i+" - "+t+" - "+a)},complete:function(){setTimeout(function(){i.form.find("input[type=submit]").prop("disabled",!1),$("#sending-loading").remove(),$("#successfull-mail").remove()},1500)}})}};
...
function changePassword(a){this.form=a,this.validIcon="glyphicon glyphicon-ok",this.invalidIcon="glyphicon glyphicon-remove",this.validatingIcon="glyphicon glyphicon-refresh",this.password={validators:{notEmpty:{message:"Your password is required and cannot be empty"},stringLength:{min:6,max:32,message:"Your Password must be more than 6 and less than 32 characters long"},identical:{field:"new_password_confirmation",message:"Your passwords do not match"}}},this.confirmed_password={validators:{notEmpty:{message:"Your password is required and cannot be empty"},stringLength:{min:6,max:32,message:"Your Password must be more than 6 and less than 32 characters long"},identical:{field:"new_password",message:"Your passwords do not match"}}},this.validation()}changePassword.prototype={constructor:changePassword,validation:function(){var a=this;this.form.bootstrapValidator({message:"This value is not valid",feedbackIcons:{valid:this.validIcon,invalid:this.invalidIcon,validating:this.validatingIcon},fields:{new_password:this.password,new_password_confirmation:this.confirmed_password}}).on("success.form.bv",function(o){o.preventDefault(),a.ajaxUpload()})},ajaxUpload:function(){var a=this;$.ajax(a.form.attr("action"),{type:"post",data:a.form.serialize(),dataType:"json",beforeSend:function(){a.form.find("input[type='submit']").prop("disabled",!0)},success:function(o){1==o.validation_failed?a.failedValidation(o):location.reload()},error:function(a,o,n){console.log(a+" - "+o+" - "+n)},complete:function(){a.form.find("input[type='submit']").prop("disabled",!1)}})},failedValidation:function(a){self=this;var o=a.errors;$.each(o,function(a,o){self.form.find('input[name="'+a+'"]').parent().addClass("has-error"),self.form.find('input[name="'+a+'"]').parent().find(".glyphicon").remove(),self.form.find('input[name="'+a+'"]').parent().find(".help-block:visible").remove(),self.form.find('input[name="'+a+'"]').after('<small class="help-block" data-bv-validator="notEmpty" data-bv-for="'+a+'" data-bv-result="INVALID">'+o+"</small>"),self.form.find('input[name="'+a+'"]').after('<i class="form-control-feedback glyphicon glyphicon-remove" data-bv-icon-for="'+a+'"></i>')})}};
function Map(a){this.lat=a.data("lat"),this.lng=a.data("lng"),this.zoom=a.data("zoom"),this.icon="/assets/img/icon_default_small_pin.png",this.panel=a.closest("#map-panel"),this.init()}Map.prototype={constructor:Map,init:function(){var a=document.createElement("script");a.src="//www.google.com/jsapi?key=AIzaSyAha5JzFciZvU_rWu_2d2UVl7o4Z8LWdcg&callback=map.load",a.type="text/javascript",document.getElementsByTagName("head")[0].appendChild(a)},load:function(){self=this,google.load("maps","3",{other_params:"sensor=false",callback:function(){var a=new google.maps.Map(document.getElementById("map_canvas"),{center:new google.maps.LatLng(self.lat,self.lng),zoom:self.zoom,scrollwheel:!1,mapTypeId:google.maps.MapTypeId.ROADMAP});google.maps.event.trigger(a,"resize");var e=new google.maps.Marker({position:new google.maps.LatLng(self.lat,self.lng),animation:google.maps.Animation.DROP,icon:self.icon});e.setMap(a)}}),this.addMobileCheck()},addMobileCheck:function(){$("#map-panel-mobile").is(":visible")&&$("#map-panel-mobile").append(this.panel)}};
...
function Cart(t){this.cart=t,this.form="",this.maxQty="2000",this.addListeners(),$(".checkout").length&&(this.step=0,this.viewPrice=VIEWPRICE,this.checkout())}Cart.prototype={constructor:Cart,addListeners:function(){$(document).on("submit","#empty-cart",$.proxy(this.submit,this)),$(document).on("submit",".remove-row",$.proxy(this.submit,this)),$(document).on("submit",".add-to-class",$.proxy(this.submit,this)),$(document).on("change",".btn-select",$.proxy(this.changeSelectDropdown,this)),$(document).on("click",".toggle-select .switch a",$.proxy(this.switchQty,this)),$(document).on("click","#stripe-button",$.proxy(this.openStripe,this)),$(window).on("popstate",$.proxy(this.closeStripe,this)),$(document).on("change",'select[name="quantity"]',$.proxy(this.selectQty,this))},changeSelectDropdown:function(t){$(t.target).hasClass("qty-select")&&this.selectQty(t),$(t.target).hasClass("select-box")?$(t.target).closest(".add-to-class").trigger("submit"):$(t.target).val()?($(t.target).css("z-index",1),$(t.target).closest(".add-to-class").trigger("submit")):$(t.target).css("z-index",0)},switchQty:function(t){t.preventDefault(),t.stopPropagation();var e=$(t.target).closest(".toggle-select");this.maxQty=$(e).data("qty");var a=$(e).data("trigger"),i=$(t.target).attr("href").substring(1),s=$(e).find("#toggle-quantity").val();if("plus"==i){if(s<this.maxQty){var n=Math.max(parseInt(s)+1);$(e).find("#toggle-quantity").val(n),$(e).find("#qty").text(n)}}else if(s>1){var n=Math.max(parseInt(s)-1);$(e).find("#toggle-quantity").val(n),$(e).find("#qty").text(n)}a&&$(t.target).closest(".add-to-class").trigger("submit")},selectQty:function(t){var e=$(t.target).val();$(t.target).closest(".qty-wrapper").find(".qty-select").val(e)},submit:function(t){t.preventDefault(),t.stopPropagation(),this.form=$(t.target),this.ajaxSubmit()},ajaxSubmit:function(){var t=this;$.ajax(t.form.attr("action"),{type:"post",data:t.form.serialize(),dataType:"json",beforeSend:function(){t.form.find('select[name="quantity"]')&&t.form.find('select[name="quantity"]').parent().addClass("disabled"),t.form.find('input[type="submit"]').hasClass("add-btn")?t.form.find("input[type='submit']").prop("disabled",!0):t.form.find("input[type='submit']").replaceWith('<span id="cart-loading" class="icon icon-loading"></span>'),$(".checkout .mask").length&&$(".mask").removeClass("hidden"),t.form.find(".switch").addClass("disabled")},success:function(e){e.view?($("html,body").animate({scrollTop:0},300),setTimeout(function(){t.updateCart(e)},300),$(".checkout .mask").length&&$(".checkout .mask").addClass("hidden")):e.refresh?location.reload():1==e.validation_failed&&(t.failedValidation(e),$(".mask").length&&$(".mask").addClass("hidden"))},error:function(t,e,a){console.log(t+" - "+e+" - "+a)},complete:function(){t.form.find("input[type=submit]").prop("disabled",!1),$("#cart-loading").remove(),t.form.find(".switch").removeClass("disabled")}})},updateCart:function(t){$(".basket").replaceWith(t.view),$(".cart-items").html(t.items),$(".basket").hasClass("checkout--active")||setTimeout(function(){$(".basket").find(".checkout__button ").trigger("click")},300)},failedValidation:function(t){$("body").append('<div class="mt10 alert alert-danger alert-dismissible fixed" >'+t.errors.custom+'<button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button></div>')},checkout:function(){this.newUserForm=$(".checkout #new-user-form"),this.loginForm=$(".checkout .login-form"),this.userType="new";var t=this;STEP&&$('a[href="#step-'+STEP+'"]').trigger("click"),$("#step-2").on("shown.bs.collapse",function(t){var e=$(t.target).attr("id");$('a[href="#'+e+'"]').addClass("hidden"),$("#step-1").find(".switch-cart").addClass("hidden"),$("#step-1").find(".switch-back").removeClass("hidden"),$(".cart-progress").find("#progress-2").addClass("complete"),setTimeout(function(){$("html, body").animate({scrollTop:$(t.target).offset().top},500)},800)}),$(document).on("change",":checkbox",function(e){var a=$(e.target).attr("name");$(":checkbox").prop("checked",!1),$('input[name="'+a+'"]').prop("checked",!0),t.userType=a,"ps"==t.userType&&$('input[name="password"]').focus()}),$(document).on("keyup",t.loginForm.find('input[name="email"]'),function(e){t.newUserForm.find('input[name="email"]').val($(e.target).val())}),$(document).on("click","#cart-account",function(e){e.preventDefault(),"new"==t.userType?t.newUserForm.trigger("submit"):t.loginForm.trigger("submit")}),$(document).on("submit",".checkout #new-user-form",$.proxy(this.newUser,this))},openStripe:function(t){var e=this;handler.open({name:"Evercise",description:"Checkout",amount:e.viewPrice}),t.preventDefault()},closeStripe:function(){handler.close()},newUser:function(t){t.preventDefault();var e=this;e.newUserForm.find('input[name="email"]').val(e.loginForm.find('input[name="email"]').val()),$.ajax(e.newUserForm.attr("action"),{type:"post",data:e.newUserForm.serialize(),dataType:"json",beforeSend:function(){$(".has-error").removeClass("has-error"),$(".error-append").remove(),$("#cart-account").prop("disabled",!0)},success:function(t){if(1==t.validation_failed)e.failedValidation(t);else{var a=window.location.href;a+="/2",window.location.href=a}},error:function(t,e,a){console.log(t+" - "+e+" - "+a)},complete:function(){$("#cart-account").prop("disabled",!1)}})},failedValidation:function(t){var e=this,a=t.errors;$.each(a,function(t,a){e.loginForm.find('input[name="'+t+'"]').parent().addClass("has-error").after('<div class="form-control input-lg input-group has-error error-append">'+a+"</div>")})}};
