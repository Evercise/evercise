...
function topUp(t){this.form=t,this.amount=0,this.init()}topUp.prototype={constructor:topUp,init:function(){$(".stripe-button-el").prop("disabled",!0).addClass("btn"),$("#fb-pay").prop("disabled",!0),this.addListeners()},addListeners:function(){this.form.find(".add-btn").on("click",$.proxy(this.topUpAmount,this)),this.form.find('input[name="custom"]').on("keyup change",$.proxy(this.topUpAmount,this)),this.form.find("#cancel-btn").on("click",$.proxy(this.cancelTopUp,this)),this.form.find('input[name="amount"]').on("change",$.proxy(this.amountChanged,this)),this.form.on("submit",$.proxy(this.submitForm,this))},topUpAmount:function(t){t.preventDefault(),this.amount=$(t.target).val()?$(t.target).val():$(t.target).data("amount"),this.form.find(".add-btn").removeClass("btn-primary"),this.form.find('input[name="custom"]').removeClass("btn-primary"),$(t.target).addClass("btn-primary"),this.updateAmountInput()},cancelTopUp:function(t){t.preventDefault(),this.amount=0,this.form.find(".add-btn").removeClass("btn-primary"),this.form.find('input[name="custom"]').removeClass("btn-primary"),this.updateAmountInput()},updateAmountInput:function(){this.form.find('input[name="amount"]').val(this.amount).trigger("change")},amountChanged:function(){if($(".stripe-button-el").prop("disabled",!0),$("#fb-pay").prop("disabled",!0),this.amount>0){var t=this.amount,n=this;setTimeout(function(){var o=n.amount;t==o&&n.form.trigger("submit")},1e3)}},submitForm:function(t){t.preventDefault(),this.ajaxUpload()},ajaxUpload:function(){var t=this;$.ajax(t.form.attr("action"),{type:"post",data:t.form.serialize(),dataType:"json",beforeSend:function(){t.form.find(".add-btn").prop("disabled",!0),t.form.find('input[name="custom"]').prop("disabled",!0)},success:function(t){$(".stripe-button-el").prop("disabled",!1),$("#fb-pay").prop("disabled",!1),console.log(t)},error:function(t,n,o){console.log(t+" - "+n+" - "+o)},complete:function(){t.form.find(".add-btn").prop("disabled",!1),t.form.find('input[name="custom"]').prop("disabled",!1)}})}};
...
function Cart(t){this.cart=t,this.addTo=$(".add-to-class"),this.watch()}Cart.prototype={constructor:Cart,watch:function(){var t=this;$(document).on("submit","#empty-cart",function(o){t.submit($("#empty-cart"),o)}),$(document).on("submit",".remove-row",function(o){t.submit($(".remove-row"),o)}),$(document).on("submit",".add-to-class",function(o){t.submit($(".add-to-class"),o)})},submit:function(t,o){o.preventDefault(),o.stopPropagation(),new AjaxRequest(t,cart.updateCart)},updateCart:function(t){$(".dropdown ").addClass("open"),$(".dropdown-cart").replaceWith(t.view)}};
